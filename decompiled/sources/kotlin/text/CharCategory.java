...
public final class CharCategory {
    ...
    public static final class Companion {
        ...
        public final CharCategory valueOf(int i) {
            if (i >= 0 && i < 17) {
                return CharCategory.getEntries().get(i);
            }
            if (18 > i || i >= 31) {
                throw new IllegalArgumentException(ObjectListKt$$ExternalSyntheticOutline1.m("Category #", i, " is not defined."));
            }
            return CharCategory.getEntries().get(i - 1);
        }
