...
public class ReflectionFactory {
    ...
    public KType mutableCollectionType(KType kType) {
        ...
        return new TypeReference(kType.getClassifier(), kType.getArguments(), typeReference.platformTypeUpperBound, typeReference.flags | 2);
    }

    @SinceKotlin(version = "1.6")
    public KType nothingType(KType kType) {
        TypeReference typeReference = (TypeReference) kType;
        return new TypeReference(kType.getClassifier(), kType.getArguments(), typeReference.platformTypeUpperBound, typeReference.flags | 4);
    }

    @SinceKotlin(version = "1.6")
    public KType platformType(KType kType, KType kType2) {
        return new TypeReference(kType.getClassifier(), kType.getArguments(), kType2, ((TypeReference) kType).flags);
    }
