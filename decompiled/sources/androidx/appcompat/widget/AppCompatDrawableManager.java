    ...
    public static synchronized void preload() {
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                public final ColorStateList createBorderlessButtonColorStateList(@NonNull Context context) {
                    return createButtonColorStateList(context, 0);
                }

                public final ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
                ...
                public final ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
                    return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, R.attr.colorAccent));
                }

                public final ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
                ...
                public final ColorStateList createSwitchThumbColorStateList(Context context) {
                    int[][] iArr = new int[3][];
                    int[] iArr2 = new int[3];
                ...
                public final LayerDrawable getRatingBarLayerDrawable(@NonNull ResourceManagerInternal resourceManagerInternal, @NonNull Context context, @DimenRes int i) {
                ...
                public boolean tintDrawable(@NonNull Context context, int i, @NonNull Drawable drawable) {
                    if (i == R.drawable.abc_seekbar_track_material) {
                        ...
                        Drawable drawableFindDrawableByLayerId = layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress);
                    ...
                    setPorterDuffColorFilter(drawableFindDrawableByLayerId2, themeAttrColor2, mode2);
