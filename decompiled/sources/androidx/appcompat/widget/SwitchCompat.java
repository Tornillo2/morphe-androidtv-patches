...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public static final Property<SwitchCompat, Float> THUMB_POS = new AnonymousClass1(Float.class, "thumbPos");
    public static final int[] CHECKED_STATE_SET = {R.attr.state_checked};

    /* JADX INFO: renamed from: androidx.appcompat.widget.SwitchCompat$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public final void animateThumbToCheckedState(boolean z) {
    ...
    public final void cancelSuperTouch(MotionEvent motionEvent) {
    ...
    @Nullable
    public final CharSequence doTransformForOnOffText(@Nullable CharSequence charSequence) {
    ...
    public final boolean hitThumb(float f, float f2) {
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(androidx.appcompat.R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.mWrapped.getInt(androidx.appcompat.R.styleable.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.mWrapped.getInt(androidx.appcompat.R.styleable.TextAppearance_android_textStyle, -1));
        if (tintTypedArrayObtainStyledAttributes.mWrapped.getBoolean(androidx.appcompat.R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public final void setSwitchTypefaceByIndex(int i, int i2) {
    ...
    public final void stopDrag(MotionEvent motionEvent) {
        this.mTouchMode = 0;
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.SwitchCompat, attributeSet, tintTypedArrayObtainStyledAttributes.mWrapped, i, 0);
        ...
        setTextOnInternal(tintTypedArrayObtainStyledAttributes.mWrapped.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(tintTypedArrayObtainStyledAttributes.mWrapped.getText(androidx.appcompat.R.styleable.SwitchCompat_android_textOff));
        this.mShowText = tintTypedArrayObtainStyledAttributes.mWrapped.getBoolean(androidx.appcompat.R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(androidx.appcompat.R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(androidx.appcompat.R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(androidx.appcompat.R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.mWrapped.getBoolean(androidx.appcompat.R.styleable.SwitchCompat_splitTrack, false);
        ...
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.mWrapped.getInt(androidx.appcompat.R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.mWrapped.getInt(androidx.appcompat.R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(androidx.appcompat.R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
