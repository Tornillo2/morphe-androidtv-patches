...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        public int mIconifiedByDefaultId;
        public int mImeOptionsId;
        public int mMaxWidthId;
        public boolean mPropertiesMapped = false;
        public int mQueryHintId;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* JADX INFO: renamed from: androidx.appcompat.widget.SearchView$SavedState$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public final Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        int position;
        String stringOrNull;
        try {
            ...
            String stringOrNull2 = SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_data"));
            if (stringOrNull2 == null) {
                stringOrNull2 = this.mSearchable.getSuggestIntentData();
            }
            if (stringOrNull2 != null && (stringOrNull = SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_data_id"))) != null) {
                stringOrNull2 = stringOrNull2 + SchemaId.METRIC_SCHEMA_ID_DELIMITER + Uri.encode(stringOrNull);
            }
            return createIntent(str2, stringOrNull2 == null ? null : Uri.parse(stringOrNull2), SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_extra_data")), SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_query")), i, str);
    ...
    public final Intent createVoiceWebSearchIntent(Intent intent, SearchableInfo searchableInfo) {
    ...
    public final boolean launchSuggestion(int i, int i2, String str) {
    ...
    public final void rewriteQueryFromSuggestion(int i) {
        Editable text = this.mSearchSrcTextView.getText();
        Cursor cursor = this.mSuggestionsAdapter.getCursor();
        if (cursor == null) {
            return;
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.appcompat.R.styleable.SearchView, i, 0);
        TintTypedArray tintTypedArray = new TintTypedArray(context, typedArrayObtainStyledAttributes);
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.SearchView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        LayoutInflater.from(context).inflate(typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.SearchView_layout, androidx.appcompat.R.layout.abc_search_view), (ViewGroup) this, true);
        ...
        viewFindViewById.setBackground(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_queryBackground));
        viewFindViewById2.setBackground(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = tintTypedArray.getDrawable(androidx.appcompat.R.styleable.SearchView_searchHintIcon);
        ...
        this.mSuggestionRowLayout = typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.SearchView_suggestionRowLayout, androidx.appcompat.R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(typedArrayObtainStyledAttributes.getBoolean(androidx.appcompat.R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(androidx.appcompat.R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = typedArrayObtainStyledAttributes.getText(androidx.appcompat.R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = typedArrayObtainStyledAttributes.getText(androidx.appcompat.R.styleable.SearchView_queryHint);
        int i2 = typedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = typedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(typedArrayObtainStyledAttributes.getBoolean(androidx.appcompat.R.styleable.SearchView_android_focusable, true));
