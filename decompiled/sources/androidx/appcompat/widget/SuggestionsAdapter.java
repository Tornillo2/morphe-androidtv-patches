...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public final Drawable checkIconCache(String str) {
    ...
    public final Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbM = MediaBrowserCompat$CustomActionResultReceiver$$ExternalSyntheticOutline0.m("Invalid icon resource ", iconResource, " for ");
            sbM.append(componentName.flattenToShortString());
    ...
    public final Drawable getActivityIconWithCache(ComponentName componentName) {
    ...
    public final Drawable getDefaultIcon1() {
    ...
    public final Drawable getDrawable(Uri uri) {
        try {
    ...
    public final Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + SchemaId.METRIC_SCHEMA_ID_DELIMITER + i;
    ...
    public final Drawable getIcon1(Cursor cursor) {
    ...
    public final Drawable getIcon2(Cursor cursor) {
    ...
    public final void setViewDrawable(ImageView imageView, Drawable drawable, int i) {
    ...
    public final void storeInIconCache(String str, Drawable drawable) {
        if (drawable != null) {
