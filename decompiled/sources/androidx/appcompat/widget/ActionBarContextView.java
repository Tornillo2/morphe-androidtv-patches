...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        setBackground(tintTypedArray.getDrawable(R.styleable.ActionMode_background));
        this.mTitleStyleRes = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = typedArrayObtainStyledAttributes.getLayoutDimension(R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ActionMode_closeItemLayout, R.layout.abc_action_mode_close_item_material);
