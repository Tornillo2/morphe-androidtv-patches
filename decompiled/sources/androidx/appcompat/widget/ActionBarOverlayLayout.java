...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static {
        ...
        builder.mImpl.setSystemWindowInsets(Insets.of(0, 1, 0, 1));
        NON_EMPTY_SYSTEM_WINDOW_INSETS = builder.mImpl.build();
    ...
    */
    public final boolean applyInsets(@androidx.annotation.NonNull android.view.View r3, @androidx.annotation.NonNull android.graphics.Rect r4, boolean r5, boolean r6, boolean r7, boolean r8) {
        /*
            r2 = this;
    ...
    public WindowInsets onApplyWindowInsets(@NonNull WindowInsets windowInsets) {
        ...
        WindowInsetsCompat windowInsetsCompatInset = windowInsetsCompat.mImpl.inset(rect.left, rect.top, rect.right, rect.bottom);
        ...
        return windowInsetsCompat.mImpl.consumeDisplayCutout().consumeSystemWindowInsets().consumeStableInsets().toWindowInsets();
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mOverlayMode || z || !decorFitsSystemWindows()) {
            Insets insetsOf = Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom());
            WindowInsetsCompat.Builder builder = new WindowInsetsCompat.Builder(this.mInnerInsets);
            builder.mImpl.setSystemWindowInsets(insetsOf);
            this.mInnerInsets = builder.mImpl.build();
        } else {
    ...
    public final boolean shouldHideActionBarOnFling(float f) {
