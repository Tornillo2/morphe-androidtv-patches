...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        ...
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (colorStateList = ContextCompat.getColorStateList(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : colorStateList;
    }
