...
public class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
        ...
        if (drawable != null) {
            if (this.mHasTickMarkTint || this.mHasTickMarkTintMode) {
                ...
                if (this.mHasTickMarkTint) {
                    drawableWrap.setTintList(this.mTickMarkTintList);
                }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(seekBar, seekBar.getContext(), R.styleable.AppCompatSeekBar, attributeSet, tintTypedArrayObtainStyledAttributes.mWrapped, i, 0);
        ...
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.AppCompatSeekBar_tickMarkTintMode)) {
            this.mTickMarkTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.mWrapped.getInt(R.styleable.AppCompatSeekBar_tickMarkTintMode, -1), this.mTickMarkTintMode);
            this.mHasTickMarkTintMode = true;
        }
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.AppCompatSeekBar_tickMarkTint)) {
