...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), R.styleable.ViewBackgroundHelper, attributeSet, tintTypedArrayObtainStyledAttributes.mWrapped, i, 0);
        try {
            if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.ViewBackgroundHelper_android_background)) {
                this.mBackgroundResId = tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.ViewBackgroundHelper_android_background, -1);
                ColorStateList tintList = this.mDrawableManager.getTintList(this.mView.getContext(), this.mBackgroundResId);
                if (tintList != null) {
                    setInternalBackgroundTint(tintList);
                }
            }
            if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.ViewBackgroundHelper_backgroundTint)) {
            ...
            if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.mWrapped.getInt(R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), null));
            }
