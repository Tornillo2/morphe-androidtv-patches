...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public final void init(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(tintTypedArrayObtainStyledAttributes.mWrapped.getBoolean(R.styleable.PopupWindow_overlapAnchor, false));
        }
