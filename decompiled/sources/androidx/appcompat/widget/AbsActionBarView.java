...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i, long j) {
        ...
        if (i != 0) {
            ...
            viewPropertyAnimatorCompatAnimate.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAnimate, i));
        ...
        viewPropertyAnimatorCompatAnimate2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAnimate2, i));
