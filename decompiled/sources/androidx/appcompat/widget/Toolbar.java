...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Toolbar> {
        public int mCollapseContentDescriptionId;
        public int mCollapseIconId;
        public int mContentInsetEndId;
        public int mContentInsetEndWithActionsId;
        public int mContentInsetLeftId;
        public int mContentInsetRightId;
        public int mContentInsetStartId;
        public int mContentInsetStartWithNavigationId;
        public int mLogoDescriptionId;
        public int mLogoId;
        public int mMenuId;
        public int mNavigationContentDescriptionId;
        public int mNavigationIconId;
        public int mPopupThemeId;
        public boolean mPropertiesMapped = false;
        public int mSubtitleId;
        public int mTitleId;
        public int mTitleMarginBottomId;
        public int mTitleMarginEndId;
        public int mTitleMarginStartId;
        public int mTitleMarginTopId;
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mLogoId = propertyMapper.mapObject(TvContractCompat.Channels.Logo.CONTENT_DIRECTORY, R.attr.logo);
            this.mLogoDescriptionId = propertyMapper.mapObject("logoDescription", R.attr.logoDescription);
            this.mMenuId = propertyMapper.mapObject(SupportMenuInflater.XML_MENU, R.attr.menu);
        ...
        public void readProperties(@NonNull Toolbar toolbar, @NonNull PropertyReader propertyReader) {
            if (!this.mPropertiesMapped) {
                throw AppCompatAutoCompleteTextView$InspectionCompanion$$ExternalSyntheticApiModelOutline0.m();
            }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* JADX INFO: renamed from: androidx.appcompat.widget.Toolbar$SavedState$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    /* JADX WARN: Removed duplicated region for block: B:117:0x02eb A[LOOP:2: B:116:0x02e9->B:117:0x02eb, LOOP_END] */
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        iArr2[zIsLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetStart - horizontalMargins);
        ...
        int iMax4 = iMax3 + Math.max(currentContentInsetEnd, horizontalMargins2);
        iArr2[i3] = Math.max(0, currentContentInsetEnd - horizontalMargins2);
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                int iMax5 = Math.max(iMax, getVerticalMargins(childAt) + childAt.getMeasuredHeight());
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            int verticalMargins2 = getVerticalMargins(this.mTitleTextView) + this.mTitleTextView.getMeasuredHeight();
            ...
            verticalMargins = verticalMargins2;
        } else {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.Toolbar, attributeSet, tintTypedArrayObtainStyledAttributes.mWrapped, i, 0);
        this.mTitleTextAppearance = tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = tintTypedArrayObtainStyledAttributes.mWrapped.getInteger(R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = tintTypedArrayObtainStyledAttributes.mWrapped.getInteger(R.styleable.Toolbar_buttonGravity, 48);
        int dimensionPixelOffset = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMargin, 0);
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.Toolbar_titleMargins)) {
            dimensionPixelOffset = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMargins, dimensionPixelOffset);
        }
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        int dimensionPixelOffset2 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset2 >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset2;
        }
        int dimensionPixelOffset3 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset3 >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset3;
        }
        int dimensionPixelOffset4 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset4 >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset4;
        }
        int dimensionPixelOffset5 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_titleMarginBottom, -1);
        if (dimensionPixelOffset5 >= 0) {
            this.mTitleMarginBottom = dimensionPixelOffset5;
        }
        this.mMaxButtonHeight = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(R.styleable.Toolbar_maxButtonHeight, -1);
        int dimensionPixelOffset6 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset7 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelSize(R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        this.mContentInsets.setAbsolute(dimensionPixelSize, dimensionPixelSize2);
        if (dimensionPixelOffset6 != Integer.MIN_VALUE || dimensionPixelOffset7 != Integer.MIN_VALUE) {
            this.mContentInsets.setRelative(dimensionPixelOffset6, dimensionPixelOffset7);
        }
        this.mContentInsetStartWithNavigation = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = tintTypedArrayObtainStyledAttributes.mWrapped.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = tintTypedArrayObtainStyledAttributes.getDrawable(R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = tintTypedArrayObtainStyledAttributes.mWrapped.getText(R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = tintTypedArrayObtainStyledAttributes.mWrapped.getText(R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        CharSequence text2 = tintTypedArrayObtainStyledAttributes.mWrapped.getText(R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text2)) {
            setSubtitle(text2);
        }
        this.mPopupContext = getContext();
        setPopupTheme(tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        CharSequence text3 = tintTypedArrayObtainStyledAttributes.mWrapped.getText(R.styleable.Toolbar_navigationContentDescription);
        ...
        CharSequence text4 = tintTypedArrayObtainStyledAttributes.mWrapped.getText(R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text4)) {
            setLogoDescription(text4);
        }
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(tintTypedArrayObtainStyledAttributes.getColorStateList(R.styleable.Toolbar_titleTextColor));
        }
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(tintTypedArrayObtainStyledAttributes.getColorStateList(R.styleable.Toolbar_subtitleTextColor));
        }
        if (tintTypedArrayObtainStyledAttributes.mWrapped.hasValue(R.styleable.Toolbar_menu)) {
            inflateMenu(tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.Toolbar_menu, 0));
        }
