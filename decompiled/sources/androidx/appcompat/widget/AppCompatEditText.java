...
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public InputConnection onCreateInputConnection(@NonNull EditorInfo editorInfo) {
        ...
        if (inputConnectionOnCreateInputConnection != null && Build.VERSION.SDK_INT <= 30 && (onReceiveContentMimeTypes = ViewCompat.getOnReceiveContentMimeTypes(this)) != null) {
            ...
            inputConnectionOnCreateInputConnection = InputConnectionCompat.createWrapper(inputConnectionOnCreateInputConnection, editorInfo, InputConnectionCompat.createOnCommitContentListenerUsingPerformReceiveContent(this));
        }
    ...
    public AppCompatEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        appCompatTextClassifierHelper.mTextView = this;
