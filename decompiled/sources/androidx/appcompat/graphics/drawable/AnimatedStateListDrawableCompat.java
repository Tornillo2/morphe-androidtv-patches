...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        public void mutate() {
            this.mTransitions = this.mTransitions.m28clone();
            this.mStateIds = this.mStateIds.m29clone();
        }
    ...
    public static abstract class Transition {
        ...
        public Transition(AnonymousClass1 anonymousClass1) {
        }
    ...
    public final int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        if (drawable == null) {
            ...
            drawable = xmlPullParser.getName().equals(VectorDrawableCompat.SHAPE_VECTOR) ? VectorDrawableCompat.createFromXmlInner(resources, xmlPullParser, attributeSet, theme) : Compatibility.Api21Impl.createFromXmlInner(resources, xmlPullParser, attributeSet, theme);
        }
        if (drawable != null) {
    ...
    public final int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        if (drawable == null) {
            ...
            drawable = xmlPullParser.getName().equals(AnimatedVectorDrawableCompat.ANIMATED_VECTOR) ? AnimatedVectorDrawableCompat.createFromXmlInner(context, resources, xmlPullParser, attributeSet, theme) : Compatibility.Api21Impl.createFromXmlInner(resources, xmlPullParser, attributeSet, theme);
        }
        if (drawable == null) {
            throw new XmlPullParserException(xmlPullParser.getPositionDescription() + TRANSITION_MISSING_DRAWABLE_ERROR);
        }
    ...
    public final void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.mVariablePadding = typedArray.getBoolean(R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.mVariablePadding);
        animatedStateListState.mConstantSize = typedArray.getBoolean(R.styleable.AnimatedStateListDrawableCompat_android_constantSize, animatedStateListState.mConstantSize);
        animatedStateListState.mEnterFadeDuration = typedArray.getInt(R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, animatedStateListState.mEnterFadeDuration);
        animatedStateListState.mExitFadeDuration = typedArray.getInt(R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, animatedStateListState.mExitFadeDuration);
