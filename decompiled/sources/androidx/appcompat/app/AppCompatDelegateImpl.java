...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (appCompatDelegateImpl2.mActionModeView != null) {
                ...
                ViewPropertyAnimatorCompat viewPropertyAnimatorCompatAnimate = ViewCompat.animate(appCompatDelegateImpl3.mActionModeView);
                viewPropertyAnimatorCompatAnimate.alpha(0.0f);
                appCompatDelegateImpl3.mFadeAnim = viewPropertyAnimatorCompatAnimate;
    ...
    public static final class PanelFeatureState {
        ...
        public static class SavedState implements Parcelable {
            ...
            /* JADX INFO: renamed from: androidx.appcompat.app.AppCompatDelegateImpl$PanelFeatureState$SavedState$1, reason: invalid class name */
            /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ...
                this.menu.addMenuPresenter(listMenuPresenter);
            }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(@NonNull MenuBuilder menuBuilder) {
            ...
            AppCompatDelegateImpl appCompatDelegateImpl = AppCompatDelegateImpl.this;
            if (!appCompatDelegateImpl.mHasActionBar || (callback = appCompatDelegateImpl.mWindow.getCallback()) == null || AppCompatDelegateImpl.this.mDestroyed) {
                return true;
            }
            callback.onMenuOpened(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, menuBuilder);
            return true;
    ...
    public boolean applyAppLocales() {
        ...
        if (AppCompatDelegate.isAutoStorageOptedIn(this.mContext) && (localeListCompat = AppCompatDelegate.sRequestedAppLocales) != null && !localeListCompat.equals(AppCompatDelegate.sStoredAppLocales)) {
    ...
    public LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        LocaleListCompat localeListCompatCombineLocalesIfOverlayExists = i >= 24 ? LocaleOverlayHelper.combineLocalesIfOverlayExists(localeListCompat, configurationLocales) : localeListCompat.mImpl.isEmpty() ? LocaleListCompat.sEmptyLocaleList : LocaleListCompat.forLanguageTags(Api21Impl.toLanguageTag(localeListCompat.mImpl.get(0)));
        return localeListCompatCombineLocalesIfOverlayExists.mImpl.isEmpty() ? configurationLocales : localeListCompatCombineLocalesIfOverlayExists;
    }
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        return appCompatViewInflater.createView(view, str, context, attributeSet, z, z2, true, false);
    }
    ...
    public void dismissPopups() {
        ...
        MenuBuilder menuBuilder = getPanelState(0, false).menu;
        if (menuBuilder != null) {
            menuBuilder.close();
        }
    }
    ...
    public final int getActivityHandlesConfigChangesFlags(Context context) {
    ...
    public void invalidateOptionsMenu() {
        if (this.mActionBar == null || getSupportActionBar().invalidateOptionsMenu()) {
            return;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean onKeyUpPanel(int r5, android.view.KeyEvent r6) {
        /*
            r4 = this;
    ...
    public boolean onMenuItemSelected(@NonNull MenuBuilder menuBuilder, @NonNull MenuItem menuItem) {
        ...
        Window.Callback callback = this.mWindow.getCallback();
        if (callback == null || this.mDestroyed || (panelFeatureStateFindMenuPanel = findMenuPanel(menuBuilder.getRootMenu())) == null) {
            return false;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void openPanel(androidx.appcompat.app.AppCompatDelegateImpl.PanelFeatureState r12, android.view.KeyEvent r13) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean preparePanel(androidx.appcompat.app.AppCompatDelegateImpl.PanelFeatureState r9, android.view.KeyEvent r10) {
        /*
    ...
    public final void reopenMenu(boolean z) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && z) {
            ...
            callback.onPanelClosed(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, getPanelState(0, true).menu);
            return;
        }
        if (callback == null || this.mDestroyed) {
            return;
        ...
        if (menuBuilder == null || panelState2.refreshMenuContent || !callback.onPreparePanel(0, panelState2.createdPanelView, menuBuilder)) {
            return;
        }
        callback.onMenuOpened(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, panelState2.menu);
    ...
    public void setConfigurationLocales(Configuration configuration, @NonNull LocaleListCompat localeListCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            configuration.setLayoutDirection(localeListCompat.mImpl.get(0));
        }
    }
    ...
    public void setDefaultLocalesForLocaleList(LocaleListCompat localeListCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Locale.setDefault(localeListCompat.mImpl.get(0));
        }
    }
    ...
    */
    ...
    public boolean shouldRegisterBackInvokedCallback() {
        return this.mDispatcher != null && (getPanelState(0, false).isOpen || this.mActionMode != null);
    }
    ...
    public ActionMode startSupportActionModeFromWindow(@NonNull ActionMode.Callback callback) {
        ...
        if (this.mActionModeView == null) {
            if (this.mIsFloating) {
                ...
                this.mActionModeView = new ActionBarContextView(contextThemeWrapper, null);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean updateAppConfiguration(int r9, @androidx.annotation.Nullable androidx.core.os.LocaleListCompat r10, boolean r11) {
        /*
            r8 = this;
    ...
    public final void updateResourcesConfiguration(int i, @Nullable LocaleListCompat localeListCompat, boolean z, @Nullable Configuration configuration) {
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean dispatchKeyShortcutEvent(KeyEvent keyEvent) {
            return this.mWrapped.dispatchKeyShortcutEvent(keyEvent) || AppCompatDelegateImpl.this.onKeyShortcut(keyEvent.getKeyCode(), keyEvent);
        }
        ...
        public View onCreatePanelView(int i) {
            ...
            return (actionBarMenuCallback == null || (viewOnCreatePanelView = actionBarMenuCallback.onCreatePanelView(i)) == null) ? this.mWrapped.onCreatePanelView(i) : viewOnCreatePanelView;
        }
        ...
        public boolean onPreparePanel(int i, View view, Menu menu) {
            ...
            if (actionBarMenuCallback != null) {
                actionBarMenuCallback.onPreparePanel(i);
            }
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int i) {
            MenuBuilder menuBuilder = AppCompatDelegateImpl.this.getPanelState(0, true).menu;
            if (menuBuilder != null) {
        ...
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback) {
            ...
            return AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() ? startAsSupportActionMode(callback) : this.mWrapped.onWindowStartingActionMode(callback);
        }
