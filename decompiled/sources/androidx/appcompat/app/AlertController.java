...
public class AlertController {
    ...
    public static class AlertParams {
        ...
        public final void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (alertParams.mCursor != null) {
                    ...
                    if (checkedItemAdapter == null) {
                        checkedItemAdapter = new CheckedItemAdapter(alertParams.mContext, i, R.id.text1, (Object[]) alertParams.mItems);
                    }
                }
    ...
    @Nullable
    public final ViewGroup resolvePanel(@Nullable View view, @Nullable View view2) {
        if (view == null) {
    ...
    public final void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
    ...
    public final void setupView() {
        ...
        View viewFindViewById2 = this.mWindow.findViewById(androidx.appcompat.R.id.parentPanel);
        View viewFindViewById3 = viewFindViewById2.findViewById(androidx.appcompat.R.id.topPanel);
        View viewFindViewById4 = viewFindViewById2.findViewById(androidx.appcompat.R.id.contentPanel);
        View viewFindViewById5 = viewFindViewById2.findViewById(androidx.appcompat.R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById2.findViewById(androidx.appcompat.R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById6 = viewGroup.findViewById(androidx.appcompat.R.id.topPanel);
        View viewFindViewById7 = viewGroup.findViewById(androidx.appcompat.R.id.contentPanel);
        View viewFindViewById8 = viewGroup.findViewById(androidx.appcompat.R.id.buttonPanel);
        ...
        boolean z3 = viewGroupResolvePanel3.getVisibility() != 8;
        if (!z3 && (viewFindViewById = viewGroupResolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById9 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(androidx.appcompat.R.id.titleDividerNoCustom);
            if (viewFindViewById9 != null) {
                viewFindViewById9.setVisibility(0);
            }
        } else {
            View viewFindViewById10 = viewGroupResolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoTitle);
