...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public void doHide(boolean z) {
        ...
        viewPropertyAnimatorCompatAnimate.setUpdateListener(this.mUpdateListener);
        viewPropertyAnimatorCompatSet2.play(viewPropertyAnimatorCompatAnimate);
        if (this.mContentAnimations && (view = this.mContentView) != null) {
            ...
            viewPropertyAnimatorCompatSet2.play(viewPropertyAnimatorCompatAnimate2);
        }
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z)) {
            ...
            if (this.mContentAnimations && (view2 = this.mContentView) != null) {
                ...
                ViewPropertyAnimatorCompat viewPropertyAnimatorCompatAnimate2 = ViewCompat.animate(this.mContentView);
                viewPropertyAnimatorCompatAnimate2.translationY(0.0f);
                viewPropertyAnimatorCompatSet2.play(viewPropertyAnimatorCompatAnimate2);
            }
    ...
    public final void init(View view) {
        ...
        ActionBarPolicy actionBarPolicy = new ActionBarPolicy(this.mContext);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        setHasEmbeddedTabs(new ActionBarPolicy(this.mContext).hasEmbeddedTabs());
    }
    ...
    public void selectTab(ActionBar.Tab tab) {
        ...
        if (!(this.mActivity instanceof FragmentActivity) || this.mDecorToolbar.getViewGroup().isInEditMode()) {
            fragmentTransactionBeginTransaction = null;
        } else {
            fragmentTransactionBeginTransaction = ((FragmentActivity) this.mActivity).getSupportFragmentManager().beginTransaction();
            fragmentTransactionBeginTransaction.disallowAddToBackStack();
        }
        TabImpl tabImpl = this.mSelectedTab;
        if (tabImpl != tab) {
            ...
            if (tabImpl2 != null) {
                tabImpl2.getCallback().onTabUnselected(this.mSelectedTab, fragmentTransactionBeginTransaction);
            }
            TabImpl tabImpl3 = (TabImpl) tab;
            this.mSelectedTab = tabImpl3;
            if (tabImpl3 != null) {
                tabImpl3.getCallback().onTabSelected(this.mSelectedTab, fragmentTransactionBeginTransaction);
            }
        } else if (tabImpl != null) {
            tabImpl.getCallback().onTabReselected(this.mSelectedTab, fragmentTransactionBeginTransaction);
            this.mTabScrollView.animateToTab(tab.getPosition());
        }
        if (fragmentTransactionBeginTransaction == null || fragmentTransactionBeginTransaction.isEmpty()) {
            return;
        }
