...
public class MenuBuilder implements SupportMenu {
    ...
    public static int findInsertIndex(ArrayList<MenuItemImpl> arrayList, int i) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            if (arrayList.get(size).mOrdering <= i) {
                return size + 1;
            }
        }
        return 0;
    ...
    public MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        ...
        if (contextMenuInfo != null) {
            menuItemImpl.mMenuInfo = contextMenuInfo;
        }
    ...
    public final MenuItemImpl createNewMenuItem(int i, int i2, int i3, int i4, CharSequence charSequence, int i5) {
    ...
    public final void dispatchPresenterUpdate(boolean z) {
    ...
    public final boolean dispatchSubMenuSelected(SubMenuBuilder subMenuBuilder, MenuPresenter menuPresenter) {
        if (this.mPresenters.isEmpty()) {
            return false;
        }
    ...
    public void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                char c = zIsQwertyMode ? menuItemImpl.mShortcutAlphabeticChar : menuItemImpl.mShortcutNumericChar;
                if ((modifiers & SupportMenu.SUPPORTED_MODIFIERS_MASK) == ((zIsQwertyMode ? menuItemImpl.mShortcutAlphabeticModifiers : menuItemImpl.mShortcutNumericModifiers) & SupportMenu.SUPPORTED_MODIFIERS_MASK) && c != 0) {
                    char[] cArr = keyData.meta;
    ...
    public void removeGroup(int i) {
        ...
        if (iFindGroupIndex >= 0) {
            ...
            while (true) {
                int i3 = i2 + 1;
                if (i2 >= size || this.mItems.get(iFindGroupIndex).mGroup != i) {
                    break;
                }
    ...
    */
    public final void setShortcutsVisibleInner(boolean r3) {
        /*
            r2 = this;
            if (r3 == 0) goto L1c
    ...
    public int findGroupIndex(int i, int i2) {
        ...
        while (i2 < size) {
            if (this.mItems.get(i2).mGroup == i) {
                return i2;
            }
            i2++;
        }
