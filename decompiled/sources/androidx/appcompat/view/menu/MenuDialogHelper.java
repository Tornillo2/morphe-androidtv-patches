...
public class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        listMenuPresenter.mCallback = this;
        this.mMenu.addMenuPresenter(listMenuPresenter);
        builder.setAdapter(this.mPresenter.getAdapter(), this);
        View headerView = menuBuilder.getHeaderView();
        if (headerView != null) {
            builder.P.mCustomTitleView = headerView;
        } else {
            builder.P.mIcon = menuBuilder.getHeaderIcon();
            builder.P.mTitle = menuBuilder.getHeaderTitle();
        }
        builder.P.mOnKeyListener = this;
