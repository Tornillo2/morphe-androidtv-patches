...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTextAppearance = tintTypedArrayObtainStyledAttributes.mWrapped.getResourceId(R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = tintTypedArrayObtainStyledAttributes.mWrapped.getBoolean(R.styleable.MenuView_preserveIconSpacing, false);
    ...
    public final void addContentView(View view, int i) {
