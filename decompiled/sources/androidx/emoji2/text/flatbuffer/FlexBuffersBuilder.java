...
public class FlexBuffersBuilder {
    ...
    public static final int WIDTH_32 = 2;
    public static final int WIDTH_64 = 3;
    ...
    public static class Value {
        ...
        public final int elemWidth(int i, int i2) {
            return elemWidth(this.type, this.minBitWidth, this.iValue, i, i2);
        }

        public final byte storedPackedType() {
            return storedPackedType(0);
        }

        public final int storedWidth(int i) {
        ...
        public final byte storedPackedType(int i) {
    ...
    public final Value createKeyVector(int i, int i2) {
        long j = i2;
    ...
    public final Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        int i4;
        int typedVector;
        int i5 = i3;
        long j = i5;
    ...
    public ByteBuffer finish() {
        ...
        this.bb.put(this.stack.get(0).storedPackedType(0));
    ...
    public final void writeOffset(long j, int i) {
        writeInt((int) (((long) this.bb.writePosition()) - j), i);
    }

    public final Value writeString(int i, String str) {
    ...
    public final void putUInt64(String str, long j) {
    ...
    public final void putUInt(String str, long j) {
        Value valueUInt64;
        int iPutKey = putKey(str);
