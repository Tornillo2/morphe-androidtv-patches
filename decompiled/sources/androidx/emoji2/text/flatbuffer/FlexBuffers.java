...
public class FlexBuffers {
    ...
    public static class Map extends Vector {
        ...
        public final int binarySearch(KeyVector keyVector, byte[] bArr) {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(readBuf, iIndirect, (int) FlexBuffers.readLong(readBuf2, i + i2, i2), 4));
        }
        ...
        public Reference get(byte[] bArr) {
            KeyVector keyVectorKeys = keys();
            int size = keyVectorKeys.vec.size();
    ...
    public static class Reference {
        ...
        public double asFloat() {
            ...
            if (i == 1) {
                return (int) FlexBuffers.readLong(this.bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
                ...
                if (i == 6) {
                    ReadBuf readBuf = this.bb;
                    return (int) FlexBuffers.readLong(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                }
                if (i == 7) {
                    ReadBuf readBuf2 = this.bb;
        ...
        public int asInt() {
            ...
            int i = this.type;
            if (i == 1) {
                uInt = FlexBuffers.readLong(this.bb, this.end, this.parentWidth);
            } else if (i == 2) {
                ...
                if (i == 6) {
                    ReadBuf readBuf = this.bb;
                    uInt = FlexBuffers.readLong(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                } else if (i == 7) {
                    ReadBuf readBuf2 = this.bb;
                    uInt = FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
                } else {
                    if (i == 8) {
                        ReadBuf readBuf3 = this.bb;
        ...
        public Vector asVector() {
            ...
            ReadBuf readBuf3 = this.bb;
            return new TypedVector(readBuf3, FlexBuffers.indirect(readBuf3, this.end, this.parentWidth), this.byteWidth, this.type - 10);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.bb, (i * this.byteWidth) + this.end, this.byteWidth, this.bb.get((int) ((size * ((long) this.byteWidth)) + ((long) this.end) + j)) & 255);
        }
    ...
    public static int access$100(ReadBuf readBuf, int i, int i2) {
    ...
    public static Reference getRoot(ReadBuf readBuf) {
        ...
        int i = iLimit - 2;
        return new Reference(readBuf, i - b, b, readBuf.get(i) & 255);
    }
}
