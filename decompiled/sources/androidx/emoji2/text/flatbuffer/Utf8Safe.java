...
public final class Utf8Safe extends Utf8 {
    ...
    public static int computeEncodedLength(CharSequence charSequence) {
    ...
    public static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        char cCharAt;
        int length = charSequence.length();
    ...
    public static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
        int length = charSequence.length();
