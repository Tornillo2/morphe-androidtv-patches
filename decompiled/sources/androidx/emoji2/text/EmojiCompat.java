...
public class EmojiCompat {
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        public String getAssetSignature() {
            String strSourceSha = this.mMetadataRepo.mMetadataList.sourceSha();
        ...
        public void onMetadataLoadSuccess(@NonNull MetadataRepo metadataRepo) {
            ...
            this.mProcessor = new EmojiProcessor(metadataRepo2, emojiCompat.mSpanFactory, emojiCompat.mGlyphChecker, emojiCompat.mUseEmojiAsDefaultStyle, emojiCompat.mEmojiAsDefaultStyleExceptions, EmojiExclusions.getEmojiExclusions());
            this.mEmojiCompat.onMetadataLoadSuccess();
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public void updateEditorInfoAttrs(@NonNull EditorInfo editorInfo) {
            editorInfo.extras.putInt(EmojiCompat.EDITOR_INFO_METAVERSION_KEY, this.mMetadataRepo.mMetadataList.version());
