...
public final class EmojiTextViewHelper {
    ...
    public static class HelperInternal19 extends HelperInternal {
        ...
        @NonNull
        public final InputFilter[] addEmojiInputFilterIfMissing(@NonNull InputFilter[] inputFilterArr) {
        ...
        public final SparseArray<InputFilter> getEmojiInputFilterPositionArray(@NonNull InputFilter[] inputFilterArr) {
        ...
        @NonNull
        public final InputFilter[] removeEmojiInputFilterIfPresent(@NonNull InputFilter[] inputFilterArr) {
        ...
        @Nullable
        public final TransformationMethod unwrapForDisabled(@Nullable TransformationMethod transformationMethod) {
        ...
        @NonNull
        public final TransformationMethod wrapForEnabled(@Nullable TransformationMethod transformationMethod) {
