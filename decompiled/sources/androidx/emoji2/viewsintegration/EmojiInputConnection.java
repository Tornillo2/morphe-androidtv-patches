...
public final class EmojiInputConnection extends InputConnectionWrapper {
    ...
    public boolean deleteSurroundingText(int i, int i2) {
        return this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, this.mTextView.getEditableText(), i, i2, false) || super.deleteSurroundingText(i, i2);
    }

    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean deleteSurroundingTextInCodePoints(int i, int i2) {
        return this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, this.mTextView.getEditableText(), i, i2, true) || super.deleteSurroundingTextInCodePoints(i, i2);
    }
