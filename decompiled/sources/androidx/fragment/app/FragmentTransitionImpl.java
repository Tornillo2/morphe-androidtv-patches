            ...
            if (transitionName != null) {
                ...
                while (true) {
                    ...
                    if (str.equals(arrayList3.get(i2))) {
                        ViewCompat.Api21Impl.setTransitionName(arrayList2.get(i2), transitionName);
                        break;
                    }
                    i2++;
                }
        ...
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            ...
            public void run() {
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    ViewCompat.Api21Impl.setTransitionName((View) arrayList.get(i3), (String) arrayList4.get(i3));
                }
            }
        });
    }
