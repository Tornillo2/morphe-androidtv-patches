...
public class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(ActivityCompat$$ExternalSyntheticOutline0.m(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        SpecialEffectsController.Operation.LifecycleImpact awaitingCompletionLifecycleImpact = viewGroup != null ? SpecialEffectsController.getOrCreateController(viewGroup, fragment3.getParentFragmentManager().getSpecialEffectsControllerFactory()).getAwaitingCompletionLifecycleImpact(this) : null;
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbM = MediaBrowserCompat$CustomActionResultReceiver$$ExternalSyntheticOutline0.m("computeExpectedState() of ", iMin, " for ");
    ...
    public void destroy() {
        ...
        if (fragmentHostCallback instanceof ViewModelStoreOwner) {
            zIsChangingConfigurations = this.mFragmentStore.getNonConfig().mHasBeenCleared;
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i) {
                    ...
                    if (fragment2.mHiddenChanged) {
                        ...
                        fragment4.mChildFragmentManager.dispatchOnHiddenChanged();
                    }
                    ...
                    switch (i + 1) {
                        ...
                        case 4:
                            if (fragment.mView != null && (viewGroup3 = fragment.mContainer) != null) {
                                SpecialEffectsController.getOrCreateController(viewGroup3, fragment.getParentFragmentManager().getSpecialEffectsControllerFactory()).enqueueAdd(SpecialEffectsController.Operation.State.from(this.mFragment.mView.getVisibility()), this);
                            }
