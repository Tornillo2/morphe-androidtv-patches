        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
                ...
                if (fragmentStateManager != null) {
                    ...
                    fragment.dump(strM, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (fragmentFindActiveFragment == null) {
                    throw new IllegalStateException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("No instantiated fragment for (", str, ")"));
                }
                if (FragmentManager.isLoggingEnabled(2)) {
