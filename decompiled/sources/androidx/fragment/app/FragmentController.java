...
public class FragmentController {
    ...
    public List<Fragment> retainNonConfig() {
        ...
        if (fragmentManagerNonConfigRetainNonConfig == null || fragmentManagerNonConfigRetainNonConfig.mFragments == null) {
            return null;
        }
        return new ArrayList(fragmentManagerNonConfigRetainNonConfig.mFragments);
    }
