...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        /* JADX INFO: renamed from: androidx.fragment.app.FragmentTabHost$SavedState$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        ...
        public String toString() {
            ...
            sb.append(" curTab=");
            return ActivityCompat$$ExternalSyntheticOutline0.m(sb, this.curTab, "}");
        }
    ...
    public void addTab(@NonNull TabHost.TabSpec tabSpec, @NonNull Class<?> cls, @Nullable Bundle bundle) {
        ...
        if (this.mAttached) {
            ...
            if (fragmentFindFragmentByTag != null && !fragmentFindFragmentByTag.mDetached) {
                ...
                ((BackStackRecord) fragmentTransactionBeginTransaction).commitInternal(false);
            }
        }
    ...
    @Nullable
    public final FragmentTransaction doTabChanged(@Nullable String str, @Nullable FragmentTransaction fragmentTransaction) {
        Fragment fragment;
    ...
    public final void ensureContent() {
    ...
    public final void ensureHierarchy(Context context) {
