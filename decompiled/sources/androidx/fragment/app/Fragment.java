...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public final OnPreAttachedListener mSavedStateAttachListener;
    ...
    public void callStartTransitionListener(boolean z) {
        ...
        final SpecialEffectsController orCreateController = SpecialEffectsController.getOrCreateController(viewGroup, fragmentManager.getSpecialEffectsControllerFactory());
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(AbstractResolvableFuture$$ExternalSyntheticOutline0.m(str, GlideException.IndentedAppendable.INDENT), fileDescriptor, printWriter, strArr);
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        bundle.putParcelable(FragmentManager.SAVED_STATE_TAG, this.mChildFragmentManager.saveAllStateInternal());
    }
    ...
    @NonNull
    public final <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
    ...
    public final void registerOnPreAttachListener(@NonNull OnPreAttachedListener onPreAttachedListener) {
        if (this.mState >= 0) {
            onPreAttachedListener.onPreAttached();
        } else {
    ...
    public static class SavedState implements Parcelable {
        ...
        /* JADX INFO: renamed from: androidx.fragment.app.Fragment$SavedState$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), (Throwable) e);
        } catch (java.lang.InstantiationException e2) {
            throw new InstantiationException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), (Throwable) e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), (Throwable) e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), (Throwable) e4);
        }
    }
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            layoutInflaterOnGetLayoutInflater.setFactory2(this.mChildFragmentManager.getLayoutInflaterFactory());
            return layoutInflaterOnGetLayoutInflater;
        }
