...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View onFindViewById(int i) {
                return anonymousClass5.onHasView() ? anonymousClass5.onFindViewById(i) : DialogFragment.this.onFindViewById(i);
            }

            @Override // androidx.fragment.app.FragmentContainer
            public boolean onHasView() {
                return anonymousClass5.onHasView() || DialogFragment.this.onHasView();
            }
        };
    }
    ...
    public final void prepareDialog(@Nullable Bundle bundle) {
    ...
    public void show(@NonNull FragmentManager fragmentManager, @Nullable String str) {
        ...
        fragmentTransactionBeginTransaction.mReorderingAllowed = true;
        fragmentTransactionBeginTransaction.doAddOp(0, this, str, 1);
        ((BackStackRecord) fragmentTransactionBeginTransaction).commitInternal(false);
    }
