...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    @GuardedBy("this")
    public final BandwidthEstimator bandwidthEstimator;
    public long initialBitrateEstimate;
    ...
    @GuardedBy("this")
    public final TimeToFirstByteEstimator timeToFirstByteEstimator;
    ...
    public static final class Builder {
        ...
        public TimeToFirstByteEstimator timeToFirstByteEstimator = new PercentileTimeToFirstByteEstimator(20, 0.5f);
        public BandwidthEstimator bandwidthEstimator = new SplitParallelSampleBandwidthEstimator(new SplitParallelSampleBandwidthEstimator.Builder());
        public boolean resetOnNetworkTypeChange = true;
