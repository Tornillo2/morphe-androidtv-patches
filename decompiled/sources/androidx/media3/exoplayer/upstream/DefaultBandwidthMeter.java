...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static int[] getInitialBitrateCountryGroupAssignment(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 2166:
                if (str.equals("CY")) {
                    b = TarConstants.LF_BLK;
                }
                break;
            case 2167:
                if (str.equals("CZ")) {
                    b = TarConstants.LF_DIR;
                }
                break;
            case 2177:
                if (str.equals("DE")) {
                    b = TarConstants.LF_FIFO;
                }
                break;
            case 2182:
                if (str.equals("DJ")) {
                    b = TarConstants.LF_CONTIG;
                }
                break;
            case 2183:
                if (str.equals("DK")) {
            ...
            case 2271:
                if (str.equals("GF")) {
                    b = TarConstants.LF_GNUTYPE_LONGNAME;
                }
                break;
            case 2272:
                if (str.equals("GG")) {
            ...
            case 2281:
                if (str.equals("GP")) {
                    b = TarConstants.LF_GNUTYPE_SPARSE;
                }
                break;
            case 2282:
                if (str.equals("GQ")) {
            ...
            case 2288:
                if (str.equals("GW")) {
                    b = TarConstants.LF_PAX_EXTENDED_HEADER_UC;
                }
                break;
            case 2290:
                if (str.equals("GY")) {
            ...
            case 2339:
                if (str.equals("IL")) {
                    b = IonRawBinaryWriter.TIMESTAMP_TYPE;
                }
                break;
            case 2340:
                if (str.equals("IM")) {
            ...
            case 2347:
                if (str.equals("IT")) {
                    b = TarConstants.LF_PAX_GLOBAL_EXTENDED_HEADER;
                }
                break;
            case 2363:
                if (str.equals("JE")) {
            ...
            case 2402:
                if (str.equals("KM")) {
                    b = IonRawBinaryWriter.SYMBOL_TYPE;
                }
                break;
            case 2403:
                if (str.equals("KN")) {
                    b = DtsUtil.FIRST_BYTE_UHD_FTOC_NONSYNC_BE;
                }
                break;
            case 2407:
                if (str.equals("KR")) {
            ...
            case 2468:
                if (str.equals("MQ")) {
                    b = IonRawBinaryWriter.STRING_TYPE_EXTENDED_LENGTH;
                }
                break;
            case 2469:
                if (str.equals("MR")) {
            ...
            case 2470:
                if (str.equals("MS")) {
                    b = IonRawBinaryWriter.CLOB_TYPE;
                }
                break;
            case 2471:
                if (str.equals("MT")) {
            ...
            case 2498:
                if (str.equals("NP")) {
                    b = IonRawBinaryWriter.BLOB_TYPE;
                }
                break;
            case 2500:
                if (str.equals("NR")) {
            ...
            case 2640:
                ...
                break;
            case 2641:
                if (str.equals(AmazonQuirks.FIRE_PHONE_DEVICE_MODEL)) {
                    b = 187;
                }
                break;
            case 2642:
            ...
            case 2648:
                if (str.equals("SK")) {
                    b = ExifInterface.MARKER_SOF1;
                }
                break;
            case 2649:
                if (str.equals("SL")) {
                    b = ExifInterface.MARKER_SOF2;
                }
                break;
            case 2650:
                if (str.equals("SM")) {
                    b = ExifInterface.MARKER_SOF3;
                }
                break;
            case 2651:
                if (str.equals("SN")) {
            ...
            case 2652:
                if (str.equals("SO")) {
                    b = ExifInterface.MARKER_SOF5;
                }
                break;
            case 2655:
                if (str.equals("SR")) {
                    b = ExifInterface.MARKER_SOF6;
                }
                break;
            case 2656:
                if (str.equals("SS")) {
                    b = ExifInterface.MARKER_SOF7;
                }
                break;
            case 2657:
                if (str.equals("ST")) {
            ...
            case 2659:
                if (str.equals("SV")) {
                    b = ExifInterface.MARKER_SOF9;
                }
                break;
            case 2661:
                if (str.equals("SX")) {
                    b = ExifInterface.MARKER_SOF10;
                }
                break;
            case 2662:
                if (str.equals("SY")) {
                    b = ExifInterface.MARKER_SOF11;
                }
                break;
            case 2663:
                if (str.equals("SZ")) {
            ...
            case 2671:
                if (str.equals("TC")) {
                    b = ExifInterface.MARKER_SOF13;
                }
                break;
            case 2672:
                if (str.equals("TD")) {
                    b = ExifInterface.MARKER_SOF14;
                }
                break;
            case 2675:
                if (str.equals("TG")) {
                    b = ExifInterface.MARKER_SOF15;
                }
                break;
            case 2676:
                if (str.equals("TH")) {
            ...
            case 2690:
                if (str.equals("TV")) {
                    b = ExifInterface.MARKER_SOI;
                }
                break;
            case 2691:
                if (str.equals("TW")) {
                    b = ExifInterface.MARKER_EOI;
                }
                break;
            case 2694:
                if (str.equals("TZ")) {
                    b = ExifInterface.MARKER_SOS;
                }
                break;
            case 2700:
                if (str.equals("UA")) {
            ...
            case 2780:
                if (str.equals("WS")) {
                    b = DtsUtil.FIRST_BYTE_UHD_FTOC_NONSYNC_LE;
                }
                break;
            case 2803:
                if (str.equals("XK")) {
        ...
        switch (b) {
            ...
            case 154:
            case 226:
            case IonReaderBinaryIncremental.IVM_FINAL_BYTE /* 234 */:
            ...
            case 43:
            case ReverseBinaryEncoder.TYPE_STRUCT /* 208 */:
    ...
    public final synchronized void onNetworkTypeChanged(int i) throws Throwable {
        Throwable th;
        try {
            try {
    ...
    /* JADX WARN: Removed duplicated region for block: B:22:0x0056 A[Catch: all -> 0x0073, TRY_ENTER, TryCatch #2 {all -> 0x0073, blocks: (B:3:0x0001, B:7:0x0009, B:11:0x0011, B:13:0x002e, B:23:0x0061, B:22:0x0056), top: B:36:0x0001 }] */
    @Override // androidx.media3.datasource.TransferListener
    /*
    ...
    */
    public synchronized void onTransferEnd(androidx.media3.datasource.DataSource r11, androidx.media3.datasource.DataSpec r12, boolean r13) throws java.lang.Throwable {
        ...
        L10:
            r11 = 0
        L11:
            androidx.media3.common.util.Assertions.checkState(r11)     // Catch: java.lang.Throwable -> L73
            androidx.media3.common.util.Clock r11 = r10.clock     // Catch: java.lang.Throwable -> L73
            ...
            float r11 = r11 / r13
            androidx.media3.exoplayer.upstream.SlidingPercentile r13 = r10.slidingPercentile     // Catch: java.lang.Throwable -> L73
        ...
        L52:
            ...
            goto L7e
        L56:
            androidx.media3.exoplayer.upstream.SlidingPercentile r11 = r10.slidingPercentile     // Catch: java.lang.Throwable -> L73
