...
public final class SilenceSkippingAudioProcessor extends androidx.media3.common.audio.BaseAudioProcessor {
    ...
    public SilenceSkippingAudioProcessor() {
        this(100000L, 0.2f, DEFAULT_MAX_SILENCE_TO_KEEP_DURATION_US, 10, (short) 1024);
    }
    ...
    public final int calculateShortenedSilenceLength(int i) {
        ...
        return alignToBytePerFrameBoundary((int) Math.min((i * this.silenceRetentionRatio) + 0.5f, iDurationUsToFrames));
    }

    public final int durationUsToFrames(long j) {
        return (int) ((j * ((long) this.inputFormat.sampleRate)) / 1000000);
    }
