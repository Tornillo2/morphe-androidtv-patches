...
public class DefaultLoadControl implements LoadControl {
    ...
    public static final class Builder {
        ...
        public DefaultLoadControl build() {
            ...
            if (this.allocator == null) {
                this.allocator = new DefaultAllocator(true, 65536, 0);
            }
    ...
    public DefaultLoadControl() {
        this(new DefaultAllocator(true, 65536, 0), 50000, 50000, 2500, 5000, -1, false, 0, false);
    }
    ...
    public /* synthetic */ boolean shouldStartPlayback(long j, float f, boolean z, long j2) {
        return shouldStartPlayback(Timeline.EMPTY, LoadControl.EMPTY_MEDIA_PERIOD_ID, j, f, z, j2);
    }
