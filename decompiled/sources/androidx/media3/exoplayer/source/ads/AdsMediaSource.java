...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public final class AdMediaSourceHolder {
        ...
        public MediaPeriod createMediaPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
            ...
            if (mediaSource != null) {
                ...
                mediaItem.getClass();
                maskingMediaPeriod.listener = adsMediaSource.new AdPrepareListener(mediaItem);
            }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, MediaItem mediaItem) {
            ...
            for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(i);
                maskingMediaPeriod.setMediaSource(mediaSource);
                maskingMediaPeriod.listener = AdsMediaSource.this.new AdPrepareListener(mediaItem);
            }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        public final MediaItem adMediaItem;

        public static /* synthetic */ void $r8$lambda$L47Zq3dfuUw0yMriU2Qczx5x7vw(AdPrepareListener adPrepareListener, MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
            AdsMediaSource adsMediaSource = AdsMediaSource.this;
        ...
        public static /* synthetic */ void $r8$lambda$iY6j3qciq5aH9HaoVSNuOmhpCg4(AdPrepareListener adPrepareListener, MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource adsMediaSource = AdsMediaSource.this;
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    AdsMediaSource.AdPrepareListener.$r8$lambda$iY6j3qciq5aH9HaoVSNuOmhpCg4(this.f$0, mediaPeriodId);
                }
            });
        }
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            long andIncrement = LoadEventInfo.idSource.getAndIncrement();
            MediaItem.LocalConfiguration localConfiguration = this.adMediaItem.localConfiguration;
            localConfiguration.getClass();
            eventDispatcherCreateEventDispatcher.loadError(new LoadEventInfo(andIncrement, new DataSpec(localConfiguration.uri), SystemClock.elapsedRealtime()), 6, (IOException) AdLoadException.createForAd(iOException), true);
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener.$r8$lambda$L47Zq3dfuUw0yMriU2Qczx5x7vw(this.f$0, mediaPeriodId, iOException);
                }
            });
        }
    }
    ...
    @Nullable
    public static MediaItem.AdsConfiguration getAdsConfiguration(MediaItem mediaItem) {
    ...
    public boolean canUpdateMediaItem(MediaItem mediaItem) {
        return Util.areEqual(getAdsConfiguration(this.contentMediaSource.getMediaItem()), getAdsConfiguration(mediaItem)) && this.contentMediaSource.canUpdateMediaItem(mediaItem);
    }
                    ...
                    if (adMediaSourceHolder != null && !adMediaSourceHolder.hasMediaSource()) {
                        ...
                        if (i2 < mediaItemArr.length && (mediaItemBuild = mediaItemArr[i2]) != null) {
                            if (this.contentDrmConfiguration != null) {
                                MediaItem.Builder builder = new MediaItem.Builder(mediaItemBuild);
                                builder.setDrmConfiguration(this.contentDrmConfiguration);
                                mediaItemBuild = builder.build();
                            }
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public static /* synthetic */ void $r8$lambda$Aclssj4obmXoYqYLco9NUDMQTcM(ComponentListener componentListener, AdPlaybackState adPlaybackState) {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.ComponentListener.$r8$lambda$Aclssj4obmXoYqYLco9NUDMQTcM(this.f$0, adPlaybackState);
                }
            });
        }
