...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    public static /* synthetic */ boolean $r8$lambda$kn6RbvW74OB13KKGATjYUxIN99A(ConcatenatingMediaSource concatenatingMediaSource, Message message) {
        ...
        try {
            ...
            this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: androidx.media3.exoplayer.source.ConcatenatingMediaSource$$ExternalSyntheticLambda0
                ...
                public final boolean handleMessage(Message message) {
                    ConcatenatingMediaSource.$r8$lambda$kn6RbvW74OB13KKGATjYUxIN99A(this.f$0, message);
                    return true;
                }
            });
