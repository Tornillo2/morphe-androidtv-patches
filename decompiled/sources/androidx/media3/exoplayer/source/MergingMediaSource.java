...
public final class MergingMediaSource extends CompositeMediaSource<Integer> {
    ...
    public final Map<Object, Long> clippedDurationsUs;
    public final Multimap<Object, ClippingMediaPeriod> clippedMediaPeriods;
    ...
    public static final class ClippedTimeline extends ForwardingTimeline {
        ...
        public ClippedTimeline(Timeline timeline, Map<Object, Long> map) {
            ...
            for (int i = 0; i < windowCount; i++) {
                this.windowDurationsUs[i] = timeline.getWindow(i, window, 0L).durationUs;
            }
    ...
    public final void computePeriodTimeOffsets() {
        Timeline.Period period = new Timeline.Period();
        for (int i = 0; i < this.periodCount; i++) {
            long j = -this.timelines[0].getPeriod(i, period, false).positionInWindowUs;
            int i2 = 1;
            while (true) {
                Timeline[] timelineArr = this.timelines;
                if (i2 < timelineArr.length) {
                    this.periodTimeOffsetsUs[i][i2] = j - (-timelineArr[i2].getPeriod(i, period, false).positionInWindowUs);
                    i2++;
                }
            }
        }
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        Long l = this.clippedDurationsUs.get(mediaPeriodId.periodUid);
        l.getClass();
    ...
    public final void updateClippedDuration() {
        ...
        for (int i = 0; i < this.periodCount; i++) {
            ...
            while (true) {
                ...
                long j2 = timelineArr[i2].getPeriod(i, period, false).durationUs;
                if (j2 != -9223372036854775807L) {
                    long j3 = j2 + this.periodTimeOffsetsUs[i][i2];
    ...
    public MergingMediaSource(MediaSource... mediaSourceArr) {
        this(false, false, mediaSourceArr);
    }
    ...
    public MergingMediaSource(boolean z, boolean z2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, MediaSource... mediaSourceArr) {
        ...
        this.clippedMediaPeriods = MultimapBuilder.hashKeys(8).arrayListValues(2).build();
    }
}
