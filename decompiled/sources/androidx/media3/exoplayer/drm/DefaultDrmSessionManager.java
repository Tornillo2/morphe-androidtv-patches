...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public class PreacquiredSessionReference implements DrmSessionManager.DrmSessionReference {
        ...
        public static void $r8$lambda$3uBQpbDSBR_JYCKTHo5FzQm93bs(PreacquiredSessionReference preacquiredSessionReference, Format format) {
        ...
        public void acquire(final Format format) {
            ...
            handler.post(new Runnable() { // from class: androidx.media3.exoplayer.drm.DefaultDrmSessionManager$PreacquiredSessionReference$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    DefaultDrmSessionManager.PreacquiredSessionReference.$r8$lambda$3uBQpbDSBR_JYCKTHo5FzQm93bs(this.f$0, format);
                }
            });
        }
        ...
        public void release() {
            Handler handler = DefaultDrmSessionManager.this.playbackHandler;
            handler.getClass();
            Util.postOrRun(handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DefaultDrmSessionManager$PreacquiredSessionReference$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class ReferenceCountListenerImpl implements DefaultDrmSession.ReferenceCountListener {
        ...
        */
        public void onReferenceCountDecremented(final androidx.media3.exoplayer.drm.DefaultDrmSession r7, int r8) {
            /*
                r6 = this;
                r0 = 1
                r1 = -9223372036854775807(0x8000000000000001, double:-4.9E-324)
                if (r8 != r0) goto L32
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r0 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                int r3 = r0.prepareCallsCount
                if (r3 <= 0) goto L32
                long r3 = r0.sessionKeepaliveMs
                int r5 = (r3 > r1 ? 1 : (r3 == r1 ? 0 : -1))
                if (r5 == 0) goto L32
                java.util.Set<androidx.media3.exoplayer.drm.DefaultDrmSession> r8 = r0.keepaliveSessions
                r8.add(r7)
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r8 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                android.os.Handler r8 = r8.playbackHandler
                r8.getClass()
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager$ReferenceCountListenerImpl$$ExternalSyntheticLambda0 r0 = new androidx.media3.exoplayer.drm.DefaultDrmSessionManager$ReferenceCountListenerImpl$$ExternalSyntheticLambda0
                r0.<init>()
            ...
            L32:
                if (r8 != 0) goto L66
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r8 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                java.util.List<androidx.media3.exoplayer.drm.DefaultDrmSession> r8 = r8.sessions
                r8.remove(r7)
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r8 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                androidx.media3.exoplayer.drm.DefaultDrmSession r0 = r8.placeholderDrmSession
                r3 = 0
                if (r0 != r7) goto L44
                r8.placeholderDrmSession = r3
            L44:
                androidx.media3.exoplayer.drm.DefaultDrmSession r0 = r8.noMultiSessionDrmSession
                if (r0 != r7) goto L4a
                r8.noMultiSessionDrmSession = r3
            L4a:
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager$ProvisioningManagerImpl r8 = r8.provisioningManagerImpl
                ...
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r8 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                java.util.Set<androidx.media3.exoplayer.drm.DefaultDrmSession> r8 = r8.keepaliveSessions
                r8.remove(r7)
            L66:
                androidx.media3.exoplayer.drm.DefaultDrmSessionManager r7 = androidx.media3.exoplayer.drm.DefaultDrmSessionManager.this
                r7.maybeReleaseMediaDrm()
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.media3.exoplayer.drm.DefaultDrmSessionManager.ReferenceCountListenerImpl.onReferenceCountDecremented(androidx.media3.exoplayer.drm.DefaultDrmSession, int):void");
        }
