...
public final class AsynchronousMediaCodecAdapter implements MediaCodecAdapter {
    ...
    public static final class Factory implements MediaCodecAdapter.Factory {
        ...
        public static HandlerThread $r8$lambda$dxogLQ4In6z2OlvcYCXGKljyjA8(int i) {
            return new HandlerThread(AsynchronousMediaCodecAdapter.createThreadLabel(i, "ExoPlayer:MediaCodecQueueingThread:"));
        }

        public static HandlerThread $r8$lambda$ywPSKqV55WpaaeBkvRWSdXOPhIk(int i) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$t8iiVXXtPJTyXCy-9oagKLCt2ec, reason: not valid java name */
    public static /* synthetic */ void m143$r8$lambda$t8iiVXXtPJTyXCy9oagKLCt2ec(AsynchronousMediaCodecAdapter asynchronousMediaCodecAdapter, MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, MediaCodec mediaCodec, long j, long j2) {
    ...
    public void setOnFrameRenderedListener(final MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, Handler handler) {
        this.codec.setOnFrameRenderedListener(new MediaCodec.OnFrameRenderedListener() { // from class: androidx.media3.exoplayer.mediacodec.AsynchronousMediaCodecAdapter$$ExternalSyntheticLambda0
            ...
            public final void onFrameRendered(MediaCodec mediaCodec, long j, long j2) {
                AsynchronousMediaCodecAdapter.m143$r8$lambda$t8iiVXXtPJTyXCy9oagKLCt2ec(this.f$0, onFrameRenderedListener, mediaCodec, j, j2);
            }
        }, handler);
    }
