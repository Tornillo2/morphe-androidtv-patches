...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public final int evaluateSelectionEligibility(int i, boolean z, int i2) {
    ...
    public static final class Parameters extends TrackSelectionParameters implements Bundleable {
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            public final void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                ImmutableList<Object> immutableListFromBundleList = parcelableArrayList == null ? RegularImmutableList.EMPTY : BundleCollectionUtil.fromBundleList(new DefaultTrackSelector$Parameters$Builder$$ExternalSyntheticLambda0(), parcelableArrayList);
                SparseArray sparseParcelableArray = bundle.getSparseParcelableArray(Parameters.FIELD_SELECTION_OVERRIDES);
                SparseArray sparseArray = sparseParcelableArray == null ? new SparseArray() : BundleCollectionUtil.fromBundleSparseArray(new DefaultTrackSelector$Parameters$Builder$$ExternalSyntheticLambda1(), sparseParcelableArray);
            ...
            public Builder(Bundle bundle) {
                ...
                this.allowAudioNonSeamlessAdaptiveness = bundle.getBoolean(Parameters.FIELD_ALLOW_AUDIO_NON_SEAMLESS_ADAPTIVENESS, parameters.allowAudioNonSeamlessAdaptiveness);
                ...
                this.allowInvalidateSelectionsOnRendererCapabilitiesChange = bundle.getBoolean(Parameters.FIELD_ALLOW_INVALIDATE_SELECTIONS_ON_RENDERER_CAPABILITIES_CHANGE, parameters.allowInvalidateSelectionsOnRendererCapabilitiesChange);
                this.selectionOverrides = new SparseArray<>();
        ...
        public static void putSelectionOverridesToBundle(Bundle bundle, SparseArray<Map<TrackGroupArray, SelectionOverride>> sparseArray) {
            ...
            for (int i = 0; i < sparseArray.size(); i++) {
                ...
                bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES_TRACK_GROUP_ARRAYS, BundleCollectionUtil.toBundleArrayList(arrayList2, new DefaultTrackSelector$Parameters$$ExternalSyntheticLambda1()));
                bundle.putSparseParcelableArray(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleSparseArray(sparseArray2, new DefaultTrackSelector$Parameters$$ExternalSyntheticLambda2()));
            }
        }
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        @CanIgnoreReturnValue
        public TrackSelectionParameters.Builder setAudioOffloadPreferences(TrackSelectionParameters.AudioOffloadPreferences audioOffloadPreferences) {
            this.delegate.audioOffloadPreferences = audioOffloadPreferences;
            return this;
        }
        ...
        @Override // androidx.media3.common.TrackSelectionParameters.Builder
        @CanIgnoreReturnValue
        public TrackSelectionParameters.Builder setPrioritizeImageOverVideoEnabled(boolean z) {
            this.delegate.isPrioritizeImageOverVideoEnabled = z;
            return this;
        }
    ...
    public static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        public static final float MIN_REASONABLE_FRAME_RATE = 10.0f;
        public final boolean allowMixedMimeTypes;
        public final int bitrate;
    ...
    /* JADX INFO: renamed from: $r8$lambda$1K-J19NFpaFe_HRchMynj9miuKg, reason: not valid java name */
    public static /* synthetic */ int m161$r8$lambda$1KJ19NFpaFe_HRchMynj9miuKg(Integer num, Integer num2) {
        return 0;
    }

    public static /* synthetic */ List $r8$lambda$2T_4iSWD9qbYWNCmj_m_CfgfChw(final DefaultTrackSelector defaultTrackSelector, Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$wDADG2-vDKhCzf_8d2quwv3GXqM, reason: not valid java name */
    public static /* synthetic */ int m163$r8$lambda$wDADG2vDKhCzf_8d2quwv3GXqM(Integer num, Integer num2) {
        if (num.intValue() == -1) {
    ...
    */
    ...
    public static void maybeConfigureRendererForOffload(Parameters parameters, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, RendererConfiguration[] rendererConfigurationArr, ExoTrackSelection[] exoTrackSelectionArr) {
        int i = -1;
        boolean z = false;
        int i2 = 0;
        for (int i3 = 0; i3 < mappedTrackInfo.rendererCount; i3++) {
            ...
            if (i4 != 1 && exoTrackSelection != null) {
                return;
            }
            if (i4 == 1 && exoTrackSelection != null && exoTrackSelection.length() == 1) {
                if (rendererSupportsOffload(parameters, iArr[i3][mappedTrackInfo.rendererTrackGroups[i3].indexOf(exoTrackSelection.getTrackGroup())][exoTrackSelection.getIndexInTrackGroup(0)], exoTrackSelection.getSelectedFormat())) {
                    i2++;
                    i = i3;
                }
            }
        ...
        if (i2 == 1) {
            ...
            rendererConfigurationArr[i] = new RendererConfiguration(i5, z);
        }
    }
    ...
    public static boolean rendererSupportsOffload(Parameters parameters, int i, Format format) {
        if ((i & RendererCapabilities.AUDIO_OFFLOAD_SUPPORT_MASK) == 0) {
            return false;
        }
    ...
    public final void maybeInvalidateForRendererCapabilitiesChange(Renderer renderer) {
        boolean z;
        synchronized (this.lock) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return DefaultTrackSelector.$r8$lambda$2T_4iSWD9qbYWNCmj_m_CfgfChw(this.f$0, parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters, @Nullable final String str) throws ExoPlaybackException {
        ...
        return selectTracksForType(3, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda9
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr2) {
                return DefaultTrackSelector.TextTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, str);
            }
        }, new DefaultTrackSelector$$ExternalSyntheticLambda10());
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(2, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda7
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
