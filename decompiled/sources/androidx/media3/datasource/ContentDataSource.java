            ...
            try {
                ...
                try {
                    try {
                        ...
                        throw new ContentDataSourceException((Throwable) e, 2000);
                    }
                } finally {
                ...
                throw new ContentDataSourceException((Throwable) e2, 2000);
            }
        } catch (Throwable th) {
            this.inputStream = null;
            try {
                try {
                    ...
                    throw new ContentDataSourceException((Throwable) e3, 2000);
                }
            } finally {
                this.assetFileDescriptor = null;
                if (this.opened) {
    ...
    public long open(DataSpec dataSpec) throws ContentDataSourceException {
        ...
        try {
            ...
            if (assetFileDescriptorOpenAssetFileDescriptor == null) {
                throw new ContentDataSourceException((Throwable) new IOException("Could not open file descriptor for: " + uriNormalizeScheme), 2000);
            }
            long length = assetFileDescriptorOpenAssetFileDescriptor.getLength();
            FileInputStream fileInputStream = new FileInputStream(assetFileDescriptorOpenAssetFileDescriptor.getFileDescriptor());
            this.inputStream = fileInputStream;
            if (length != -1 && dataSpec.position > length) {
                throw new ContentDataSourceException((Throwable) null, 2008);
            }
            ...
            throw new ContentDataSourceException((Throwable) e2, e2 instanceof FileNotFoundException ? 2005 : 2000);
        }
    }
