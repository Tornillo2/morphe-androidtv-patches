...
public abstract class Timeline implements Bundleable {
    ...
    public static final String FIELD_PERIODS = Integer.toString(1, 36);
    public static final String FIELD_SHUFFLED_WINDOW_INDICES = Integer.toString(2, 36);

    @UnstableApi
    @Deprecated
    public static final Bundleable.Creator<Timeline> CREATOR = new Timeline$$ExternalSyntheticLambda2();

    /* JADX INFO: renamed from: androidx.media3.common.Timeline$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public static final class Period implements Bundleable {
        ...
        public static final String FIELD_DURATION_US = Integer.toString(1, 36);
        public static final String FIELD_POSITION_IN_WINDOW_US = Integer.toString(2, 36);
        public static final String FIELD_PLACEHOLDER = Integer.toString(3, 36);
        public static final String FIELD_AD_PLAYBACK_STATE = Integer.toString(4, 36);
        ...
        public int hashCode() {
            Object obj = this.id;
            int iHashCode = (DefaultImageHeaderParser.MARKER_EOI + (obj == null ? 0 : obj.hashCode())) * 31;
        ...
        public Period set(@Nullable Object obj, @Nullable Object obj2, int i, long j, long j2) {
            set(obj, obj2, i, j, j2, AdPlaybackState.NONE, false);
            return this;
        }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public int getLastWindowIndex(boolean z) {
            ...
            return z ? this.shuffledWindowIndices[this.windows.size() - 1] : this.windows.size() - 1;
        }
    ...
    public static final class Window implements Bundleable {
        ...
        public static final String FIELD_DEFAULT_POSITION_US;
        public static final String FIELD_DURATION_US;
        public static final String FIELD_ELAPSED_REALTIME_EPOCH_OFFSET_MS;
        public static final String FIELD_FIRST_PERIOD_INDEX;
        public static final String FIELD_IS_DYNAMIC;
        public static final String FIELD_IS_PLACEHOLDER;
        public static final String FIELD_IS_SEEKABLE;
        public static final String FIELD_LAST_PERIOD_INDEX;
        public static final String FIELD_LIVE_CONFIGURATION;
        public static final String FIELD_MEDIA_ITEM;
        public static final String FIELD_POSITION_IN_FIRST_PERIOD_US;
        public static final String FIELD_PRESENTATION_START_TIME_MS;
        public static final String FIELD_WINDOW_START_TIME_MS;
        ...
        static {
            ...
            builder.mediaId = "androidx.media3.common.Timeline";
            ...
            CREATOR = new Timeline$Window$$ExternalSyntheticLambda0();
        }
        ...
        public int hashCode() {
            int iHashCode = (this.mediaItem.hashCode() + ((this.uid.hashCode() + DefaultImageHeaderParser.MARKER_EOI) * 31)) * 31;
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(new Timeline$$ExternalSyntheticLambda0(), BundleUtil.getBinder(bundle, FIELD_WINDOWS));
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(new Timeline$$ExternalSyntheticLambda1(), BundleUtil.getBinder(bundle, FIELD_PERIODS));
    ...
    public final Pair<Object, Long> getPeriodPositionUs(Window window, Period period, int i, long j) {
        Pair<Object, Long> periodPositionUs = getPeriodPositionUs(window, period, i, j, 0L);
    ...
    public int hashCode() {
        Window window = new Window();
        Period period = new Period();
        int windowCount = getWindowCount() + DefaultImageHeaderParser.MARKER_EOI;
        for (int i = 0; i < getWindowCount(); i++) {
