...
public class TrackSelectionParameters implements Bundleable {
    ...
    public static final class AudioOffloadPreferences implements Bundleable {
        ...
        public static final AudioOffloadPreferences DEFAULT = new AudioOffloadPreferences(new Builder());
        public static final String FIELD_AUDIO_OFFLOAD_MODE_PREFERENCE = Util.intToStringMaxRadix(1);
        public static final String FIELD_IS_GAPLESS_SUPPORT_REQUIRED = Integer.toString(2, 36);
        public static final String FIELD_IS_SPEED_CHANGE_SUPPORT_REQUIRED = Integer.toString(3, 36);
        ...
        public static AudioOffloadPreferences fromBundle(Bundle bundle) {
            ...
            builder.audioOffloadMode = bundle.getInt(str, audioOffloadPreferences.audioOffloadMode);
            builder.isGaplessSupportRequired = bundle.getBoolean(FIELD_IS_GAPLESS_SUPPORT_REQUIRED, audioOffloadPreferences.isGaplessSupportRequired);
            builder.isSpeedChangeSupportRequired = bundle.getBoolean(FIELD_IS_SPEED_CHANGE_SUPPORT_REQUIRED, audioOffloadPreferences.isSpeedChangeSupportRequired);
            return new AudioOffloadPreferences(builder);
        }

        public Builder buildUpon() {
            Builder builder = new Builder();
            builder.audioOffloadMode = this.audioOffloadMode;
            builder.isGaplessSupportRequired = this.isGaplessSupportRequired;
            builder.isSpeedChangeSupportRequired = this.isSpeedChangeSupportRequired;
            return builder;
        }
    ...
    static {
        ...
        CREATOR = new TrackSelectionParameters$$ExternalSyntheticLambda1();
    }
    ...
    public static class Builder {
        ...
        public static AudioOffloadPreferences getAudioOffloadPreferencesFromBundle(Bundle bundle) {
            ...
            builder.audioOffloadMode = bundle.getInt(str, audioOffloadPreferences.audioOffloadMode);
            builder.isGaplessSupportRequired = bundle.getBoolean(TrackSelectionParameters.FIELD_IS_GAPLESS_SUPPORT_REQUIRED, audioOffloadPreferences.isGaplessSupportRequired);
            builder.isSpeedChangeSupportRequired = bundle.getBoolean(TrackSelectionParameters.FIELD_IS_SPEED_CHANGE_SUPPORT_REQUIRED, audioOffloadPreferences.isSpeedChangeSupportRequired);
            return new AudioOffloadPreferences(builder);
        }
        ...
        public Builder(Bundle bundle) {
            ...
            if (parcelableArrayList == null) {
                ...
                immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new TrackSelectionParameters$Builder$$ExternalSyntheticLambda0(), parcelableArrayList);
            }
            this.overrides = new HashMap<>();
