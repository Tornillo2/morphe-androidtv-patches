...
public final class MediaItem implements Bundleable {
    ...
    public static final String FIELD_LOCAL_CONFIGURATION = Integer.toString(5, 36);
    ...
    public static final class AdsConfiguration implements Bundleable {
        ...
        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<AdsConfiguration> CREATOR = new MediaItem$AdsConfiguration$$ExternalSyntheticLambda0();
    ...
    public static final class Builder {
        ...
        public MediaItem build() {
            ...
            return new MediaItem(str3, clippingProperties, localConfiguration, liveConfiguration, mediaMetadata, this.requestMetadata);
        }
    ...
    public static class ClippingConfiguration implements Bundleable {
        ...
        public static final class Builder {
            ...
            public Builder setEndPositionMs(long j) {
                setEndPositionUs(Util.msToUs(j));
                return this;
            }
            ...
            public Builder setStartPositionMs(@IntRange(from = 0) long j) {
                setStartPositionUs(Util.msToUs(j));
                return this;
            }
    ...
    public static final class DrmConfiguration implements Bundleable {
        ...
        public static final String FIELD_LICENSE_URI = Integer.toString(1, 36);
        public static final String FIELD_LICENSE_REQUEST_HEADERS = Integer.toString(2, 36);
        public static final String FIELD_MULTI_SESSION = Integer.toString(3, 36);

        @VisibleForTesting
        public static final String FIELD_PLAY_CLEAR_CONTENT_WITHOUT_KEY = Integer.toString(4, 36);
        public static final String FIELD_FORCE_DEFAULT_LICENSE_URI = Integer.toString(5, 36);
        public static final String FIELD_FORCED_SESSION_TRACK_TYPES = Integer.toString(6, 36);
        public static final String FIELD_KEY_SET_ID = Integer.toString(7, 36);

        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<DrmConfiguration> CREATOR = new MediaItem$DrmConfiguration$$ExternalSyntheticLambda0();
        ...
        public static DrmConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableMap<String, String> immutableMapBundleToStringImmutableMap = BundleCollectionUtil.bundleToStringImmutableMap(bundle2);
            ...
            String str2 = FIELD_FORCED_SESSION_TRACK_TYPES;
            ...
            Builder builder = new Builder(uuidFromString);
            builder.licenseUri = uri;
            builder.licenseRequestHeaders = ImmutableMap.copyOf((Map) immutableMapBundleToStringImmutableMap);
            builder.multiSession = z;
            builder.forceDefaultLicenseUri = z3;
            builder.playClearContentWithoutKey = z2;
            builder.forcedSessionTrackTypes = ImmutableList.copyOf((Collection) immutableListCopyOf);
            builder.setKeySetId(byteArray);
    ...
    public static final class LiveConfiguration implements Bundleable {
        ...
        public static LiveConfiguration fromBundle(Bundle bundle) {
            ...
            builder.targetOffsetMs = bundle.getLong(str, liveConfiguration.targetOffsetMs);
    ...
    public static final class LocalConfiguration implements Bundleable {
        ...
        public static final String FIELD_MIME_TYPE = Integer.toString(1, 36);
        public static final String FIELD_DRM_CONFIGURATION = Integer.toString(2, 36);
        public static final String FIELD_ADS_CONFIGURATION = Integer.toString(3, 36);
        public static final String FIELD_STREAM_KEYS = Integer.toString(4, 36);
        public static final String FIELD_CUSTOM_CACHE_KEY = Integer.toString(5, 36);
        public static final String FIELD_SUBTITLE_CONFIGURATION = Integer.toString(6, 36);
        public static final String FIELD_IMAGE_DURATION_MS = Integer.toString(7, 36);

        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<LocalConfiguration> CREATOR = new MediaItem$LocalConfiguration$$ExternalSyntheticLambda2();
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList immutableListOf = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new MediaItem$LocalConfiguration$$ExternalSyntheticLambda3(), parcelableArrayList);
            ArrayList parcelableArrayList2 = bundle.getParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION);
            ImmutableList immutableListOf2 = parcelableArrayList2 == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new MediaItem$LocalConfiguration$$ExternalSyntheticLambda4(), parcelableArrayList2);
            long j = bundle.getLong(FIELD_IMAGE_DURATION_MS, -9223372036854775807L);
            Uri uri = (Uri) bundle.getParcelable(FIELD_URI);
            uri.getClass();
            return new LocalConfiguration(uri, bundle.getString(FIELD_MIME_TYPE), drmConfigurationFromBundle, adsConfigurationFromBundle, immutableListOf, bundle.getString(FIELD_CUSTOM_CACHE_KEY), immutableListOf2, null, j);
        }
    ...
    public static class SubtitleConfiguration implements Bundleable {
        ...
        public static final String FIELD_LABEL = Integer.toString(5, 36);
        public static final String FIELD_ID = Integer.toString(6, 36);

        @UnstableApi
        @Deprecated
        public static final Bundleable.Creator<SubtitleConfiguration> CREATOR = new MediaItem$SubtitleConfiguration$$ExternalSyntheticLambda0();
