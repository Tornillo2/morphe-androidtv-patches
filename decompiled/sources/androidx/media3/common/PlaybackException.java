...
public class PlaybackException extends Exception implements Bundleable {
    ...
    public static final String FIELD_LONG_TIMESTAMP_MS = Integer.toString(1, 36);
    public static final String FIELD_STRING_MESSAGE = Integer.toString(2, 36);
    public static final String FIELD_STRING_CAUSE_CLASS_NAME = Integer.toString(3, 36);
    public static final String FIELD_STRING_CAUSE_MESSAGE = Integer.toString(4, 36);
    ...
    public static Throwable getCauseFromBundle(Bundle bundle) {
        ...
        try {
            ...
            return thCreateThrowable == null ? new RemoteException(string2) : thCreateThrowable;
    ...
    public boolean errorInfoEquals(@Nullable PlaybackException playbackException) {
        ...
        if (playbackException != null && getClass() == playbackException.getClass()) {
            ...
            } else if (!Util.areEqual(cause.getMessage(), cause2.getMessage()) || !cause.getClass().equals(cause2.getClass())) {
                return false;
            }
