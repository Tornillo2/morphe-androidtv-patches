...
public final class GlUtil {
    public static final String EXTENSION_COLORSPACE_BT2020_PQ = "EGL_EXT_gl_colorspace_bt2020_pq";
    ...
    public static final String EXTENSION_YUV_TARGET = "GL_EXT_YUV_target";
    public static final long GL_FENCE_SYNC_FAILED = 0;
    ...
    public static final int[] EGL_WINDOW_SURFACE_ATTRIBUTES_BT2020_PQ = {EGL_GL_COLORSPACE_KHR, EGL_GL_COLORSPACE_BT2020_PQ_EXT, 12344, 12344};
    public static final int[] EGL_WINDOW_SURFACE_ATTRIBUTES_NONE = {12344};
    ...
    public static final class Api17 {
        ...
        public static void checkEglException(String str) throws GlException {
            ...
            StringBuilder sbM = MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection$$ExternalSyntheticOutline0.m(str, ", error code: 0x");
            sbM.append(Integer.toHexString(iEglGetError));
            throw new GlException(sbM.toString());
        }
        ...
        public static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, int i, int[] iArr) throws GlException {
            ...
            throw new GlException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("eglCreateContext() failed to create a valid context. The device may not support EGL version ", i));
        }
    ...
    public static void assertValidTextureSize(int i, int i2) throws GlException {
        int[] iArr = new int[1];
        ...
        if (i > i3 || i2 > i3) {
            throw new GlException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("width or height is greater than GL_MAX_TEXTURE_SIZE ", i3));
        }
    }
    ...
    public static EGLSurface createEglSurface(EGLDisplay eGLDisplay, Object obj, int i, boolean z) throws GlException {
        ...
        if (i == 3 || i == 10) {
            ...
            if (i != 7) {
                throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Unsupported color transfer: ", i));
            }
    ...
    public static EGLSurface createFocusedPlaceholderEglSurface(EGLContext eGLContext, EGLDisplay eGLDisplay) throws GlException {
        ...
        Api17.focusRenderTarget(eGLDisplay, eGLContext, eGLSurfaceCreatePbufferSurface, 0, 1, 1);
    ...
    @RequiresApi(17)
    public static EGLSurface createPbufferSurface(EGLDisplay eGLDisplay, int i, int i2, int[] iArr) throws GlException {
    ...
    public static int createTextureUninitialized(int i, int i2, int i3, int i4) throws GlException {
    ...
    public static boolean isYuvTargetExtensionSupported() {
        ...
        if (Util.areEqual(Api17.getCurrentContext(), EGL14.EGL_NO_CONTEXT)) {
            try {
                EGLDisplay defaultEglDisplay = Api17.getDefaultEglDisplay();
                ...
                Api17.destroyEglContext(defaultEglDisplay, eGLContextCreateEglContext);
            } catch (GlException unused) {
                return false;
            }
        } else {
