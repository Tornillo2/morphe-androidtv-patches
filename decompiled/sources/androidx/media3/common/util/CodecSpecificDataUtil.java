...
public final class CodecSpecificDataUtil {
    ...
    public static final int VISUAL_OBJECT_LAYER = 1;
    public static final int VISUAL_OBJECT_LAYER_START = 32;
    public static final byte[] NAL_START_CODE = {0, 0, 0, 1};
    public static final String[] HEVC_GENERAL_PROFILE_SPACE_STRINGS = {"", ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, "B", "C"};
