...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final class AdGroup implements Bundleable {
        ...
        @VisibleForTesting
        public static final String FIELD_MEDIA_ITEMS = Integer.toString(8, 36);
        ...
        public int hashCode() {
            ...
            long j = this.timeUs;
            int iHashCode = (Arrays.hashCode(this.durationsUs) + ((Arrays.hashCode(this.states) + ((((i + ((int) (j ^ (j >>> 32)))) * 31) + Arrays.hashCode(this.mediaItems)) * 31)) * 31)) * 31;
