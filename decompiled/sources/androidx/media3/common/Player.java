...
public interface Player {
    ...
    public static final class Commands implements Bundleable {
        ...
        public static final String FIELD_COMMANDS = Util.intToStringMaxRadix(0);
        ...
        public static final class Builder {
            ...
            public final FlagSet.Builder flagsBuilder;
        ...
        public Bundle toBundle() {
            ...
            for (int i = 0; i < this.flags.flags.size(); i++) {
    ...
    public interface Listener {
        ...
        /* JADX INFO: renamed from: androidx.media3.common.Player$Listener$-CC, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        public final /* synthetic */ class CC {
            ...
            public static void $default$onPlayerErrorChanged(Listener listener, @Nullable PlaybackException playbackException) {
            }
            ...
            public static void $default$onMediaItemTransition(Listener listener, @Nullable MediaItem mediaItem, int i) {
            }
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        public static final String FIELD_MEDIA_ITEM = Integer.toString(1, 36);

        @VisibleForTesting
        public static final String FIELD_PERIOD_INDEX = Integer.toString(2, 36);

        @VisibleForTesting
        public static final String FIELD_POSITION_MS = Integer.toString(3, 36);

        @VisibleForTesting
        public static final String FIELD_CONTENT_POSITION_MS = Integer.toString(4, 36);
        public static final String FIELD_AD_GROUP_INDEX = Integer.toString(5, 36);
        public static final String FIELD_AD_INDEX_IN_AD_GROUP = Integer.toString(6, 36);
        ...
        public PositionInfo filterByAvailableCommands(boolean z, boolean z2) {
            ...
            int i5 = z2 ? this.mediaItemIndex : 0;
            MediaItem mediaItem2 = z ? this.mediaItem : null;
            Object obj3 = this.periodUid;
            int i6 = z2 ? this.periodIndex : 0;
            long j3 = z ? this.positionMs : 0L;
            long j4 = z ? this.contentPositionMs : 0L;
            int i7 = z ? this.adGroupIndex : -1;
            if (z) {
                i = i6;
                i2 = i5;
            ...
            return new PositionInfo(obj2, i2, mediaItem, obj, i, j2, j, i3, i4);
        }
