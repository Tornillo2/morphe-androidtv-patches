...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    */
    public static androidx.media3.extractor.metadata.id3.Id3Frame decodeFrame(int r19, androidx.media3.common.util.ParsableByteArray r20, boolean r21, int r22, @androidx.annotation.Nullable androidx.media3.extractor.metadata.id3.Id3Decoder.FramePredicate r23) throws java.lang.Throwable {
        /*
    ...
    public static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i) {
        ...
        return new GeobFrame(strNormalizeMimeType, strDecodeStringIfValid, decodeStringIfValid(bArr, iDelimiterLength, iIndexOfTerminator2, charset), copyOfRangeIfValid(bArr, delimiterLength(unsignedByte) + iIndexOfTerminator2, i2));
    }
    ...
    public static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (unsignedByte == 2) {
            ...
            if (unsignedByte != 4) {
                NalUnitUtil$$ExternalSyntheticOutline0.m("Skipped ID3 tag with unsupported majorVersion=", unsignedByte, "Id3Decoder");
                return null;
            }
            if ((unsignedByte2 & 64) != 0) {
