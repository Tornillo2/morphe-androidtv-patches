...
public final class H265Reader implements ElementaryStreamReader {
    ...
    public static Format parseMediaFormat(@Nullable String str, NalUnitTargetBuffer nalUnitTargetBuffer, NalUnitTargetBuffer nalUnitTargetBuffer2, NalUnitTargetBuffer nalUnitTargetBuffer3) {
        ...
        builder2.colorSpace = h265SpsNalUnit.colorSpace;
        builder2.colorRange = h265SpsNalUnit.colorRange;
        builder2.colorTransfer = h265SpsNalUnit.colorTransfer;
        builder2.lumaBitdepth = h265SpsNalUnit.bitDepthLumaMinus8 + 8;
        builder2.chromaBitdepth = h265SpsNalUnit.bitDepthChromaMinus8 + 8;
