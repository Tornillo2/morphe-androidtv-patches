...
public final class BmpExtractor implements Extractor {
    public static final int BMP_FILE_SIGNATURE = 16973;
    public static final int BMP_FILE_SIGNATURE_LENGTH = 2;
    public final SingleSampleExtractor imageExtractor = new SingleSampleExtractor(BMP_FILE_SIGNATURE, 2, MimeTypes.IMAGE_BMP);
