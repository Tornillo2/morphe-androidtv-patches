...
public final class HevcConfig {
    ...
    public static HevcConfig parse(ParsableByteArray parsableByteArray) throws ParserException {
        ...
        try {
            ...
            while (i7 < unsignedByte2) {
                ...
                while (i16 < unsignedShort3) {
                    ...
                    if (unsignedByte3 == 33 && i16 == 0) {
                        ...
                        i11 = h265SpsNalUnit.bitDepthLumaMinus8 + 8;
                        i12 = h265SpsNalUnit.bitDepthChromaMinus8 + 8;
            ...
            return new HevcConfig(i4 == 0 ? Collections.EMPTY_LIST : Collections.singletonList(bArr), unsignedByte + 1, i9, i10, i11, i12, i13, i14, i15, f, strBuildHevcCodecString);
