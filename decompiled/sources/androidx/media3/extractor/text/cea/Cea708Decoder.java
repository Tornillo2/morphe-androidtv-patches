...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public final void handleC0Command(int i) {
        if (i != 0) {
            ...
            switch (i) {
                ...
                default:
                    if (i >= 17 && i <= 23) {
                        NalUnitUtil$$ExternalSyntheticOutline0.m("Currently unsupported COMMAND_EXT1 Command: ", i, "Cea708Decoder");
                        this.captionChannelPacketData.skipBits(8);
                    } else if (i >= 24 && i <= 31) {
                        NalUnitUtil$$ExternalSyntheticOutline0.m("Currently unsupported COMMAND_P16 Command: ", i, "Cea708Decoder");
                        this.captionChannelPacketData.skipBits(16);
                    } else {
                        NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid C0 command: ", i, "Cea708Decoder");
                    }
                    break;
            }
        }
    ...
    public final void handleC1Command(int i) {
        ...
        switch (i) {
            ...
            default:
                NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid C1 command: ", i, "Cea708Decoder");
                break;
            case 151:
                if (this.currentCueInfoBuilder.defined) {
            ...
            default:
                switch (i) {
                    ...
                    case 127:
                        ...
                        break;
                    default:
                        NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid G2 character: ", i, "Cea708Decoder");
                        break;
                }
                break;
        }
    ...
    public final void handleG3Character(int i) {
        if (i == 160) {
            ...
            NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid G3 character: ", i, "Cea708Decoder");
    ...
    public final void processCurrentPacket() {
        ...
        while (true) {
            ...
            if (bits == 7) {
                ...
                if (bits < 7) {
                    NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid extended service number: ", bits, "Cea708Decoder");
                }
            }
            if (bits2 == 0) {
                if (bits != 0) {
                    ...
                    if (bits3 == 16) {
                        ...
                        if (bits4 <= 31) {
                            ...
                            if (bits4 <= 127) {
                                ...
                                NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid extended command: ", bits4, "Cea708Decoder");
                            }
                            z = true;
                        }
                    } else if (bits3 <= 31) {
                        ...
                        if (bits3 <= 127) {
                            ...
                            NalUnitUtil$$ExternalSyntheticOutline0.m("Invalid base command: ", bits3, "Cea708Decoder");
                        }
                        z = true;
                    }
                }
