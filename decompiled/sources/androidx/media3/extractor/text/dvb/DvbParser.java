...
public final class DvbParser implements SubtitleParser {
    ...
    */
    public static int paint2BitPixelCodeString(androidx.media3.common.util.ParsableBitArray r9, int[] r10, @androidx.annotation.Nullable byte[] r11, int r12, int r13, @androidx.annotation.Nullable android.graphics.Paint r14, android.graphics.Canvas r15) {
        /*
            r6 = 0
            r0 = 0
        L2:
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static int paint4BitPixelCodeString(androidx.media3.common.util.ParsableBitArray r9, int[] r10, @androidx.annotation.Nullable byte[] r11, int r12, int r13, @androidx.annotation.Nullable android.graphics.Paint r14, android.graphics.Canvas r15) {
        /*
            r6 = 0
            r0 = 0
        L2:
