...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    public static void $r8$lambda$278Cq622rQ9X9WaDkyOm2xm3rFw(ComponentActivity componentActivity, Context context) {
        Bundle bundleConsumeRestoredStateForKey = componentActivity.mSavedStateRegistryController.savedStateRegistry.consumeRestoredStateForKey(ACTIVITY_RESULT_TAG);
    ...
    public static /* synthetic */ Bundle m0$r8$lambda$71Q7mCYu4mmbnahJ05KgHel0(ComponentActivity componentActivity) {
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorApi16Impl, new Function0() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                ComponentActivity.$r8$lambda$aw7Gh21f7q0ZVK9WcrxuxkkoVwc(this.f$0);
                return null;
            }
        });
            ...
            public <I, O> void onLaunch(final int i, @NonNull ActivityResultContract<I, O> activityResultContract, I i2, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (synchronousResult != null) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.2.1
                        @Override // java.lang.Runnable
                        public void run() {
                            dispatchResult(i, synchronousResult.value);
                        }
                    });
                    return;
                }
                ...
                if (!ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST.equals(intentCreateIntent.getAction())) {
                    componentActivity.startActivityForResult(intentCreateIntent, i, bundle2);
                    return;
                }
                ...
                try {
                    componentActivity.startIntentSenderForResult(intentSenderRequest.intentSender, i3, intentSenderRequest.fillInIntent, intentSenderRequest.flagsMask, intentSenderRequest.flagsValues, 0, bundle2);
        ...
        savedStateRegistryControllerCreate.savedStateRegistry.registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda3
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return ComponentActivity.m0$r8$lambda$71Q7mCYu4mmbnahJ05KgHel0(this.f$0);
            }
        });
        contextAwareHelper.addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda4
    ...
    public final ReportFullyDrawnExecutor createFullyDrawnExecutor() {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        nonConfigurationInstances2.custom = null;
    ...
    public void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        if (ComponentActivity$$ExternalSyntheticNonNull0.m(lifecycle)) {
    ...
    public void reportFullyDrawn() {
        try {
            if (Trace.isEnabled()) {
                android.os.Trace.beginSection(Trace.truncatedTraceSectionLabel("reportFullyDrawn() for ComponentActivity"));
            }
