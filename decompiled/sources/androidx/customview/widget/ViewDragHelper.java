...
public class ViewDragHelper {
    ...
    public static final Interpolator sInterpolator = new AnonymousClass1();
    ...
    /* JADX INFO: renamed from: androidx.customview.widget.ViewDragHelper$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public final boolean checkTouchSlop(View view, float f, float f2) {
        if (view != null) {
            ...
            this.mCallback.getClass();
            if (z && Math.abs(f) > this.mTouchSlop) {
                return true;
            }
        }
        return false;
    ...
    public final int computeSettleDuration(View view, int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        int iComputeAxisDuration = computeAxisDuration(i, iClampMag, this.mCallback.getViewHorizontalDragRange(view));
        this.mCallback.getClass();
        return (int) ((computeAxisDuration(i2, iClampMag2, 0) * f6) + (iComputeAxisDuration * f5));
    }
    ...
    */
    public boolean shouldInterceptTouchEvent(@androidx.annotation.NonNull android.view.MotionEvent r15) {
        /*
    ...
    */
    public boolean checkTouchSlop(int r7, int r8) {
        ...
        L58:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.customview.widget.ViewDragHelper.checkTouchSlop(int, int):boolean");
    }
