...
public abstract class RoomDatabase {
    ...
    public static class MigrationContainer {
        ...
        */
        public final java.util.List<androidx.room.migration.Migration> findUpMigrationPath(java.util.List<androidx.room.migration.Migration> r6, boolean r7, int r8, int r9) {
            /*
                r5 = this;
            L0:
                if (r7 == 0) goto L5
