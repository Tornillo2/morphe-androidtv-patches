...
public final class WorkSpecDao_Impl implements WorkSpecDao {
    ...
    public WorkSpecDao_Impl(RoomDatabase __db) {
        ...
        this.__insertionAdapterOfWorkSpec = new EntityInsertionAdapter<WorkSpec>(__db) { // from class: androidx.work.impl.model.WorkSpecDao_Impl.1
            ...
            public void bind(SupportSQLiteStatement supportSQLiteStatement, WorkSpec workSpec) throws Throwable {
                ...
                byte[] bArrContentUriTriggersToByteArray = WorkTypeConverters.contentUriTriggersToByteArray(constraints.mContentUriTriggers);
    ...
    public List<WorkSpec> getAllEligibleWorkSpecsForScheduling(final int maxLimit) throws Throwable {
        ...
        try {
            ...
            columnIndexOrThrow13 = CursorUtil.getColumnIndexOrThrow(cursorQuery, TvContractCompat.PARAM_INPUT);
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                ...
                constraints.mRequiredNetworkType = WorkTypeConverters.intToNetworkType(cursorQuery.getInt(columnIndexOrThrow));
                ...
                constraints.mContentUriTriggers = WorkTypeConverters.byteArrayToContentUriTriggers(cursorQuery.getBlob(columnIndexOrThrow8));
    ...
    public LiveData<List<String>> getAllWorkSpecIdsLiveData() {
        ...
        return this.__db.getInvalidationTracker().createLiveData(new String[]{"workspec"}, true, new Callable<List<String>>() { // from class: androidx.work.impl.model.WorkSpecDao_Impl.10
            ...
            public List<String> call() throws Exception {
                ...
                try {
                    Cursor cursorQuery = WorkSpecDao_Impl.this.__db.query(roomSQLiteQueryAcquire, (CancellationSignal) null);
                    try {
                        ArrayList arrayList = new ArrayList(cursorQuery.getCount());
                        while (cursorQuery.moveToNext()) {
                            arrayList.add(cursorQuery.getString(0));
    ...
    public List<WorkSpec> getRecentlyCompletedWork(final long startingAt) throws Throwable {
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                ...
                workSpec.intervalDuration = cursorQuery.getLong(i9);
                int i11 = columnIndexOrThrow4;
                int i12 = columnIndexOrThrow17;
                workSpec.flexDuration = cursorQuery.getLong(i12);
                int i13 = columnIndexOrThrow18;
    ...
    public WorkSpec getWorkSpec(final String id) throws Throwable {
        ...
        try {
            ...
            int columnIndexOrThrow13 = CursorUtil.getColumnIndexOrThrow(cursorQuery, TvContractCompat.PARAM_INPUT);
    ...
    public WorkSpec[] getWorkSpecs(final List<String> ids) throws Throwable {
        RoomSQLiteQuery roomSQLiteQuery;
        StringBuilder sbM = AccessibilityServiceInfoCompat$$ExternalSyntheticOutline0.m("SELECT * FROM workspec WHERE id IN (");
        int size = ids.size();
        StringUtil.appendPlaceholders(sbM, size);
        sbM.append(")");
        RoomSQLiteQuery roomSQLiteQueryAcquire = RoomSQLiteQuery.acquire(sbM.toString(), size);
        int i = 1;
        for (String str : ids) {
            if (str == null) {
    ...
    public List<WorkSpec.WorkInfoPojo> getWorkStatusPojoForIds(final List<String> ids) {
        StringBuilder sbM = AccessibilityServiceInfoCompat$$ExternalSyntheticOutline0.m("SELECT id, state, output, run_attempt_count FROM workspec WHERE id IN (");
        int size = ids.size();
        StringUtil.appendPlaceholders(sbM, size);
        sbM.append(")");
        RoomSQLiteQuery roomSQLiteQueryAcquire = RoomSQLiteQuery.acquire(sbM.toString(), size);
    ...
    public LiveData<List<WorkSpec.WorkInfoPojo>> getWorkStatusPojoLiveDataForIds(final List<String> ids) {
        ...
        StringUtil.appendPlaceholders(sbM, size);
        sbM.append(")");
        final RoomSQLiteQuery roomSQLiteQueryAcquire = RoomSQLiteQuery.acquire(sbM.toString(), size);
        int i = 1;
        for (String str : ids) {
            if (str == null) {
                roomSQLiteQueryAcquire.bindNull(i);
    ...
    public int setState(final WorkInfo.State state, final String... ids) {
        ...
        StringUtil.appendPlaceholders(sb, ids.length);
        sb.append(")");
        SupportSQLiteStatement supportSQLiteStatementCompileStatement = this.__db.compileStatement(sb.toString());
