...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        RoomOpenHelper roomOpenHelper = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(12) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void createAllTables(SupportSQLiteDatabase _db) {
                ...
                _db.execSQL(WorkDatabaseMigrations.CREATE_SYSTEM_ID_INFO);
                ...
                _db.execSQL(WorkDatabaseMigrations.CREATE_WORK_PROGRESS);
                _db.execSQL(WorkDatabaseMigrations.CREATE_PREFERENCE);
            ...
            public void dropAllTables(SupportSQLiteDatabase _db) {
                ...
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        WorkDatabase_Impl.this.mCallbacks.get(i).getClass();
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase _db) {
                ...
                if (list != null) {
                    int size = list.size();
                    for (int i = 0; i < size; i++) {
                        WorkDatabase_Impl.this.mCallbacks.get(i).onOpen(_db);
                    }
                }
            }
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                map2.put(TvContractCompat.PARAM_INPUT, new TableInfo.Column(TvContractCompat.PARAM_INPUT, "BLOB", true, 0, null, 1));
        ...
        SupportSQLiteOpenHelper.Configuration.Builder builder = new SupportSQLiteOpenHelper.Configuration.Builder(configuration.context);
        builder.mName = configuration.name;
        builder.mCallback = roomOpenHelper;
        return configuration.sqliteOpenHelperFactory.create(builder.build());
    }
