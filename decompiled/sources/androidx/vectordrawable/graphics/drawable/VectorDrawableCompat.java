...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public final void inflateInternal(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        VectorDrawableCompatState vectorDrawableCompatState = this.mVectorState;
    ...
    public final void printGroupTree(VGroup vGroup, int i) {
        String strM = "";
        for (int i2 = 0; i2 < i; i2++) {
            strM = AbstractResolvableFuture$$ExternalSyntheticOutline0.m(strM, JsonKt.defaultIndent);
        }
        StringBuilder sbM = MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection$$ExternalSyntheticOutline0.m(strM, "current group is :");
        sbM.append(vGroup.getGroupName());
        sbM.append(" rotation is ");
        sbM.append(vGroup.mRotate);
        Log.v(LOGTAG, sbM.toString());
        Log.v(LOGTAG, strM + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    public final void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) throws XmlPullParserException {
        VectorDrawableCompatState vectorDrawableCompatState = this.mVectorState;
        VPathRenderer vPathRenderer = vectorDrawableCompatState.mVPathRenderer;
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                sbM.append(pathDataNodeArr[i].mType);
                sbM.append(":");
                string = sbM.toString();
                for (float f : pathDataNodeArr[i].mParams) {
                    StringBuilder sbM2 = AccessibilityServiceInfoCompat$$ExternalSyntheticOutline0.m(string);
                    sbM2.append(f);
                    sbM2.append(",");
        ...
        public void printVPath(int i) {
            ...
            StringBuilder sbM = MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection$$ExternalSyntheticOutline0.m(strM, "current path is :");
            sbM.append(this.mPathName);
            sbM.append(" pathData is ");
            sbM.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbM.toString());
        }
    ...
    public static class VFullPath extends VPath {
        ...
        public final Paint.Cap getStrokeLineCap(int i, Paint.Cap cap) {
            return i != 0 ? i != 1 ? i != 2 ? cap : Paint.Cap.SQUARE : Paint.Cap.ROUND : Paint.Cap.BUTT;
        }

        public final Paint.Join getStrokeLineJoin(int i, Paint.Join join) {
        ...
        public final void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) {
            ...
            if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
                ...
                this.mFillAlpha = f;
                this.mStrokeLineCap = getStrokeLineCap(!TypedArrayUtils.hasAttribute(xmlPullParser, "strokeLineCap") ? -1 : typedArray.getInt(8, -1), this.mStrokeLineCap);
                this.mStrokeLineJoin = getStrokeLineJoin(TypedArrayUtils.hasAttribute(xmlPullParser, "strokeLineJoin") ? typedArray.getInt(9, -1) : -1, this.mStrokeLineJoin);
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (vObject instanceof VGroup) {
                    ...
                    if (vObject instanceof VFullPath) {
                        ...
                        vClipPath = new VClipPath((VPath) vObject);
                    } else {
    ...
    public static class VPathRenderer {
        ...
        public final void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
