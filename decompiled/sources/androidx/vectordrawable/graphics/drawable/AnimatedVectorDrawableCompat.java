...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId != 0) {
                        ...
                        vectorDrawableCompatCreate.mAllowCaching = false;
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i = 0; i < size; i++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i)).getClass();
                    }
                }
    ...
    public final void setupAnimatorsForTarget(String str, Animator animator) {
    ...
    public final void setupColorAnimator(Animator animator) {
