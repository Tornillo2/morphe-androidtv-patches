...
public abstract class LongList {
    ...
    public int hashCode() {
        ...
        int iM = 0;
        for (int i2 = 0; i2 < i; i2++) {
            iM += FloatFloatPair$$ExternalSyntheticBackport0.m(jArr[i2]) * 31;
        }
        return iM;
    }
        ...
        if (obj == null) {
            ...
            while (true) {
                if (i4 < i3) {
                    ...
                    sbM.append((CharSequence) function1.invoke(Long.valueOf(j)));
                    i4++;
                } else {
                    sbM.append(postfix);
                    break;
    ...
    public final String joinToString(@NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i, @NotNull CharSequence charSequence, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        ...
        while (true) {
            if (i3 < i2) {
                ...
                sbM.append(function1.invoke(Long.valueOf(j)));
                i3++;
            } else {
                sbM.append(postfix);
                break;
