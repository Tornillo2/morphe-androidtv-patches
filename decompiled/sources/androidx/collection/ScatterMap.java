...
public abstract class ScatterMap<K, V> {
    ...
    */
    ...
    public final V getOrElse(K k, @NotNull Function0<? extends V> defaultValue) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean any(@org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super K, ? super V, java.lang.Boolean> r19) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence separator, @NotNull CharSequence prefix, @NotNull CharSequence charSequence, int i, @NotNull CharSequence charSequence2, @Nullable Function2<? super K, ? super V, ? extends CharSequence> function2) {
        Object[] objArr;
        Object[] objArr2;
        Object[] objArr3;
        Object[] objArr4;
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            if (function2 == null) {
                                ...
                                sbM.append(function2.invoke(obj, obj2));
                            }
                            i3++;
                        } else {
                            objArr3 = objArr5;
