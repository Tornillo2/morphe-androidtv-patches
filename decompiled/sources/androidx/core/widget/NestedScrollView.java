...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
        ...
        */
        public boolean performAccessibilityAction(android.view.View r5, int r6, android.os.Bundle r7) {
            ...
            L80:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.AccessibilityDelegate.performAccessibilityAction(android.view.View, int, android.os.Bundle):boolean");
        }
    }
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        /* JADX INFO: renamed from: androidx.core.widget.NestedScrollView$SavedState$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        ...
        public String toString() {
            ...
            return MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline1.m(sb, this.scrollPosition, "}");
        }
    ...
    public int consumeFlingInVerticalStretch(int i) {
        ...
        if (i > 0 && EdgeEffectCompat.getDistance(this.mEdgeGlowTop) != 0.0f) {
            int iRound = Math.round(EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, ((-i) * 4.0f) / height, 0.5f) * ((-height) / 4.0f));
            if (iRound != i) {
        ...
        float f = height;
        int iRound2 = Math.round(EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, (i * 4.0f) / f, 0.5f) * (f / 4.0f));
        if (iRound2 != i) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final android.view.View findFocusableViewInBounds(boolean r13, int r14, int r15) {
        /*
            r12 = this;
            r0 = 2
    ...
    public final float getSplineFlingDistance(int i) {
        double dLog = Math.log((Math.abs(i) * 0.35f) / (this.mPhysicalCoeff * 0.015f));
        float f = DECELERATION_RATE;
        return (float) (Math.exp((((double) f) / (((double) f) - 1.0d)) * dLog) * ((double) (this.mPhysicalCoeff * 0.015f)));
    }
    ...
    public final void initializeTouchDrag(int i, int i2) {
        this.mLastMotionY = i;
    ...
    */
    ...
    public final boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i) {
        if (i > 0) {
            return true;
        }
