...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfoCompat.setScreenReaderFocusable(ViewCompat.isScreenReaderFocusable(view));
            accessibilityNodeInfoCompat.setHeading(ViewCompat.isAccessibilityHeading(view));
            accessibilityNodeInfoCompat.setPaneTitle(ViewCompat.getAccessibilityPaneTitle(view));
            accessibilityNodeInfoCompat.setStateDescription(ViewCompat.getStateDescription(view));
            ...
            for (int i = 0; i < actionList.size(); i++) {
                accessibilityNodeInfoCompat.addAction(actionList.get(i));
            }
        }
    ...
    public final boolean isSpanStillValid(ClickableSpan clickableSpan, View view) {
    ...
    public final boolean performClickableSpanAction(int i, View view) {
