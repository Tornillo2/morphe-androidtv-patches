    ...
    public static class Impl21 extends Impl {
        ...
        public static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public Impl21OnApplyWindowInsetsListener(@NonNull View view, @NonNull Callback callback) {
                ...
                this.mLastInsets = rootWindowInsets != null ? new WindowInsetsCompat.Builder(rootWindowInsets).mImpl.build() : null;
            }
            ...
            public WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                final ValueAnimator duration = ValueAnimator.ofFloat(0.0f, 1.0f).setDuration(windowInsetsAnimationCompat.mImpl.getDurationMillis());
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        Impl21.dispatchOnProgress(view, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat2, windowInsetsAnimationCompat.mImpl.getInterpolatedFraction(), iBuildAnimationMask), Collections.singletonList(windowInsetsAnimationCompat));
                    }
                });
        ...
        public static void dispatchOnEnd(@NonNull View view, @NonNull WindowInsetsAnimationCompat windowInsetsAnimationCompat) {
            ...
            if ((callback == null || callback.mDispatchMode != 0) && (view instanceof ViewGroup)) {
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsetsAnimation.Bounds onStart(@NonNull WindowInsetsAnimation windowInsetsAnimation, @NonNull WindowInsetsAnimation.Bounds bounds) {
                BoundsCompat boundsCompatOnStart = this.mCompat.onStart(getWindowInsetsAnimationCompat(windowInsetsAnimation), new BoundsCompat(bounds));
                boundsCompatOnStart.getClass();
                return Impl30.createPlatformBounds(boundsCompatOnStart);
            }
        }
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(@NonNull BoundsCompat boundsCompat) {
            WindowInsetsAnimationCompat$Impl30$$ExternalSyntheticApiModelOutline2.m();
            return WindowInsetsAnimationCompat$Impl30$$ExternalSyntheticApiModelOutline1.m(boundsCompat.mLowerBound.toPlatformInsets(), boundsCompat.mUpperBound.toPlatformInsets());
        }
