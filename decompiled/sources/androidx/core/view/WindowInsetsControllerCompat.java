...
public final class WindowInsetsControllerCompat {
    ...
    public static class Impl30 extends Impl {
        ...
        /* JADX INFO: renamed from: $r8$lambda$dB4TddSL6qemvhMnqt_qA-OHo8o, reason: not valid java name */
        public static /* synthetic */ void m52$r8$lambda$dB4TddSL6qemvhMnqt_qAOHo8o(Impl30 impl30, OnControllableInsetsChangedListener onControllableInsetsChangedListener, WindowInsetsController windowInsetsController, int i) {
        ...
        public void addOnControllableInsetsChangedListener(@NonNull final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda1
                @Override // android.view.WindowInsetsController.OnControllableInsetsChangedListener
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    WindowInsetsControllerCompat.Impl30.m52$r8$lambda$dB4TddSL6qemvhMnqt_qAOHo8o(this.f$0, onControllableInsetsChangedListener, windowInsetsController, i);
                }
            };
        ...
        public int getSystemBarsBehavior() {
            ...
            Object tag = window.getDecorView().getTag(Impl.KEY_BEHAVIOR);
            if (tag != null) {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public void removeOnControllableInsetsChangedListener(@NonNull OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListenerM = WindowInsetsControllerCompat$Impl30$$ExternalSyntheticApiModelOutline0.m(this.mListeners.remove(onControllableInsetsChangedListener));
        ...
        public void setSystemBarsBehavior(int i) {
            ...
            window.getDecorView().setTag(Impl.KEY_BEHAVIOR, Integer.valueOf(i));
            if (i == 0) {
    ...
    public static class Impl {
        public static final int KEY_BEHAVIOR = 356039078;
    ...
    public static class Impl20 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public int getSystemBarsBehavior() {
            Object tag = this.mWindow.getDecorView().getTag(Impl.KEY_BEHAVIOR);
            if (tag != null) {
                return ((Integer) tag).intValue();
            }
            return 1;
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        public void setSystemBarsBehavior(int i) {
            this.mWindow.getDecorView().setTag(Impl.KEY_BEHAVIOR, Integer.valueOf(i));
            if (i == 0) {
                unsetSystemUiFlag(6144);
                return;
            }
