...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            ...
                            builder.mImpl.setStableInsets(Insets.of(rect));
                            builder.mImpl.setSystemWindowInsets(Insets.of(rect2));
                            WindowInsetsCompat windowInsetsCompatBuild = builder.mImpl.build();
    ...
    public static final class Type {
        ...
        public static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("type needs to be >= FIRST and <= LAST, type=", i));
        }
    ...
    public boolean hasInsets() {
        ...
        return (insets.equals(insets2) && getInsetsIgnoringVisibility(-9).equals(insets2) && getDisplayCutout() == null) ? false : true;
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        ...
        builder.mImpl.setSystemWindowInsets(Insets.of(i, i2, i3, i4));
        return builder.mImpl.build();
    }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setDisplayCutout(@Nullable DisplayCutoutCompat displayCutoutCompat) {
            this.mPlatBuilder.setDisplayCutout(displayCutoutCompat != null ? displayCutoutCompat.mDisplayCutout : null);
        }
        ...
        public BuilderImpl29(@NonNull WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builderM = WindowInsetsCompat$BuilderImpl29$$ExternalSyntheticApiModelOutline1.m(windowInsets);
            } else {
                builderM = WindowInsetsCompat$BuilderImpl29$$ExternalSyntheticApiModelOutline0.m();
            }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        Builder builder = new Builder(this);
        builder.mImpl.setSystemWindowInsets(Insets.of(rect));
        return builder.mImpl.build();
    }
    ...
    public static class Impl {
        ...
        @NonNull
        public static final WindowInsetsCompat CONSUMED = new Builder().mImpl.build().consumeDisplayCutout().consumeStableInsets().consumeSystemWindowInsets();
