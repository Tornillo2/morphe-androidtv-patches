...
public final class ViewConfigurationCompat {
    ...
    public static int getPlatformResId(Resources resources, String str, String str2) {
        return resources.getIdentifier(str, str2, ResourceDrawableDecoder.ANDROID_PACKAGE_NAME);
    }

    public static int getPreApi34MaximumFlingVelocityResId(Resources resources, int i, int i2) {
        if (i == 4194304 && i2 == 26) {
            return resources.getIdentifier("config_viewMaxRotaryEncoderFlingVelocity", "dimen", ResourceDrawableDecoder.ANDROID_PACKAGE_NAME);
        }
        return -1;
    }
    ...
    public static int getPreApi34MinimumFlingVelocityResId(Resources resources, int i, int i2) {
        if (i == 4194304 && i2 == 26) {
            return resources.getIdentifier("config_viewMinRotaryEncoderFlingVelocity", "dimen", ResourceDrawableDecoder.ANDROID_PACKAGE_NAME);
        }
        return -1;
    }
    ...
    public static boolean shouldShowMenuShortcutsWhenKeyboardPresent(@NonNull ViewConfiguration viewConfiguration, @NonNull Context context) {
        ...
        Resources resources = context.getResources();
        int identifier = resources.getIdentifier("config_showMenuShortcutsWhenKeyboardPresent", "bool", ResourceDrawableDecoder.ANDROID_PACKAGE_NAME);
