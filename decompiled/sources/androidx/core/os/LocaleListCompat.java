...
public final class LocaleListCompat {
    ...
    public static class Api21Impl {
        public static final Locale[] PSEUDO_LOCALE = {new Locale("en", "XA"), new Locale(ArchiveStreamFactory.AR, "XB")};
    ...
    public static Locale forLanguageTagCompat(String str) {
        if (str.contains("-")) {
            ...
            if (!str.contains(Attributes.PREDEFINED_ATTRIBUTE_PREFIX)) {
                return new Locale(str);
            }
            String[] strArrSplit2 = str.split(Attributes.PREDEFINED_ATTRIBUTE_PREFIX, -1);
        ...
        throw new IllegalArgumentException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("Can not parse language tag: [", str, "]"));
    }
