...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), params.mPaint, Integer.MAX_VALUE).setBreakStrategy(params.mBreakStrategy).setHyphenationFrequency(params.mHyphenationFrequency).setTextDirection(params.mTextDir).build();
                charSequence2 = charSequence;
            } else {
                charSequence2 = charSequence;
                new StaticLayout(charSequence2, params.mPaint, Integer.MAX_VALUE, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
            return new PrecomputedTextCompat(charSequence2, params, iArr);
        } finally {
            Trace.endSection();
        }
    }
    ...
    public PrecomputedText getPrecomputedText() {
        ...
        if (PrecomputedTextCompat$$ExternalSyntheticApiModelOutline0.m(spannable)) {
            return PrecomputedTextCompat$$ExternalSyntheticApiModelOutline1.m(spannable);
        }
        return null;
    }
    ...
    public static final class Params {
        ...
        public Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = PrecomputedTextCompat$Params$$ExternalSyntheticApiModelOutline0.m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
        ...
        public int hashCode() {
            return Build.VERSION.SDK_INT >= 24 ? Objects.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(this.mPaint.getLetterSpacing()), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocales(), this.mPaint.getTypeface(), Boolean.valueOf(this.mPaint.isElegantTextHeight()), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency)) : Objects.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(this.mPaint.getLetterSpacing()), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocale(), this.mPaint.getTypeface(), Boolean.valueOf(this.mPaint.isElegantTextHeight()), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
        }
