...
public final class TimeUtils {
    ...
    public static int formatDurationLocked(long j, int i) {
        ...
        if (i != 0) {
            ...
            int iAccumField2 = accumField(i3, 1, iAccumField > 0, 2) + iAccumField;
            int iAccumField3 = accumField(i4, 1, iAccumField2 > 0, 2) + iAccumField2;
            int iAccumField4 = accumField(iFloor, 1, iAccumField3 > 0, 2) + iAccumField3;
            i5 = 0;
            for (int iAccumField5 = accumField(i7, 2, true, iAccumField4 > 0 ? 3 : 0) + 1 + iAccumField4; iAccumField5 < i; iAccumField5++) {
                cArr[i5] = ' ';
                i5++;
            }
        } else {
