...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(this.id);
            sb.append(", tag:");
            return ActivityCompat$$ExternalSyntheticOutline0.m(sb, this.tag, "]");
        }
    }
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                ...
                if (!collection.contains(notificationChannelM.getId()) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM)))) {
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM = NotificationManagerCompat$$ExternalSyntheticApiModelOutline0.m(it.next());
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(NotificationChannelGroupCompat$$ExternalSyntheticApiModelOutline0.m(it.next())));
                }
                return arrayList;
            }
        }
