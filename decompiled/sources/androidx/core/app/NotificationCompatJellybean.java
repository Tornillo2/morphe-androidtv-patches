...
public class NotificationCompatJellybean {
    ...
    public static Bundle toBundle(RemoteInput remoteInput) {
        Bundle bundle = new Bundle();
        bundle.putString(KEY_RESULT_KEY, remoteInput.mResultKey);
        bundle.putCharSequence(KEY_LABEL, remoteInput.mLabel);
        bundle.putCharSequenceArray(KEY_CHOICES, remoteInput.mChoices);
        bundle.putBoolean(KEY_ALLOW_FREE_FORM_INPUT, remoteInput.mAllowFreeFormTextInput);
