...
public class NotificationCompat {
            ...
            public static Builder fromAndroidAction(@NonNull Notification.Action action) {
                ...
                if (remoteInputs != null && remoteInputs.length != 0) {
                    for (android.app.RemoteInput remoteInput : remoteInputs) {
                        builder.addRemoteInput(RemoteInput.Api20Impl.fromPlatform(remoteInput));
                    }
                }
                ...
                if (i >= 28) {
                    builder.mSemanticAction = Api28Impl.getSemanticAction(action);
                }
                if (i >= 29) {
                    builder.mIsContextual = Api29Impl.isContextual(action);
                }
                if (i >= 31) {
                    builder.mAuthenticationRequired = Api31Impl.isAuthenticationRequired(action);
                }
    ...
    public static class BigPictureStyle extends Style {
        ...
        public static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$BigPictureStyle$$ExternalSyntheticApiModelOutline0.m(parcelable)) {
    ...
    public static final class BubbleMetadata {
        ...
        public static class Api29Impl {
            ...
            public static Notification.BubbleMetadata toPlatform(@Nullable BubbleMetadata bubbleMetadata) {
                if (bubbleMetadata == null || bubbleMetadata.mPendingIntent == null) {
                    return null;
                }
                Notification.BubbleMetadata.Builder suppressNotification = new Notification.BubbleMetadata.Builder().setIcon(bubbleMetadata.mIcon.toIcon()).setIntent(bubbleMetadata.mPendingIntent).setDeleteIntent(bubbleMetadata.mDeleteIntent).setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
        ...
        public static class Api30Impl {
            ...
            public static Notification.BubbleMetadata toPlatform(@Nullable BubbleMetadata bubbleMetadata) {
                ...
                Notification.BubbleMetadata.Builder builder = bubbleMetadata.mShortcutId != null ? new Notification.BubbleMetadata.Builder(bubbleMetadata.mShortcutId) : new Notification.BubbleMetadata.Builder(bubbleMetadata.mPendingIntent, bubbleMetadata.mIcon.toIcon());
                builder.setDeleteIntent(bubbleMetadata.mDeleteIntent).setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
                int i = bubbleMetadata.mDesiredHeight;
                if (i != 0) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            Style styleConstructStyleForExtras = bundle == null ? null : Style.constructStyleForExtras(bundle);
            setContentTitle(notification.extras.getCharSequence(NotificationCompat.EXTRA_TITLE)).setContentText(notification.extras.getCharSequence(NotificationCompat.EXTRA_TEXT)).setContentInfo(notification.extras.getCharSequence(NotificationCompat.EXTRA_INFO_TEXT)).setSubText(notification.extras.getCharSequence(NotificationCompat.EXTRA_SUB_TEXT)).setSettingsText(NotificationCompat.getSettingsText(notification)).setStyle(styleConstructStyleForExtras).setGroup(notification.getGroup()).setGroupSummary(NotificationCompat.isGroupSummary(notification)).setLocusId(NotificationCompat.getLocusId(notification)).setWhen(notification.when).setShowWhen(notification.extras.getBoolean(NotificationCompat.EXTRA_SHOW_WHEN)).setUsesChronometer(notification.extras.getBoolean(NotificationCompat.EXTRA_SHOW_CHRONOMETER)).setAutoCancel(NotificationCompat.getAutoCancel(notification)).setOnlyAlertOnce(NotificationCompat.getOnlyAlertOnce(notification)).setOngoing(NotificationCompat.getOngoing(notification)).setLocalOnly(NotificationCompat.getLocalOnly(notification)).setLargeIcon(notification.largeIcon).setBadgeIconType(NotificationCompat.getBadgeIconType(notification)).setCategory(notification.category).setBubbleMetadata(NotificationCompat.getBubbleMetadata(notification)).setNumber(notification.number).setTicker(notification.tickerText).setContentIntent(notification.contentIntent).setDeleteIntent(notification.deleteIntent).setFullScreenIntent(notification.fullScreenIntent, NotificationCompat.getHighPriority(notification)).setSound(notification.sound, notification.audioStreamType).setVibrate(notification.vibrate).setLights(notification.ledARGB, notification.ledOnMS, notification.ledOffMS).setDefaults(notification.defaults).setPriority(notification.priority).setColor(notification.color).setVisibility(notification.visibility).setPublicVersion(notification.publicVersion).setSortKey(notification.getSortKey()).setTimeoutAfter(NotificationCompat.getTimeoutAfter(notification)).setShortcutId(NotificationCompat.getShortcutId(notification)).setProgress(bundle.getInt(NotificationCompat.EXTRA_PROGRESS_MAX), bundle.getInt(NotificationCompat.EXTRA_PROGRESS), bundle.getBoolean(NotificationCompat.EXTRA_PROGRESS_INDETERMINATE)).setAllowSystemGeneratedContextualActions(NotificationCompat.getAllowSystemGeneratedContextualActions(notification)).setSmallIcon(notification.icon, notification.iconLevel).addExtras(getExtrasWithoutDuplicateData(notification, styleConstructStyleForExtras));
            ...
            ArrayList arrayList = (ArrayList) NotificationCompat.getInvisibleActions(notification);
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size2) {
                    ...
                    i++;
                    addPerson(Person.Api28Impl.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(obj2)));
                }
            }
    ...
    public static class CallStyle extends Style {
        ...
        public final Action makeAction(int i, int i2, Integer num, int i3, PendingIntent pendingIntent) {
            ...
            actionBuild.mExtras.putBoolean(KEY_ACTION_PRIORITY, true);
            return actionBuild;
        }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (i >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.Api28Impl.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (i >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(NotificationCompat$BigPictureStyle$$ExternalSyntheticApiModelOutline1.m(bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(@NonNull Context context, @NonNull Notification notification) {
            if (!NotificationCompat$DecoratedCustomViewStyle$$ExternalSyntheticApiModelOutline0.m().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
        ...
        public static void getTextsFromViewTraversal(View view, ArrayList<CharSequence> arrayList) {
            CharSequence text;
        ...
        */
        public final android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r7, boolean r8) {
            /*
                r6 = this;
    ...
    public static abstract class Style {
        ...
        public static Style constructCompatStyleByPlatformName(@Nullable String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(NotificationCompat$DecoratedCustomViewStyle$$ExternalSyntheticApiModelOutline0.m().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
        ...
        */
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public boolean displayCustomViewInline() {
            return this instanceof CallStyle;
        }
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        int i3 = Build.VERSION.SDK_INT;
        boolean z = i3 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || Api24Impl.getAllowGeneratedReplies(action) : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES);
        boolean z2 = action.getExtras().getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true);
        int semanticAction = i3 >= 28 ? Api28Impl.getSemanticAction(action) : action.getExtras().getInt(Action.EXTRA_SEMANTIC_ACTION, 0);
        ...
        if (Api23Impl.getIcon(action) != null || (i = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    i++;
                    arrayList.add(Person.Api28Impl.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(obj)));
                }
            }
        } else {
    ...
    public static final class CarExtender implements Extender {
        ...
        public static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                RemoteInput.Builder builderCreateBuilder = Api20Impl.createBuilder(remoteInput.mResultKey);
                Api20Impl.setLabel(builderCreateBuilder, remoteInput.mLabel);
                Api20Impl.setChoices(builderCreateBuilder, remoteInput.mChoices);
                Api20Impl.setAllowFreeFormInput(builderCreateBuilder, remoteInput.mAllowFreeFormTextInput);
                Api20Impl.addExtras(builderCreateBuilder, remoteInput.mExtras);
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (this.mConversationTitle != null && this.mIsGroupConversation.booleanValue()) {
                ...
                if (messageFindLatestIncomingMessage.mPerson != null) {
                    notificationBuilderWithBuilderAccessor.getBuilder().setContentTitle(messageFindLatestIncomingMessage.mPerson.getName());
                }
            }
            if (messageFindLatestIncomingMessage != null) {
                notificationBuilderWithBuilderAccessor.getBuilder().setContentText(this.mConversationTitle != null ? makeMessageLine(messageFindLatestIncomingMessage) : messageFindLatestIncomingMessage.mText);
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            boolean z = this.mConversationTitle != null || hasMessagesWithoutSender();
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Message message = this.mMessages.get(size);
                CharSequence charSequenceMakeMessageLine = z ? makeMessageLine(message) : message.mText;
        ...
        public final boolean hasMessagesWithoutSender() {
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Person person = this.mMessages.get(size).mPerson;
        ...
        public final CharSequence makeMessageLine(@NonNull Message message) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            Person person = message.mPerson;
            CharSequence name = person == null ? "" : person.getName();
            int color = -16777216;
            ...
            spannableStringBuilder.setSpan(makeFontColorSpan(color), spannableStringBuilder.length() - ((SpannableStringBuilder) charSequenceUnicodeWrap).length(), spannableStringBuilder.length(), 33);
            CharSequence charSequence = message.mText;
            spannableStringBuilder.append((CharSequence) GlideException.IndentedAppendable.INDENT).append(bidiFormatter.unicodeWrap(charSequence != null ? charSequence : ""));
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (bundle.containsKey(NotificationCompat.EXTRA_MESSAGING_STYLE_USER)) {
                ...
                Person.Builder builder = new Person.Builder();
                builder.mName = bundle.getString(NotificationCompat.EXTRA_SELF_DISPLAY_NAME);
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey("time")) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            person = Person.Api28Impl.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else if (bundle.containsKey(KEY_SENDER)) {
                            Person.Builder builder = new Person.Builder();
                            builder.mName = bundle.getCharSequence(KEY_SENDER);
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                Person person = this.mPerson;
                if (Build.VERSION.SDK_INT >= 28) {
                    messageCreateMessage = Api28Impl.createMessage(this.mText, this.mTimestamp, person != null ? person.toAndroidPerson() : null);
                } else {
                    messageCreateMessage = Api24Impl.createMessage(this.mText, this.mTimestamp, person != null ? person.getName() : null);
                }
                String str = this.mDataMimeType;
                if (str != null) {
                    Api24Impl.setData(messageCreateMessage, str, this.mDataUri);
                }
