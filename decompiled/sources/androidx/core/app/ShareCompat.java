...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public final void combineArrayExtra(@Nullable String str, @NonNull String[] strArr) {
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(ObjectListKt$$ExternalSyntheticOutline1.m("Could not find menu item with id ", i, " in the supplied menu"));
    }
}
