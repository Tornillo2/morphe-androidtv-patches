...
public class ShortcutXmlParser {
    ...
    public static final String META_DATA_APP_SHORTCUTS = "android.app.shortcuts";
    public static final String TAG = "ShortcutXmlParser";
    public static final String TAG_SHORTCUT = "shortcut";
    public static volatile ArrayList<String> sShortcutIds;

    public static String getAttributeValue(XmlPullParser xmlPullParser, String str) {
        String attributeValue = xmlPullParser.getAttributeValue(TypedArrayUtils.NAMESPACE, str);
    ...
    @NonNull
    public static XmlResourceParser getXmlResourceParser(Context context, ActivityInfo activityInfo) {
    ...
    @NonNull
    public static Set<String> parseShortcutIds(@NonNull Context context) {
