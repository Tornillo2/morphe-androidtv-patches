...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(AbstractResolvableFuture$$ExternalSyntheticOutline1.m(str, SchemaId.METRIC_SCHEMA_ID_DELIMITER, str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
        ...
        public Builder setTransientExtras(@NonNull Bundle bundle) {
            ShortcutInfoCompat shortcutInfoCompat = this.mInfo;
            bundle.getClass();
            shortcutInfoCompat.mTransientExtras = bundle;
            return this;
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            int i3 = i2 + 1;
            sb.append(i3);
            personArr[i2] = Person.Api22Impl.fromPersistableBundle(persistableBundle.getPersistableBundle(sb.toString()));
            i2 = i3;
        }
        return personArr;
    }
    ...
    public final PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (locusIdCompat != null) {
            this.mExtras.putString(EXTRA_LOCUS_ID, locusIdCompat.mId);
        }
