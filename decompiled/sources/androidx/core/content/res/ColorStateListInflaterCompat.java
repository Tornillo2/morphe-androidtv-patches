...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    public static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, to = 1.0d) float f, @FloatRange(from = 0.0d, to = ColorUtils.XYZ_WHITE_REFERENCE_Y) float f2) {
        ...
        if (z) {
            ...
            i = CamColor.toColor(camColorFromColor.mHue, camColorFromColor.mChroma, f2, ViewingConditions.DEFAULT);
        }
