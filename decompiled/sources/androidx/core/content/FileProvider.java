...
public class FileProvider extends ContentProvider {
    ...
    public static final File DEVICE_ROOT = new File(SchemaId.METRIC_SCHEMA_ID_DELIMITER);
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(RemoteInput$$ExternalSyntheticOutline0.m("Failed to find configured root that contains ", canonicalPath));
                }
                String path2 = entry.getValue().getPath();
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(path2.endsWith(SchemaId.METRIC_SCHEMA_ID_DELIMITER) ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), SchemaId.METRIC_SCHEMA_ID_DELIMITER)).build();
            } catch (IOException unused) {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(RemoteInput$$ExternalSyntheticOutline0.m("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    public static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(RemoteInput$$ExternalSyntheticOutline0.m("Invalid mode: ", str));
    }
