...
public final class ColorUtils {
    ...
    @ColorInt
    public static int M3HCTToColor(@FloatRange(from = 0.0d, to = 360.0d, toInclusive = false) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) float f3) {
        return CamColor.toColor(f, f2, f3, ViewingConditions.DEFAULT);
    }

    public static void RGBToHSL(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @NonNull float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static int compositeComponent(int i, int i2, int i3, int i4, int i5) {
        ...
        return ColorUtils$$ExternalSyntheticOutline0.m(255, i2, i3 * i4, (i * 255) * i2) / (i5 * 255);
    }
