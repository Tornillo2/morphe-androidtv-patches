...
public class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i) throws NoSuchMethodException {
        ...
        for (FontResourcesParserCompat.FontFileResourceEntry fontFileResourceEntry : fontFamilyFilesResourceEntry.mEntries) {
            ...
            try {
                ...
                if (!addFontWeightStyle(objNewFamily, tempFile.getPath(), fontFileResourceEntry.mWeight, fontFileResourceEntry.mItalic)) {
                    return null;
                }
                tempFile.delete();
    ...
    public final File getFile(@NonNull ParcelFileDescriptor parcelFileDescriptor) {
        try {
