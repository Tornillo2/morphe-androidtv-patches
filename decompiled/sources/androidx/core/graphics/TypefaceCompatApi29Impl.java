...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    public static final String TAG = "TypefaceCompatApi29Impl";

    @Nullable
    public static FontFamily getFontFamily(@Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, ContentResolver contentResolver) {
    ...
    public static int getMatchScore(@NonNull FontStyle fontStyle, @NonNull FontStyle fontStyle2) {
    ...
    public final Font findBaseFont(@NonNull FontFamily fontFamily, int i) {
        FontStyle fontStyle = new FontStyle((i & 1) != 0 ? HardwareConfigState.MAXIMUM_FDS_FOR_HARDWARE_CONFIGS_O : 400, (i & 2) != 0 ? 1 : 0);
