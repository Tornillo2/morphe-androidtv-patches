...
public class ExifInterface {
    ...
    public static final int DATETIME_VALUE_STRING_LENGTH = 19;
    ...
    public static final byte[] HEIF_TYPE_FTYP = {102, 116, 121, IonRawBinaryWriter.SYMBOL_TYPE};
    public static final byte[] HEIF_BRAND_MIF1 = {109, 105, 102, TarConstants.LF_LINK};
    public static final byte[] HEIF_BRAND_HEIC = {104, 101, 105, 99};
    public static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, TarConstants.LF_GNUTYPE_LONGNAME, 89, 77, 80, 0};
    public static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, TarConstants.LF_GNUTYPE_LONGNAME, 89, 77, 80, 85, TarConstants.LF_GNUTYPE_SPARSE, 0, 73, 73};
    public static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, 13, 10, Ascii.SUB, 10};
    public static final byte[] PNG_CHUNK_TYPE_EXIF = {101, TarConstants.LF_PAX_EXTENDED_HEADER_UC, 73, 102};
    ...
    public static final byte[] WEBP_CHUNK_TYPE_EXIF = {69, TarConstants.LF_PAX_EXTENDED_HEADER_UC, 73, 70};
        ...
        public void skipFully(int i) throws IOException {
            ...
            while (i2 < i) {
                ...
                if (iSkip <= 0) {
                    ...
                    if (iSkip == -1) {
                        throw new EOFException(ObjectListKt$$ExternalSyntheticOutline1.m("Reached EOF while skipping ", i, " bytes."));
                    }
                }
                i2 += iSkip;
            }
    ...
    public static class ExifAttribute {
        ...
        */
        ...
        public String toString() {
            ...
            return MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline1.m(sb, this.bytes.length, ")");
        }
    ...
    public static class Rational {
        ...
        public String toString() {
            return this.numerator + SchemaId.METRIC_SCHEMA_ID_DELIMITER + this.denominator;
        }
    ...
    static {
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, GifHeaderParser.LABEL_COMMENT_EXTENSION, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, BZip2Constants.MAX_ALPHA_SIZE, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, 273, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, DefaultImageHeaderParser.ORIENTATION_TAG_TYPE, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, AutoScrollHelper.DEFAULT_MINIMUM_VELOCITY_DIPS, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, InputDeviceCompat.SOURCE_DPAD, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        ...
        IDENTIFIER_EXIF_APP1 = DefaultImageHeaderParser.JPEG_EXIF_SEGMENT_PREAMBLE.getBytes(charsetForName);
    ...
    public static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] strArrSplit2 = strArrSplit[0].split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
            double d = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
            double d2 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
    ...
    public static Pair<Integer, Integer> guessDataFormat(String str) {
        ...
        if (!str.contains(SchemaId.METRIC_SCHEMA_ID_DELIMITER)) {
            try {
                try {
        ...
        String[] strArrSplit2 = str.split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
    ...
    public static Long parseDateTime(@Nullable String str, @Nullable String str2, @Nullable String str3) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(strSubstring) || "-".equals(strSubstring)) && ":".equals(str3.substring(3, 4)) && i2 <= 14) {
                        int i4 = ((i2 * 60) + i3) * GmtTimeZone.MILLISECONDS_PER_MINUTE;
    ...
    public final String convertDecimalDegree(double d) {
        long j = (long) d;
        double d2 = d - j;
    ...
    @Nullable
    public final ExifAttribute getExifAttribute(@NonNull String str) {
        if (str == null) {
            throw new NullPointerException("tag shouldn't be null");
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x016b A[LOOP:0: B:10:0x0034->B:61:0x016b, LOOP_END] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r21, int r22, int r23) throws java.lang.Throwable {
        /*
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r11.mAssetInputStream     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3f
            if (r1 == 0) goto L2f
        ...
        L26:
            ...
            return r2
        L2f:
            java.lang.String r1 = r11.mFilename     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3f
            if (r1 == 0) goto L44
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3f
            java.lang.String r3 = r11.mFilename     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3f
        ...
        L3f:
            ...
            goto L9d
        L44:
            java.io.FileDescriptor r1 = r11.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3f
            ...
            r1 = r10
        L59:
            int r4 = r11.mThumbnailOffset     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r5 = r11.mOffsetToExifData     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r4 = r4 + r5
            ...
            int r6 = r11.mThumbnailOffset     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r7 = r11.mOffsetToExifData     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r6 = r6 + r7
            long r6 = (long) r6
            java.lang.String r8 = "Corrupted image"
            int r9 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r9 != 0) goto L90
            int r4 = r11.mThumbnailLength     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            byte[] r4 = new byte[r4]     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r5 = r1.read(r4)     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            int r6 = r11.mThumbnailLength     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            if (r5 != r6) goto L8a
            r11.mThumbnailBytes = r4     // Catch: java.lang.Throwable -> L86 java.lang.Exception -> L88
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto L85
    ...
    public final void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap map) throws IOException {
    ...
    public final boolean isHeifFormat(byte[] bArr) throws Throwable {
    ...
    public final boolean isOrfFormat(byte[] bArr) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                byteOrderedDataInputStream2.mByteOrder = byteOrder;
    ...
    public final boolean isRw2Format(byte[] bArr) throws Throwable {
        ByteOrderedDataInputStream byteOrderedDataInputStream = null;
        try {
            ByteOrderedDataInputStream byteOrderedDataInputStream2 = new ByteOrderedDataInputStream(bArr);
            try {
    ...
    public final boolean isSupportedDataType(HashMap map) throws IOException {
        ExifAttribute exifAttribute;
        int intValue;
        ...
        if (exifAttribute2 != null) {
            ...
            if (Arrays.equals(iArr2, iArr) || (this.mMimeType == 3 && (exifAttribute = (ExifAttribute) map.get(TAG_PHOTOMETRIC_INTERPRETATION)) != null && (((intValue = exifAttribute.getIntValue(this.mExifByteOrder)) == 1 && Arrays.equals(iArr, BITS_PER_SAMPLE_GREYSCALE_2)) || (intValue == 6 && Arrays.equals(iArr, iArr2))))) {
                return true;
            }
        }
        if (!DEBUG) {
    ...
    public final boolean isThumbnail(HashMap map) throws IOException {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void loadAttributes(@androidx.annotation.NonNull java.io.InputStream r5) {
        /*
            r4 = this;
            if (r5 == 0) goto Lba
            r0 = 0
    ...
    public final void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        int i2 = byteOrderedDataInputStream.readInt();
        if (i2 < 8) {
            throw new IOException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Invalid first Ifd offset: ", i2));
        }
        int i3 = i2 - 8;
        if (i3 > 0) {
    ...
    public final void printAttributes() {
        for (int i = 0; i < this.mAttributes.length; i++) {
            StringBuilder sbM = MediaBrowserCompat$CustomActionResultReceiver$$ExternalSyntheticOutline0.m("The size of tag group[", i, "]: ");
    ...
    */
    ...
    public final void retrieveJpegImageSize(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws Throwable {
    ...
    */
    ...
    public final void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        while (byteOrderedDataInputStream.readByte() == -1) {
            ...
            if (b != -31) {
                ...
                byteOrderedDataOutputStream.writeByte(b);
                int unsignedShort = byteOrderedDataInputStream.readUnsignedShort();
                byteOrderedDataOutputStream.writeShort((short) unsignedShort);
                ...
                byteOrderedDataOutputStream.writeByte(-1);
                byteOrderedDataOutputStream.writeByte(b);
                byteOrderedDataOutputStream.writeShort((short) unsignedShort2);
                if (i3 >= 6) {
                    i3 = unsignedShort2 - 8;
                ...
                if (strReplaceAll != null) {
                    ...
                    if (exifTag.primaryFormat == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) pairGuessDataFormat.second).intValue()) {
                        ...
                        if (i6 == -1 || !(i6 == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.secondaryFormat == ((Integer) pairGuessDataFormat.second).intValue())) {
                            ...
                            if (i7 == i4 || i7 == 7 || i7 == i3) {
                                ...
                                StringBuilder sbM = ActivityResultRegistry$$ExternalSyntheticOutline0.m("Given tag (", str4, ") value didn't match with one of expected formats: ");
                                String[] strArr = IFD_FORMAT_NAMES;
                                sbM.append(strArr[exifTag.primaryFormat]);
                                sbM.append(exifTag.secondaryFormat == -1 ? "" : ", " + strArr[exifTag.secondaryFormat]);
                                sbM.append(" (guess: ");
                                sbM.append(strArr[((Integer) pairGuessDataFormat.first).intValue()]);
                                sbM.append(((Integer) pairGuessDataFormat.second).intValue() != -1 ? ", " + strArr[((Integer) pairGuessDataFormat.second).intValue()] : "");
                                sbM.append(")");
                                Log.d(str5, sbM.toString());
                            }
                        } else {
                    ...
                    switch (i) {
                        case 1:
                            i2 = i5;
                            str3 = str5;
                            this.mAttributes[i2].put(str4, ExifAttribute.createByte(strReplaceAll));
                            break;
                        case 2:
                        case 7:
                            i2 = i5;
                            str3 = str5;
                            this.mAttributes[i2].put(str4, ExifAttribute.createString(strReplaceAll));
                            break;
                        case 3:
                            i2 = i5;
                            str3 = str5;
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
                        ...
                        case 10:
                            ...
                            while (i12 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i12].split(SchemaId.METRIC_SCHEMA_ID_DELIMITER, -1);
                                rationalArr2[i12] = new Rational((long) Double.parseDouble(strArrSplit7[c]), (long) Double.parseDouble(strArrSplit7[i4]));
                                i12++;
    ...
    public void setDateTime(@NonNull Long l) {
        ...
        for (int length = string.length(); length < 3; length++) {
            string = RemoteInput$$ExternalSyntheticOutline0.m("0", string);
        }
    ...
    public final int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        for (int i4 = 0; i4 < EXIF_TAGS.length; i4++) {
            if (!this.mAttributes[i4].isEmpty()) {
                iArr[i4] = size2;
                size2 = (this.mAttributes[i4].size() * 12) + 6 + iArr2[i4] + size2;
            }
        }
        if (this.mHasThumbnail) {
            if (this.mHasThumbnailStrips) {
    ...
    public double[] getLatLong() {
        ...
        try {
            ...
            Log.w(TAG, "Latitude/longitude values are not parsable. ".concat(String.format("latValue=%s, latRef=%s, lngValue=%s, lngRef=%s", attribute, attribute2, attribute3, attribute4)));
            return null;
        }
    }
