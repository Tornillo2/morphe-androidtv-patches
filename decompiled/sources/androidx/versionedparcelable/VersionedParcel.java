...
public abstract class VersionedParcel {
    ...
    public final Exception createException(int i, String str) {
        switch (i) {
            case -9:
    ...
    public Exception readException(Exception exc, int i) {
        int i2;
        return (readField(i) && (i2 = readInt()) != 0) ? createException(i2, readString()) : exc;
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("VersionedParcelable encountered IOException reading a Serializable object (name = ", string, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", string, ")"), e2);
        }
    }
    ...
    public final <T> void writeCollection(Collection<T> collection) {
        if (collection == null) {
            writeInt(-1);
        }
    ...
    public final void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
    ...
    public final Exception readException(int i, String str) {
