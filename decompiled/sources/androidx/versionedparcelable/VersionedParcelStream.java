...
public class VersionedParcelStream extends VersionedParcel {
    ...
    public final void readObject(int i, String str, Bundle bundle) {
        switch (i) {
            case 0:
            ...
            case 14:
                ...
                return;
            default:
                throw new RuntimeException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Unknown type ", i));
        }
    }
