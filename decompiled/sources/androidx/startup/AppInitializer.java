...
public final class AppInitializer {
    ...
    public void discoverAndInitialize() {
        try {
            try {
                Trace.beginSection(androidx.tracing.Trace.truncatedTraceSectionLabel(SECTION_NAME));
    ...
    @NonNull
    public final <T> T doInitialize(@NonNull Class<? extends Initializer<?>> cls, @NonNull Set<Class<?>> set) {
        T t;
