...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public void notifyChildrenChangedForCompat(final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.3
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        MediaBrowserServiceImplApi21.this.notifyChildrenChangedForCompatOnHandler(MediaBrowserServiceCompat.this.mConnections.get((IBinder) it.next()), str, bundle);
                    }
                }
            });
        }
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            if (bundle2 == null) {
                bundle2 = browserRootOnGetRoot.mExtras;
            } else {
                Bundle bundle3 = browserRootOnGetRoot.mExtras;
                if (bundle3 != null) {
                    bundle2.putAll(bundle3);
                }
            }
            return new BrowserRoot(browserRootOnGetRoot.mRootId, bundle2);
        }
        ...
        public void setSessionTokenOnHandler(MediaSessionCompat.Token token) {
            ...
            this.mServiceFwk.setSessionToken((MediaSession.Token) token.mInner);
        }
    ...
    public class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        public void notifyChildrenChanged(@NonNull final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplBase.2
                ...
                public void run() {
                    Iterator it = ((ArrayMap.KeySet) MediaBrowserServiceCompat.this.mConnections.keySet()).iterator();
                    while (it.hasNext()) {
                        MediaBrowserServiceImplBase.this.notifyChildrenChangedOnHandler(MediaBrowserServiceCompat.this.mConnections.get((IBinder) it.next()), str, bundle);
                    }
                }
            });
        }
        ...
        public void setSessionToken(final MediaSessionCompat.Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplBase.1
                @Override // java.lang.Runnable
                public void run() {
                    Iterator it = ((ArrayMap.ValueCollection) MediaBrowserServiceCompat.this.mConnections.values()).iterator();
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            serviceCallbacks.onConnect(browserRoot.mRootId, token, browserRoot.mExtras);
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (token != null) {
                                ...
                                BrowserRoot browserRoot = connectionRecord.root;
                                serviceCallbacks2.onConnect(browserRoot.mRootId, token, browserRoot.mExtras);
                            }
    ...
    public void handleMessageInternal(Message message) {
        ...
        switch (message.what) {
            ...
            case 3:
                ...
                this.mServiceBinderImpl.addSubscription(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), data.getBinder(MediaBrowserProtocol.DATA_CALLBACK_TOKEN), bundle2, new ServiceCallbacksCompat(message.replyTo));
                break;
            case 4:
                this.mServiceBinderImpl.removeSubscription(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), data.getBinder(MediaBrowserProtocol.DATA_CALLBACK_TOKEN), new ServiceCallbacksCompat(message.replyTo));
                break;
            case 5:
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(RemoteInput$$ExternalSyntheticOutline0.m("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(RemoteInput$$ExternalSyntheticOutline0.m("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
    ...
    public static class Result<T> {
        ...
        public final void checkExtraFields(@Nullable Bundle bundle) {
