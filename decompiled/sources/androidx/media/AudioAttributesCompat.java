...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z, int i, int i2) {
        ...
        switch (i2) {
            ...
            default:
                if (z) {
                    throw new IllegalArgumentException(ObjectListKt$$ExternalSyntheticOutline1.m("Unknown usage value ", i2, " in audio attributes"));
                }
                return 3;
        }
    }
    ...
    public static String usageToString(int i) {
        switch (i) {
            ...
            case 15:
            default:
                return MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("unknown usage ", i);
            case 16:
    ...
    public static AudioAttributesCompat wrap(@NonNull Object obj) {
        ...
        return Build.VERSION.SDK_INT >= 26 ? new AudioAttributesCompat(new AudioAttributesImplApi26((AudioAttributes) obj, -1)) : new AudioAttributesCompat(new AudioAttributesImplApi21((AudioAttributes) obj, -1));
    }
