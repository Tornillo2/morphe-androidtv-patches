...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    public static class MediaButtonConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
        ...
        public void onConnected() {
            new MediaControllerCompat(this.mContext, this.mMediaBrowser.mImpl.getSessionToken()).dispatchMediaButtonEvent((KeyEvent) this.mIntent.getParcelableExtra("android.intent.extra.KEY_EVENT"));
            finish();
        }
    ...
    public static ComponentName getServiceComponentByAction(Context context, String str) {
        ...
        StringBuilder sbM = ActivityResultRegistry$$ExternalSyntheticOutline0.m("Expected 1 service that handles ", str, ", found ");
