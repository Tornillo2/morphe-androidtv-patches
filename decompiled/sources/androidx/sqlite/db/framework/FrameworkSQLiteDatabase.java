...
public class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        ...
        sb.append(str);
        sb.append(TextUtils.isEmpty(str2) ? "" : RemoteInput$$ExternalSyntheticOutline0.m(" WHERE ", str2));
        ...
        return ((FrameworkSQLiteStatement) supportSQLiteStatementCompileStatement).mDelegate.executeUpdateDelete();
    }
    ...
    public Cursor query(String str) {
        return query(new SimpleSQLiteQuery(str, null));
    }
