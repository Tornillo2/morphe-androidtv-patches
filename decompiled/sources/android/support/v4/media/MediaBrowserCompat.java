...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            ...
            StringBuilder sbM = MediaBrowserCompat$CustomActionResultReceiver$$ExternalSyntheticOutline0.m("Unknown result code: ", i, " (extras=");
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void getItem(@NonNull final String str, @NonNull final ItemCallback itemCallback) {
            ...
            try {
                serviceBinderWrapper.getMediaItem(str, new ItemReceiver(str, itemCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException unused) {
        ...
        public void onLoadChildren(Messenger messenger, String str, List<MediaItem> list, Bundle bundle, Bundle bundle2) {
            ...
            if (subscription.getCallback(bundle) != null) {
                if (bundle == null) {
                    if (list == null) {
                        return;
                    }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            ...
            try {
                serviceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbM = MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection$$ExternalSyntheticOutline0.m(str, " for ");
                sbM.append(MediaBrowserImplBase.this.mServiceComponent);
                sbM.append(" with mServiceConnection=");
                sbM.append(MediaBrowserImplBase.this.mServiceConnection);
                sbM.append(" this=");
                sbM.append(this);
                Log.i(MediaBrowserCompat.TAG, sbM.toString());
                return false;
            }
        ...
        public static String getStateLabel(int i) {
            return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("UNKNOWN/", i) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
            ...
            if (i == 0 || i == 1) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                    ...
                    public void run() {
                        ...
                        try {
                            zBindService = mediaBrowserImplBase2.mContext.bindService(intent, mediaServiceConnection, 1);
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline1.m(new StringBuilder("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline1.m(new StringBuilder("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        public final boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbM = MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection$$ExternalSyntheticOutline0.m(str, " for ");
            sbM.append(this.mServiceComponent);
            sbM.append(" with mCallbacksMessenger=");
            sbM.append(this.mCallbacksMessenger);
            sbM.append(" this=");
            sbM.append(this);
            Log.i(MediaBrowserCompat.TAG, sbM.toString());
            return false;
        ...
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) {
            if (isCurrent(messenger, "onConnect")) {
                ...
                try {
                    for (Map.Entry entry : (ArrayMap.EntrySet) this.mSubscriptions.entrySet()) {
            ...
            public void onChildrenLoaded(@NonNull String str, List<MediaBrowser.MediaItem> list) {
                ...
                for (int i = 0; i < callbacks.size(); i++) {
                    ...
                    if (bundle == null) {
                        ...
                        applyOptions(listFromMediaItemList, bundle);
    ...
    public static class MediaItem implements Parcelable {
        ...
        /* JADX INFO: renamed from: android.support.v4.media.MediaBrowserCompat$MediaItem$1, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        ...
        public String getMediaId() {
            return this.mDescription.mMediaId;
        }
