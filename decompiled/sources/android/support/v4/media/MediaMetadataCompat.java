...
public final class MediaMetadataCompat implements Parcelable {
    ...
    /* JADX INFO: renamed from: android.support.v4.media.MediaMetadataCompat$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        CharSequence charSequence = this.mBundle.getCharSequence(METADATA_KEY_DISPLAY_TITLE);
        if (TextUtils.isEmpty(charSequence)) {
            ...
            while (i < 3) {
                ...
                int i3 = i2 + 1;
                CharSequence charSequence2 = this.mBundle.getCharSequence(strArr[i2]);
            ...
            charSequenceArr[1] = this.mBundle.getCharSequence(METADATA_KEY_DISPLAY_SUBTITLE);
            charSequenceArr[2] = this.mBundle.getCharSequence(METADATA_KEY_DISPLAY_DESCRIPTION);
        }
        int i4 = 0;
        while (true) {
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 2) {
                throw new IllegalArgumentException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 3) {
                throw new IllegalArgumentException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 1) {
                throw new IllegalArgumentException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("The ", str, " key cannot be used to put a String"));
            }
