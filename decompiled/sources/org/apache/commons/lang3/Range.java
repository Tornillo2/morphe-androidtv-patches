...
public final class Range<T> implements Serializable {
    ...
    public static Range between(Comparable comparable, Comparable comparable2) {
        return new Range(comparable, comparable2, null);
    }
    ...
    public static Range is(Comparable comparable) {
        return new Range(comparable, comparable, null);
    }
    ...
    public Range<T> intersectionWith(Range<T> range) {
        ...
        return new Range<>(this.comparator.compare(this.minimum, range.minimum) < 0 ? range.minimum : this.minimum, this.comparator.compare(this.maximum, range.maximum) < 0 ? this.maximum : range.maximum, this.comparator);
    }
    ...
    public static <T> Range<T> is(T t, Comparator<T> comparator) {
        return new Range<>(t, t, comparator);
    }
