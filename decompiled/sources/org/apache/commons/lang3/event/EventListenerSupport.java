...
public class EventListenerSupport<L> implements Serializable {
    ...
    public class ProxyInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            Iterator<L> it = EventListenerSupport.this.listeners.iterator();
            while (it.hasNext()) {
    ...
    public final void createProxy(Class<L> cls, ClassLoader classLoader) {
    ...
    public final void initializeTransientFields(Class<L> cls, ClassLoader classLoader) {
