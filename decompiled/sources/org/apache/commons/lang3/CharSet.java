...
public class CharSet implements Serializable {
    ...
    public final Set<CharRange> set = DesugarCollections.synchronizedSet(new HashSet());
    ...
    static {
        ...
        Map<String, CharSet> mapSynchronizedMap = DesugarCollections.synchronizedMap(new HashMap());
