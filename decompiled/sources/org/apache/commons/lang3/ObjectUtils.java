...
public class ObjectUtils {
    ...
    public static byte CONST_BYTE(int i) {
        if (i < -128 || i > 127) {
            throw new IllegalArgumentException(ObjectListKt$$ExternalSyntheticOutline1.m("Supplied value must be a valid byte literal between -128 and 127: [", i, "]"));
        }
        return (byte) i;
    }
    ...
    public static short CONST_SHORT(int i) {
        if (i < -32768 || i > 32767) {
            throw new IllegalArgumentException(ObjectListKt$$ExternalSyntheticOutline1.m("Supplied value must be a valid byte literal between -32768 and 32767: [", i, "]"));
        }
        return (short) i;
    }
    ...
    public static <T> T clone(T t) {
        ...
        if (!t.getClass().isArray()) {
            try {
                ...
                throw new CloneFailedException("Cannot clone Cloneable type ".concat(t.getClass().getName()), e);
