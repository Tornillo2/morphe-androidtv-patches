...
public class StringUtils {
    ...
    public static String appendIfMissing(String str, CharSequence charSequence, boolean z, CharSequence... charSequenceArr) {
        ...
        sbM.append(charSequence.toString());
        return sbM.toString();
    }
    ...
    */
    ...
    public static boolean endsWithAny(CharSequence charSequence, CharSequence... charSequenceArr) {
        if (!isEmpty(charSequence) && !ArrayUtils.isEmpty(charSequenceArr)) {
            for (CharSequence charSequence2 : charSequenceArr) {
                if (endsWith(charSequence, charSequence2, false)) {
                    return true;
                }
            }
        }
    ...
    public static double getJaroWinklerDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        double length = (((d - ((double) iArrMatches[1])) / d) + ((d / ((double) charSequence2.length())) + (d / ((double) charSequence.length())))) / 3.0d;
        if (length >= 0.7d) {
            length += (1.0d - length) * Math.min(0.1d, 1.0d / ((double) iArrMatches[3])) * ((double) iArrMatches[2]);
        }
    ...
    */
    ...
    public static StringBuilder newStringBuilder(int i) {
    ...
    public static String remove(String str, String str2) {
        return (isEmpty(str) || isEmpty(str2)) ? str : replace(str, str2, "", -1, false);
    }

    @Deprecated
    public static String removeAll(String str, String str2) {
        return RegExUtils.replaceAll(str, str2, "");
    }
    ...
    public static String removeEndIgnoreCase(String str, String str2) {
        return (isEmpty(str) || isEmpty(str2) || !endsWith(str, str2, true)) ? str : str.substring(0, str.length() - str2.length());
    }

    @Deprecated
    public static String removeFirst(String str, String str2) {
        return RegExUtils.replaceFirst(str, str2, "");
    }

    public static String removeIgnoreCase(String str, String str2) {
        return (isEmpty(str) || isEmpty(str2)) ? str : replace(str, str2, "", -1, true);
    }

    @Deprecated
    public static String removePattern(String str, String str2) {
        return RegExUtils.replacePattern(str, str2, "");
    }
    ...
    public static String removeStartIgnoreCase(String str, String str2) {
        return (isEmpty(str) || isEmpty(str2) || !startsWith(str, str2, true)) ? str : str.substring(str2.length());
    }
    ...
    public static String reverseDelimited(String str, char c) {
        ...
        String[] strArrSplitWorker = splitWorker(str, c, false);
        ArrayUtils.reverse(strArrSplitWorker);
        return join(strArrSplitWorker, c);
    }
    ...
    public static boolean startsWithAny(CharSequence charSequence, CharSequence... charSequenceArr) {
        if (!isEmpty(charSequence) && !ArrayUtils.isEmpty(charSequenceArr)) {
            for (CharSequence charSequence2 : charSequenceArr) {
                if (startsWith(charSequence, charSequence2, false)) {
                    return true;
                }
            }
        }
    ...
    public static String unwrap(String str, String str2) {
        if (isEmpty(str) || isEmpty(str2) || !startsWith(str, str2, false) || !endsWith(str, str2, false)) {
            return str;
        }
        int iIndexOf = str.indexOf(str2);
    ...
    public static String replaceEach(String str, String[] strArr, String[] strArr2, boolean z, int i) {
        ...
        if (length2 != length3) {
            throw new IllegalArgumentException(Utf8$UnpairedSurrogateException$$ExternalSyntheticOutline0.m("Search and Replace array lengths don't match: ", length2, " vs ", length3));
        }
        ...
        if (i2 >= i3) {
            ...
            if (i2 >= i4) {
                if ((i2 + i) - length < str.length()) {
                    StringBuilder sbM = AccessibilityServiceInfoCompat$$ExternalSyntheticOutline0.m(str2);
                    sbM.append(abbreviate(str.substring(i), str2, 0, i5));
                    return sbM.toString();
                }
                StringBuilder sbM2 = AccessibilityServiceInfoCompat$$ExternalSyntheticOutline0.m(str2);
                sbM2.append(str.substring(str.length() - i5));
