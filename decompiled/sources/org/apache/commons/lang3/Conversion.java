...
public class Conversion {
    ...
    public static final boolean[] TTTT = {true, true, true, true};
    public static final boolean[] FTTT = {false, true, true, true};
    public static final boolean[] TFTT = {true, false, true, true};
    public static final boolean[] FFTT = {false, false, true, true};
    public static final boolean[] TTFT = {true, true, false, true};
    public static final boolean[] FTFT = {false, true, false, true};
    public static final boolean[] TFFT = {true, false, false, true};
    public static final boolean[] FFFT = {false, false, false, true};
    public static final boolean[] TTTF = {true, true, true, false};
    public static final boolean[] FTTF = {false, true, true, false};
    public static final boolean[] TFTF = {true, false, true, false};
    public static final boolean[] FFTF = {false, false, true, false};
    public static final boolean[] TTFF = {true, true, false, false};
    public static final boolean[] FTFF = {false, true, false, false};
    public static final boolean[] TFFF = {true, false, false, false};
    public static final boolean[] FFFF = {false, false, false, false};
    ...
    public static int byteArrayToInt(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 8, i3) >= 32) {
    ...
    public static long byteArrayToLong(byte[] bArr, int i, long j, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 8, i2) >= 64) {
    ...
    public static short byteArrayToShort(byte[] bArr, int i, short s, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 8, i2) >= 16) {
    ...
    public static String byteToHex(byte b, int i, String str, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i) >= 8) {
    ...
    */
    ...
    public static byte hexToByte(String str, int i, byte b, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i2) >= 8) {
    ...
    public static int hexToInt(String str, int i, int i2, int i3, int i4) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 4, i3) >= 32) {
    ...
    public static long hexToLong(String str, int i, long j, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i2) >= 64) {
    ...
    public static short hexToShort(String str, int i, short s, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i2) >= 16) {
    ...
    public static long intArrayToLong(int[] iArr, int i, long j, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 32, i2) >= 64) {
    ...
    public static byte[] intToByteArray(int i, int i2, byte[] bArr, int i3, int i4) {
        if (i4 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 8, i2) >= 32) {
    ...
    public static String intToHex(int i, int i2, String str, int i3, int i4) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 4, i2) >= 32) {
    ...
    public static char intToHexDigit(int i) {
        ...
        throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("nibble value not between 0 and 15: ", i));
    }
    ...
    public static short[] intToShortArray(int i, int i2, short[] sArr, int i3, int i4) {
        if (i4 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 16, i2) >= 32) {
    ...
    public static byte[] longToByteArray(long j, int i, byte[] bArr, int i2, int i3) {
        if (i3 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 8, i) >= 64) {
    ...
    public static String longToHex(long j, int i, String str, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i) >= 64) {
    ...
    public static int[] longToIntArray(long j, int i, int[] iArr, int i2, int i3) {
        if (i3 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 32, i) >= 64) {
    ...
    public static short[] longToShortArray(long j, int i, short[] sArr, int i2, int i3) {
        if (i3 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 16, i) >= 64) {
    ...
    public static int shortArrayToInt(short[] sArr, int i, int i2, int i3, int i4) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i4, 1, 16, i3) >= 32) {
    ...
    public static long shortArrayToLong(short[] sArr, int i, long j, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 16, i2) >= 64) {
    ...
    public static byte[] shortToByteArray(short s, int i, byte[] bArr, int i2, int i3) {
        if (i3 != 0) {
            if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 8, i) >= 16) {
    ...
    public static String shortToHex(short s, int i, String str, int i2, int i3) {
        ...
        if (ColorUtils$$ExternalSyntheticOutline0.m(i3, 1, 4, i) >= 16) {
