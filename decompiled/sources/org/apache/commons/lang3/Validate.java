...
public class Validate {
    ...
    public static void isAssignableFrom(Class<?> cls, Class<?> cls2) {
        if (cls.isAssignableFrom(cls2)) {
            ...
            throw new IllegalArgumentException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, cls2 == null ? AbstractJsonLexerKt.NULL : cls2.getName(), cls.getName()));
        }
    }
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        if (cls.isInstance(obj)) {
            ...
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, cls.getName(), obj == null ? AbstractJsonLexerKt.NULL : obj.getClass().getName()));
        }
    }
    ...
    public static <T extends CharSequence> T notBlank(T t) {
        notBlank(t, DEFAULT_NOT_BLANK_EX_MESSAGE, new Object[0]);
        return t;
    }

    public static <T> T[] notEmpty(T[] tArr) {
        notEmpty(tArr, DEFAULT_NOT_EMPTY_ARRAY_EX_MESSAGE, new Object[0]);
        return tArr;
    }

    public static <T> T[] validIndex(T[] tArr, int i) {
        validIndex(tArr, i, DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE, Integer.valueOf(i));
        return tArr;
    }
    ...
    public static <T> T[] noNullElements(T[] tArr) {
        noNullElements(tArr, DEFAULT_NO_NULL_ELEMENTS_ARRAY_EX_MESSAGE, new Object[0]);
        return tArr;
    }
    ...
    public static <T extends Collection<?>> T notEmpty(T t) {
        notEmpty(t, DEFAULT_NOT_EMPTY_COLLECTION_EX_MESSAGE, new Object[0]);
        return t;
    }

    public static <T extends Collection<?>> T validIndex(T t, int i) {
        validIndex(t, i, DEFAULT_VALID_INDEX_COLLECTION_EX_MESSAGE, Integer.valueOf(i));
        return t;
    }
    ...
    public static <T extends Iterable<?>> T noNullElements(T t) {
        noNullElements(t, DEFAULT_NO_NULL_ELEMENTS_COLLECTION_EX_MESSAGE, new Object[0]);
        return t;
    }

    public static <T extends Map<?, ?>> T notEmpty(T t) {
        notEmpty(t, DEFAULT_NOT_EMPTY_MAP_EX_MESSAGE, new Object[0]);
        return t;
    }

    public static <T extends CharSequence> T validIndex(T t, int i) {
        validIndex(t, i, DEFAULT_VALID_INDEX_CHAR_SEQUENCE_EX_MESSAGE, Integer.valueOf(i));
        return t;
    }
    ...
    public static <T extends CharSequence> T notEmpty(T t) {
        notEmpty(t, DEFAULT_NOT_EMPTY_CHAR_SEQUENCE_EX_MESSAGE, new Object[0]);
        return t;
    }
}
