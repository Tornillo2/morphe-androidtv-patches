...
public class StringEscapeUtils {
    ...
    public static final CharSequenceTranslator ESCAPE_JAVA = new LookupTranslator(new String[]{ToStringStyle.JsonToStringStyle.FIELD_NAME_QUOTE, "\\\""}, new String[]{CCTDestination.EXTRAS_DELIMITER, "\\\\"}).with(new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE())).with(JavaUnicodeEscaper.outsideOf(32, 127));
    public static final CharSequenceTranslator ESCAPE_ECMASCRIPT = new AggregateTranslator(new LookupTranslator(new String[]{"'", "\\'"}, new String[]{ToStringStyle.JsonToStringStyle.FIELD_NAME_QUOTE, "\\\""}, new String[]{CCTDestination.EXTRAS_DELIMITER, "\\\\"}, new String[]{SchemaId.METRIC_SCHEMA_ID_DELIMITER, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    public static final CharSequenceTranslator ESCAPE_JSON = new AggregateTranslator(new LookupTranslator(new String[]{ToStringStyle.JsonToStringStyle.FIELD_NAME_QUOTE, "\\\""}, new String[]{CCTDestination.EXTRAS_DELIMITER, "\\\\"}, new String[]{SchemaId.METRIC_SCHEMA_ID_DELIMITER, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    ...
    public static class CsvEscaper extends CharSequenceTranslator {
        ...
        public static final char[] CSV_SEARCH_CHARS = {',', '\"', CharUtils.CR, '\n'};
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            if (StringUtils.containsNone(charSequence.toString(), CSV_SEARCH_CHARS)) {
                ...
                writer.write(StringUtils.replace(string, str, AbstractResolvableFuture$$ExternalSyntheticOutline0.m(str, str), -1, false));
                writer.write(34);
            }
    ...
    public static class CsvUnescaper extends CharSequenceTranslator {
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            if (StringUtils.containsAny(string, CSV_SEARCH_CHARS)) {
                ...
                String str = CSV_QUOTE_STR;
                writer.write(StringUtils.replace(string, ActivityCompat$$ExternalSyntheticOutline0.m(sb, str, str), str, -1, false));
            } else {
                writer.write(charSequence.toString());
            }
            return Character.codePointCount(charSequence, 0, charSequence.length());
    ...
    static {
        AggregateTranslator aggregateTranslator = new AggregateTranslator(new OctalUnescaper(), new UnicodeUnescaper(), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_UNESCAPE()), new LookupTranslator(new String[]{"\\\\", CCTDestination.EXTRAS_DELIMITER}, new String[]{"\\\"", ToStringStyle.JsonToStringStyle.FIELD_NAME_QUOTE}, new String[]{"\\'", "'"}, new String[]{CCTDestination.EXTRAS_DELIMITER, ""}));
