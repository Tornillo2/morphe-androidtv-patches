...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public final void deleteImpl(int i, int i2, int i3) {
        char[] cArr = this.buffer;
    ...
    public final void replaceImpl(int i, int i2, int i3, String str, int i4) {
    ...
    public StrBuilder replace(StrMatcher strMatcher, String str, int i, int i2, int i3) {
        replaceImpl(strMatcher, str, i, validateRange(i, i2), i3);
        return this;
    }
    ...
    */
    ...
    public final StrBuilder replaceImpl(StrMatcher strMatcher, String str, int i, int i2, int i3) {
        String str2;
