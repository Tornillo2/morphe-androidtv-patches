...
public class TextStringBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public static final int FALSE_STRING_SIZE = 5;
    public static final int TRUE_STRING_SIZE = 4;
    ...
    public class TextStringBuilderTokenizer extends StringTokenizer {
        public TextStringBuilderTokenizer() {
        }
    ...
    public class StrBuilderReader extends Reader {
        ...
        public long skip(long j) {
            if (((long) this.pos) + j > TextStringBuilder.this.size()) {
    ...
    public TextStringBuilder replace(StringMatcher stringMatcher, String str, int i, int i2, int i3) {
        replaceImpl(stringMatcher, str, i, validateRange(i, i2), i3);
        return this;
    }
    ...
    */
    ...
    public final TextStringBuilder replaceImpl(StringMatcher stringMatcher, String str, int i, int i2, int i3) {
        String str2;
        if (stringMatcher != null && this.size != 0) {
            int length = str == null ? 0 : str.length();
            int i4 = i;
            while (i4 < i2 && i3 != 0) {
                int iIsMatch = stringMatcher.isMatch(this.buffer, i4, i, i2);
                if (iIsMatch > 0) {
                    str2 = str;
    ...
    */
    ...
    public int indexOf(StringMatcher stringMatcher, int i) {
        ...
        if (stringMatcher != null && i < (i2 = this.size)) {
            char[] cArr = this.buffer;
            for (int i3 = i; i3 < i2; i3++) {
                if (stringMatcher.isMatch(cArr, i3, i, i2) > 0) {
                    return i3;
                }
            }
        }
    ...
    public TextStringBuilder insert(int i, char[] cArr, int i2, int i3) {
        ...
        if (i2 >= 0 && i2 <= cArr.length) {
            if (i3 < 0 || i2 + i3 > cArr.length) {
                throw new StringIndexOutOfBoundsException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Invalid length: ", i3));
            }
            if (i3 > 0) {
        ...
        throw new StringIndexOutOfBoundsException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Invalid offset: ", i2));
    }
    ...
    public TextStringBuilder insert(int i, boolean z) {
        ...
        System.arraycopy(cArr3, i, cArr3, i + i5, this.size - i);
    ...
    public TextStringBuilder append(char[] cArr, int i, int i2) {
        ...
        if (i >= 0 && i <= cArr.length) {
            if (i2 < 0 || i + i2 > cArr.length) {
                throw new StringIndexOutOfBoundsException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Invalid length: ", i2));
            }
            if (i2 > 0) {
                int length = length();
                ensureCapacity(length + i2);
        ...
        throw new StringIndexOutOfBoundsException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Invalid startIndex: ", i2));
    }
