...
public class ExtendedMessageFormat extends MessageFormat {
    ...
    public ExtendedMessageFormat(String str) {
        this(str, Locale.getDefault(Locale.Category.FORMAT), null);
    }
            ...
            if (c != '\'') {
                if (c == '{') {
                    ...
                    if (arrayList.size() != i2) {
                        throw new IllegalArgumentException(Validate.DEFAULT_IS_TRUE_EX_MESSAGE);
                    }
    ...
    */
    ...
    public final void seekNonWs(String str, ParsePosition parsePosition) {
        ...
        do {
            ...
            int iIsMatch = StringMatcherFactory.SPLIT_MATCHER.isMatch(charArray, parsePosition.getIndex(), 0, charArray.length);
