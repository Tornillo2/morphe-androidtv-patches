...
public class CpioArchiveOutputStream extends ArchiveOutputStream implements CpioConstants {
    ...
    public void closeArchiveEntry() throws IOException {
        ...
        if (cpioArchiveEntry.getSize() != this.written) {
            ...
            sb.append(" but got ");
            throw new IOException(MediaSessionCompat$QueueItem$$ExternalSyntheticOutline0.m(sb, this.written, " bytes)"));
        }
    ...
    public ArchiveEntry createArchiveEntry(File file, String str) throws IOException {
        ...
        return new CpioArchiveEntry((short) 1, file, str);
    }
    ...
    public void finish() throws IOException {
        ...
        cpioArchiveEntry.setNumberOfLinks(1L);
    ...
    public void putArchiveEntry(ArchiveEntry archiveEntry) throws IOException {
        ...
        if (format != this.entryFormat) {
            StringBuilder sbM = MediaBrowserCompat$CustomActionResultReceiver$$ExternalSyntheticOutline0.m("Header format: ", format, " does not match existing format: ");
            sbM.append((int) this.entryFormat);
    ...
    public final void writeAsciiLong(long j, int i, int i2) throws IOException {
        ...
        if (stringBuffer.length() <= i) {
            ...
            strSubstring = stringBuffer.substring(stringBuffer.length() - i);
        }
    ...
    public final void writeNewEntry(CpioArchiveEntry cpioArchiveEntry) throws IOException {
        ...
        if (CpioConstants.CPIO_TRAILER.equals(cpioArchiveEntry.getName())) {
            ...
            this.nextArtificalDeviceAndInode = 1 + inode;
            deviceMin = inode >> 32;
        } else {
    ...
    public CpioArchiveOutputStream(OutputStream outputStream, short s, int i) {
        ...
        if (s != 1 && s != 2 && s != 4 && s != 8) {
            throw new IllegalArgumentException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Unknown format: ", s));
        }
        this.entryFormat = s;
        this.blockSize = i;
    }
