...
public final class ZipEightByteInteger implements Serializable {
    ...
    public static final byte LEFTMOST_BIT = -128;
    ...
    public static BigInteger getValue(byte[] bArr, int i) {
        int i2 = i + 7;
        BigInteger bigIntegerValueOf = BigInteger.valueOf(((((long) bArr[i2]) << 56) & BYTE_7_MASK) + ((((long) bArr[i + 6]) << 48) & BYTE_6_MASK) + ((((long) bArr[i + 5]) << 40) & BYTE_5_MASK) + ((((long) bArr[i + 4]) << 32) & BYTE_4_MASK) + ((((long) bArr[i + 3]) << 24) & 4278190080L) + ((((long) bArr[i + 2]) << 16) & 16711680) + ((((long) bArr[i + 1]) << 8) & 65280) + (((long) bArr[i]) & 255));
    ...
    public static byte[] getBytes(BigInteger bigInteger) {
        ...
        byte[] bArr = {(byte) (255 & jLongValue), (byte) ((65280 & jLongValue) >> 8), (byte) ((16711680 & jLongValue) >> 16), (byte) ((4278190080L & jLongValue) >> 24), (byte) ((BYTE_4_MASK & jLongValue) >> 32), (byte) ((BYTE_5_MASK & jLongValue) >> 40), (byte) ((BYTE_6_MASK & jLongValue) >> 48), (byte) ((jLongValue & BYTE_7_MASK) >> 56)};
