...
public abstract class ZipEncodingHelper {
    ...
    static {
        ...
        map.put("ibm850", simpleEncodingHolder2);
        simpleEncodings = DesugarCollections.unmodifiableMap(map);
        HEX_DIGITS = new byte[]{48, TarConstants.LF_LINK, TarConstants.LF_SYMLINK, TarConstants.LF_CHR, TarConstants.LF_BLK, TarConstants.LF_DIR, TarConstants.LF_FIFO, TarConstants.LF_CONTIG, 56, 57, 65, 66, 67, 68, 69, 70};
