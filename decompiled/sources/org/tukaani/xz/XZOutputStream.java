...
public class XZOutputStream extends FinishableOutputStream {
    public BlockOutputStream blockEncoder;
    public final Check check;
    public IOException exception;
    public FilterEncoder[] filters;
    public boolean filtersSupportFlushing;
    public boolean finished;
    public final IndexEncoder index;
    public OutputStream out;
    public final StreamFlags streamFlags;
    ...
    public final void encodeStreamFlags(byte[] bArr, int i) {
        bArr[i] = 0;
    ...
    public final void encodeStreamHeader() throws IOException {
    ...
    public void updateFilters(FilterOptions[] filterOptionsArr) throws XZIOException {
        ...
        for (int i = 0; i < filterOptionsArr.length; i++) {
            FilterEncoder filterEncoder = filterOptionsArr[i].getFilterEncoder();
            filterEncoderArr[i] = filterEncoder;
