...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            objCreateFailure = new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null);
        } catch (Throwable th) {
            objCreateFailure = ResultKt.createFailure(th);
        }
        Main = (HandlerDispatcher) (objCreateFailure instanceof Result.Failure ? null : objCreateFailure);
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2130dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m2080postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }

    /* JADX INFO: renamed from: postFrameCallback$lambda-6, reason: not valid java name */
    public static final void m2080postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
