...
public interface Channel<E> extends SendChannel<E>, ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> SelectClause1<E> getOnReceiveOrNull(@NotNull Channel<E> channel) {
            return new ReceiveChannel$onReceiveOrNull$1(channel);
        }
    ...
    public static final class Factory {
        ...
        public static final int CHANNEL_DEFAULT_CAPACITY = SystemPropsKt__SystemProps_commonKt.systemProp("kotlinx.coroutines.channels.defaultBuffer", 64, 1, 2147483646);
