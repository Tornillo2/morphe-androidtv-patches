...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void handleFatalException(@Nullable Throwable th, @Nullable Throwable th2) throws IllegalAccessException, InvocationTargetException {
        if (th == null && th2 == null) {
            return;
        }
        if (th != null && th2 != null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    objCreateFailure2 = Unit.INSTANCE;
                } catch (Throwable th) {
                    objCreateFailure2 = ResultKt.createFailure(th);
                }
                handleFatalException(null, Result.m583exceptionOrNullimpl(objCreateFailure2));
            } catch (Throwable th2) {
                if (undispatchedCoroutineUpdateUndispatchedCompletion == null || undispatchedCoroutineUpdateUndispatchedCompletion.clearThreadContext()) {
                    ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                }
            ...
            handleFatalException(th3, Result.m583exceptionOrNullimpl(objCreateFailure));
        }
    }
