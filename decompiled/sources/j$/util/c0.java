...
public final class c0 implements LongConsumer, IntConsumer {
    private long count;
    private long sum;
    ...
    public final void a(c0 c0Var) {
        this.count += c0Var.count;
        this.sum += c0Var.sum;
        this.min = Math.min(this.min, c0Var.min);
        this.max = Math.max(this.max, c0Var.max);
    }
