...
public abstract class x6 implements Spliterator.OfPrimitive {
    public int a;
    public final int b;
    public int c;
    public final int d;
    ...
    public final void forEachRemaining(Object obj) {
        ...
        if (i < i3 || (i == i3 && this.c < i2)) {
            ...
            while (true) {
                ...
                y6Var.p(obj2, i4, y6Var.q(obj2), obj);
                i++;
                i4 = 0;
            }
            y6Var.p(this.a == i3 ? this.e : y6Var.f[i3], i4, i2, obj);
            this.a = i3;
            this.c = i2;
        }
    }
    ...
    public final Spliterator.OfPrimitive trySplit() {
        ...
        if (i < i2) {
            ...
            int i4 = this.c;
            y6 y6Var = this.f;
            Spliterator.OfPrimitive ofPrimitiveC = c(i, i3, i4, y6Var.q(y6Var.f[i3]));
            this.a = i2;
            this.c = 0;
            this.e = y6Var.f[i2];
            return ofPrimitiveC;
