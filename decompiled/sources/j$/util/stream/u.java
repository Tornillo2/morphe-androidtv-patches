...
public final class u extends h5 {
    ...
    /* JADX WARN: Type inference failed for: r4v3, types: [j$.util.Spliterator$OfDouble] */
    @Override // j$.util.stream.l5, j$.util.stream.o5
    public final void accept(double d) {
        DoubleStream doubleStream = (DoubleStream) ((j$.util.q) this.d.u).apply(d);
