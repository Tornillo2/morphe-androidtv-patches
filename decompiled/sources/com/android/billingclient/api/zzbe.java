...
public final class zzbe extends ResultReceiver {
    ...
    public zzbe(BillingClientImpl billingClientImpl, Handler handler, AlternativeBillingOnlyInformationDialogListener alternativeBillingOnlyInformationDialogListener) {
        super(handler);
    ...
    public final void onReceiveResult(int i, @Nullable Bundle bundle) {
        ...
        if (i != 0) {
            if (bundle == null) {
                this.zzb.zzaM(this.zza, zzcp.zzh, zzic.NULL_BUNDLE_IN_ALTERNATIVE_BILLING_ONLY_INFORMATION_DIALOG_RECEIVER, null);
                return;
            }
            ...
            int i3 = zzcm.zza;
            billingClientImpl.zzaO(zzcm.zzb(zzicVarZzb, 16, billingResultBuild, string, zzij.BROADCAST_ACTION_UNSPECIFIED));
        }
