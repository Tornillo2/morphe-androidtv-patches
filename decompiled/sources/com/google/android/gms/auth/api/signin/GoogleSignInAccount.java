...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @NonNull
    @VisibleForTesting
    public static final Clock zaa = DefaultClock.zza;
    ...
    public static GoogleSignInAccount zab(@Nullable String str) throws JSONException {
        ...
        GoogleSignInAccount googleSignInAccountZaa = zaa(jSONObject.optString("id"), jSONObject.has("tokenId") ? jSONObject.optString("tokenId") : null, jSONObject.has("email") ? jSONObject.optString("email") : null, jSONObject.has(FileProvider.DISPLAYNAME_FIELD) ? jSONObject.optString(FileProvider.DISPLAYNAME_FIELD) : null, jSONObject.has("givenName") ? jSONObject.optString("givenName") : null, jSONObject.has("familyName") ? jSONObject.optString("familyName") : null, uri, Long.valueOf(j), jSONObject.getString("obfuscatedIdentifier"), hashSet);
    ...
    public static GoogleSignInAccount zae(Account account, Set set) {
    ...
    public final String zad() {
        ...
        try {
            ...
            if (getDisplayName() != null) {
                jSONObject.put(FileProvider.DISPLAYNAME_FIELD, getDisplayName());
            }
