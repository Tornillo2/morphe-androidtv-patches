    ...
    public static void load(@NonNull final Context context, @NonNull final String str, @NonNull final AdManagerAdRequest adManagerAdRequest, @NonNull final AdManagerInterstitialAdLoadCallback adManagerInterstitialAdLoadCallback) {
        ...
        if (((Boolean) zzbdb.zzi.zze()).booleanValue()) {
            if (((Boolean) zzba.zza.zzd.zzb(zzbbk.zzjG)).booleanValue()) {
                zzbzi.zzb.execute(new Runnable() { // from class: com.google.android.gms.ads.admanager.zzc
                    ...
                    public final void run() {
                        ...
                        try {
                            new zzbla(context2, str2).zza(adManagerAdRequest2.zza, adManagerInterstitialAdLoadCallback);
                        } catch (IllegalStateException e) {
                            zzbsy.zza(context2).zzf(e, "AdManagerInterstitialAd.load");
                        }
                    }
                });
                return;
        ...
        new zzbla(context, str).zza(adManagerAdRequest.zza, adManagerInterstitialAdLoadCallback);
    }
