...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws GooglePlayServicesRepairableException, IllegalStateException, GooglePlayServicesNotAvailableException, IOException {
        ...
        try {
            ...
            f = f2;
            try {
                advertisingIdClient.zza(info, z, f, jElapsedRealtime2, string, null);
                return info;
            } catch (Throwable th) {
                th = th;
                Throwable th2 = th;
                try {
                    advertisingIdClient.zza(null, z, f, -1L, string, th2);
                    throw th2;
                } finally {
                    advertisingIdClient.finish();
                }
    ...
    public static BlockingServiceConnection zza(Context context, boolean z) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException, IOException {
        try {
    ...
    @VisibleForTesting
    public final void zza(boolean z) throws GooglePlayServicesRepairableException, IllegalStateException, GooglePlayServicesNotAvailableException, IOException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            try {
                if (this.zzg) {
    ...
    @VisibleForTesting
    public final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        String str2;
        if (Math.random() > f) {
            return false;
        }
        ...
        if (info != null) {
            map.put("limit_ad_tracking", info.zzr ? "1" : "0");
        }
        if (info != null && (str2 = info.zzq) != null) {
