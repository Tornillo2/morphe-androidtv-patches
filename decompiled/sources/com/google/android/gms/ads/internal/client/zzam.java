...
public final class zzam extends zzax {
    ...
    public zzam(zzaw zzawVar, Context context, zzq zzqVar, String str, zzbny zzbnyVar) {
        this.zze = zzawVar;
        this.zza = context;
        this.zzb = zzqVar;
        this.zzc = str;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzce zzceVar) throws RemoteException {
        return zzceVar.zze(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 231700000);
    }
