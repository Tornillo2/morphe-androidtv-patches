...
public final class CustomEventAdapter implements MediationBannerAdapter, MediationInterstitialAdapter, MediationNativeAdapter {
    ...
    @VisibleForTesting
    public static final AdError zza = new AdError(0, "Could not instantiate custom event adapter", MobileAds.ERROR_DOMAIN, null);
    ...
    @Nullable
    public static Object zzb(Class cls, @Nullable String str) {
        try {
            if (str != null) {
