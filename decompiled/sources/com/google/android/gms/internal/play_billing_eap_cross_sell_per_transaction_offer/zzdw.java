...
public final class zzdw extends zzds implements RandomAccess, zzfl {
    ...
    @Override // com.google.android.gms.internal.play_billing_eap_cross_sell_per_transaction_offer.zzds, java.util.AbstractCollection, java.util.Collection, java.util.List
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzdwVar.zzb, 0, this.zzb, this.zzc, zzdwVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    @Override // com.google.android.gms.internal.play_billing_eap_cross_sell_per_transaction_offer.zzds, java.util.AbstractList, java.util.Collection, java.util.List
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzdwVar.zzc) {
            return false;
        }
        boolean[] zArr = zzdwVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzfm.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzfl zzd(int i) {
        if (i >= this.zzc) {
            return new zzdw(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzdw(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
