...
public final class zzfy extends zzds implements RandomAccess, zzfl {
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzfm.zzb;
        collection.getClass();
        if (!(collection instanceof zzfy)) {
            return super.addAll(collection);
        }
        zzfy zzfyVar = (zzfy) collection;
        int i = zzfyVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzfyVar.zzb, 0, this.zzb, this.zzc, zzfyVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfyVar.zzc) {
            return false;
        }
        long[] jArr = zzfyVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzfl zzd(int i) {
        if (i >= this.zzc) {
            return new zzfy(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzfy(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
