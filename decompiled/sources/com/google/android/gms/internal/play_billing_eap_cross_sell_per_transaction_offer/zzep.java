...
public final class zzep extends zzds implements RandomAccess, zzfl {
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzepVar.zzb, 0, this.zzb, this.zzc, zzepVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzepVar.zzc) {
            return false;
        }
        double[] dArr = zzepVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzfl zzd(int i) {
        if (i >= this.zzc) {
            return new zzep(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzep(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
