...
public final class zzfh extends zzds implements RandomAccess, zzfk {
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzfhVar.zzc, 0, this.zzc, this.zzd, zzfhVar.zzd);
        this.zzd = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzd != zzfhVar.zzd) {
            return false;
        }
        int[] iArr = zzfhVar.zzc;
    ...
    public final /* bridge */ /* synthetic */ zzfl zzd(int i) {
        if (i >= this.zzd) {
            return new zzfh(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
    ...
    public zzfh(int[] iArr, int i, boolean z) {
        super(z);
        this.zzc = iArr;
        this.zzd = i;
    }
