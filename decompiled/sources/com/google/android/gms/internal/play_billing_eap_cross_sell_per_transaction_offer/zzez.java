...
public final class zzez extends zzds implements RandomAccess, zzfl {
    ...
    public final /* bridge */ /* synthetic */ zzfl zzd(int i) {
        if (i >= this.zzc) {
            return new zzez(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    public zzez(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
