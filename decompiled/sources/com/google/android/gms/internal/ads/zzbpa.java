...
public final class zzbpa implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, AdError adError) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzt.zze("Adapter called onAdFailedToLoad with error. ErrorCode: " + adError.getCode() + ". ErrorMessage: " + adError.getMessage() + ". ErrorDomain: " + adError.getDomain());
        try {
    ...
    public final void onAdLoaded(MediationNativeAdapter mediationNativeAdapter, UnifiedNativeAdMapper unifiedNativeAdMapper) {
        ...
        if (!(mediationNativeAdapter instanceof AdMobAdapter)) {
            ...
            if (unifiedNativeAdMapper != null && unifiedNativeAdMapper.hasVideoContent()) {
                unifiedNativeAdMapper.zzj = videoController;
            }
        }
        try {
            this.zza.zzo();
    ...
    public final void onAdFailedToLoad(MediationInterstitialAdapter mediationInterstitialAdapter, int i) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzt.zze("Adapter called onAdFailedToLoad with error " + i + ExternalFourCCMapper.CODEC_NAME_SPLITTER);
        try {
            this.zza.zzg(i);
        } catch (RemoteException e) {
            zzbzt.zzl("#007 Could not call remote method.", e);
