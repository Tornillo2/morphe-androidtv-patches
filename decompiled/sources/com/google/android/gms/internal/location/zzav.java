...
public final class zzav {
    ...
    public final Map<ListenerHolder.ListenerKey<LocationListener>, zzau> zzd = new HashMap();
    public final Map<ListenerHolder.ListenerKey, zzas> zze = new HashMap();
    public final Map<ListenerHolder.ListenerKey<LocationCallback>, zzar> zzf = new HashMap();
    ...
    public final void zzd(LocationRequest locationRequest, ListenerHolder<LocationListener> listenerHolder, zzai zzaiVar) throws RemoteException {
        ...
        zzau zzauVar2;
        ((zzh) this.zza).zza.checkConnected();
        ListenerHolder.ListenerKey<LocationListener> listenerKey = listenerHolder.zac;
        if (listenerKey == null) {
            zzauVar2 = null;
        } else {
    ...
    public final void zze(zzba zzbaVar, ListenerHolder<LocationCallback> listenerHolder, zzai zzaiVar) throws RemoteException {
        zzar zzarVar;
        ((zzh) this.zza).zza.checkConnected();
        ListenerHolder.ListenerKey<LocationCallback> listenerKey = listenerHolder.zac;
        if (listenerKey == null) {
            zzarVar = null;
        } else {
