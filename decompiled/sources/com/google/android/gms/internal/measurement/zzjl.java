...
public final class zzjl extends zzim implements RandomAccess, zzkj, zzlq {
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzc = (iZzc * 31) + zzkk.zzc(Double.doubleToLongBits(this.zzb[i]));
        }
        return iZzc;
    }
