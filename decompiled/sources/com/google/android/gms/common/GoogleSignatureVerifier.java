...
public class GoogleSignatureVerifier {
    ...
    public final zzx zzc(@Nullable String str, boolean z, boolean z2) {
        zzx zzxVarZzc;
        ...
        if (zzn.zzg()) {
            zzxVarZzc = zzn.zzi(str, GooglePlayServicesUtilLight.honorsDebugCertificates(this.zzc), false, false, true);
        } else {
            try {
