...
public final class zzn {
    ...
    public static zzx zzh(final String str, final zzj zzjVar, final boolean z, boolean z2) {
        try {
            ...
            try {
                return zze.zzh(new zzs(str, zzjVar, z, z2), ObjectWrapper.wrap(zzg.getPackageManager())) ? zzx.zze : new zzv(new Callable() { // from class: com.google.android.gms.common.zze
    ...
    public static zzx zzi(String str, boolean z, boolean z2, boolean z3, boolean z4) {
        zzx zzxVarZzd;
        StrictMode.ThreadPolicy threadPolicyAllowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            Preconditions.checkNotNull(zzg);
            try {
                ...
                try {
                    ...
                    if (zzqVarZze.zza) {
                        zzxVarZzd = zzx.zzf(zzd.zza(zzqVarZze.zzd));
                    } else {
                        String str2 = zzqVarZze.zzb;
                        PackageManager.NameNotFoundException nameNotFoundException = zzy.zza(zzqVarZze.zzc) == 4 ? new PackageManager.NameNotFoundException() : null;
                        if (str2 == null) {
                            str2 = "error checking package certificate";
                        }
                        zzxVarZzd = zzx.zzg(zzd.zza(zzqVarZze.zzd), zzy.zza(zzqVarZze.zzc), str2, nameNotFoundException);
                    }
                } catch (RemoteException e) {
                    Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
