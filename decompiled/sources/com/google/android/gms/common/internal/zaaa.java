...
public final class zaaa extends Button {
    ...
    public static final int zab(int i, int i2, int i3, int i4) {
        ...
        throw new IllegalStateException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Unknown color scheme: ", i));
    }
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        if (i == 0 || i == 1) {
            ...
            throw new IllegalStateException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Unknown button size: ", i));
        }
        Drawable drawableWrap = DrawableCompat.wrap(resources.getDrawable(iZab));
        drawableWrap.setTintList(resources.getColorStateList(com.google.android.gms.base.R.color.common_google_signin_btn_tint));
        drawableWrap.setTintMode(PorterDuff.Mode.SRC_ATOP);
