...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i2 < iDataPosition || i2 > parcel.dataSize()) {
            throw new ParseException(Utf8$UnpairedSurrogateException$$ExternalSyntheticOutline0.m("Size read is invalid start=", iDataPosition, " end=", i2), parcel);
        }
        return i2;
    }
    ...
    public static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(ActivityCompat$$ExternalSyntheticOutline0.m(MutableFloatList$$ExternalSyntheticOutline0.m("Expected size ", i3, " got ", i2, " (0x"), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    public static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(ActivityCompat$$ExternalSyntheticOutline0.m(MutableFloatList$$ExternalSyntheticOutline0.m("Expected size ", i2, " got ", size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
}
