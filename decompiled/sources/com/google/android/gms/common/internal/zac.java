...
public final class zac {
    ...
    public static String zaa(Context context) {
        ...
        try {
            return Wrappers.zza.zza(context).getApplicationLabel(packageName).toString();
    ...
    public static String zah(Context context, String str) {
        ...
        synchronized (simpleArrayMap) {
            try {
                Locale locale = ConfigurationCompat.getLocales(context.getResources().getConfiguration()).mImpl.get(0);
