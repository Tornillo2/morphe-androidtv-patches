...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public final Map zzb = DesugarCollections.synchronizedMap(new ArrayMap());
    public int zzc = 0;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzdVar2 == null || zzdVar2.mRemoving) {
                zzdVar2 = new zzd();
                FragmentTransaction fragmentTransactionBeginTransaction = fragmentActivity.getSupportFragmentManager().beginTransaction();
                fragmentTransactionBeginTransaction.doAddOp(0, zzdVar2, "SupportLifecycleFragmentImpl", 1);
    ...
    public final void addCallback(String str, @NonNull LifecycleCallback lifecycleCallback) {
        if (this.zzb.containsKey(str)) {
            throw new IllegalArgumentException(MediaMetadataCompat$Builder$$ExternalSyntheticOutline0.m("LifecycleCallback with tag ", str, " already added to this fragment."));
        }
