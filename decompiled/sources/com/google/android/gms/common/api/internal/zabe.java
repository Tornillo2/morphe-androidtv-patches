...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public long zaq = MinervaServiceAndroidAdapter.SHUTDOWN_TIMEOUT_MS;
    ...
    public static int zad(Iterable iterable, boolean z) {
        ...
        while (it.hasNext()) {
            zRequiresSignIn |= ((Api.Client) it.next()).requiresSignIn();
        }
        return zRequiresSignIn ? 1 : 3;
    }
    ...
    public final <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(@NonNull T t) {
        Api<?> api = t.api;
        Preconditions.checkArgument(this.zac.containsKey(t.clientKey), "GoogleApiClient is not configured to use " + (api != null ? api.zac : "the API") + " required for this call.");
        this.zaj.lock();
        try {
            zaca zacaVar = this.zal;
            if (zacaVar == null) {
    ...
    public final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(@NonNull T t) {
        Map map = this.zac;
        Api<?> api = t.api;
        Preconditions.checkArgument(map.containsKey(t.clientKey), "GoogleApiClient is not configured to use " + (api != null ? api.zac : "the API") + " required for this call.");
        this.zaj.lock();
        try {
            zaca zacaVar = this.zal;
            if (zacaVar == null) {
    ...
    public final ConnectionResult getConnectionResult(@NonNull Api<?> api) {
        ...
        try {
            ...
            if (!this.zac.containsKey(api.zab)) {
                throw new IllegalArgumentException(api.zac + " was never registered with GoogleApiClient");
            }
            zaca zacaVar = this.zal;
            Preconditions.checkNotNull(zacaVar);
            ...
            if (this.zap) {
                ...
                Log.wtf("GoogleApiClientImpl", api.zac + " requested in getConnectionResult is not connected but is not present in the failed  connections map", new Exception());
    ...
    public final void zaa(ConnectionResult connectionResult) {
        if (!this.zat.isPlayServicesPossiblyUpdating(this.zan, connectionResult.zzb)) {
            zak();
        }
        if (this.zap) {
            return;
    ...
    public final void zal(int i) {
        ...
        Iterator it = this.zac.values().iterator();
        boolean zRequiresSignIn = false;
        while (it.hasNext()) {
            zRequiresSignIn |= ((Api.Client) it.next()).requiresSignIn();
        }
