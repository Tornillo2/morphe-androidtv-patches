...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    @Nullable
    @WorkerThread
    public final Feature zaC(@Nullable Feature[] featureArr) {
    ...
    @WorkerThread
    public final void zaF(@Nullable Status status, @Nullable Exception exc, boolean z) {
        Preconditions.checkHandlerThread(this.zaa.zar);
    ...
    public final void zaI(int i) {
        ...
        Handler handler2 = this.zaa.zar;
        handler2.sendMessageDelayed(Message.obtain(handler2, 11, apiKey2), MinervaServiceAndroidAdapter.SHUTDOWN_TIMEOUT_MS);
        this.zaa.zak.zac();
        Iterator it = this.zag.values().iterator();
        while (it.hasNext()) {
    ...
    public final void zaJ() {
        ...
        ApiKey apiKey = this.zad;
        Handler handler = this.zaa.zar;
        handler.sendMessageDelayed(handler.obtainMessage(12, apiKey), this.zaa.zae);
    }

    @WorkerThread
    public final void zaK(zai zaiVar) {
        zaiVar.zag(this.zae, this.zac.requiresSignIn());
        try {
            zaiVar.zaf(this);
        } catch (DeadObjectException unused) {
    ...
    public final boolean zaM(zai zaiVar) {
        ...
        Handler handler3 = this.zaa.zar;
        handler3.sendMessageDelayed(Message.obtain(handler3, 16, zabsVar), MinervaServiceAndroidAdapter.SHUTDOWN_TIMEOUT_MS);
    ...
    @WorkerThread
    public final boolean zaN(@NonNull ConnectionResult connectionResult) {
    ...
    public final void zar(@NonNull ConnectionResult connectionResult, @Nullable Exception exc) {
        ...
        GoogleApiManager googleApiManager2 = this.zaa;
        ApiKey apiKey = this.zad;
        Handler handler2 = googleApiManager2.zar;
    ...
    public final void zaw() {
        ...
        if (this.zaj) {
            zaL();
            GoogleApiManager googleApiManager = this.zaa;
            zaE(googleApiManager.zaj.isGooglePlayServicesAvailable(googleApiManager.zai) == 18 ? new Status(21, "Connection timed out waiting for Google Play services update to complete.", null, null) : new Status(22, "API failed to connect while resuming due to an unknown error.", null, null));
