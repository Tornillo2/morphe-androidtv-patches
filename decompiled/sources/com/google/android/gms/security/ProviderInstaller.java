...
public class ProviderInstaller {
        ...
        synchronized (zzb) {
            ...
            if (remoteContext != null) {
                try {
                    if (zzd == null) {
                        Class<?> cls = Long.TYPE;
                        zzd = remoteContext.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("reportRequestStats", Context.class, cls, cls);
                    }
    ...
    public static Method zzb(Context context, String str, String str2, Class[] clsArr) throws NoSuchMethodException, ClassNotFoundException {
