...
public final class MediaCodecUtil {
    ...
    public static /* synthetic */ int m462$r8$lambda$gFxzaZ51c5G_GcWNtAzN1F2QZg(MediaCodecInfo mediaCodecInfo) {
        return mediaCodecInfo.name.startsWith("OMX.google") ? 1 : 0;
    }

    /* JADX INFO: renamed from: $r8$lambda$sLOK7ccsS-ur1NtiGvNU7qvptuU, reason: not valid java name */
    public static /* synthetic */ int m463$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(Format format, MediaCodecInfo mediaCodecInfo) {
    ...
    public static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        ...
        if (i < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new MediaCodecUtil$$ExternalSyntheticLambda3());
            }
        }
    ...
    public static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed MP4A codec string: ", str, "MediaCodecUtil");
            return null;
        }
        try {
    ...
    public static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, @Nullable ColorInfo colorInfo) {
        int i;
        if (strArr.length < 4) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed AV1 codec string: ", str, "MediaCodecUtil");
            return null;
        }
        try {
            ...
            if (i2 != 0) {
                AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown AV1 profile: ", i2, "MediaCodecUtil");
                return null;
            }
            if (i4 != 8 && i4 != 10) {
                AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown AV1 bit depth: ", i4, "MediaCodecUtil");
                return null;
            }
            ...
            AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown AV1 level: ", i3, "MediaCodecUtil");
            return null;
        } catch (NumberFormatException unused) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed AV1 codec string: ", str, "MediaCodecUtil");
            return null;
    ...
    public static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i2;
        if (strArr.length < 2) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed AVC codec string: ", str, "MediaCodecUtil");
            return null;
        }
        try {
            ...
            if (iAvcProfileNumberToConst == -1) {
                AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown AVC profile: ", i2, "MediaCodecUtil");
                return null;
            }
            ...
            AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown AVC level: ", i, "MediaCodecUtil");
            return null;
        } catch (NumberFormatException unused) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed AVC codec string: ", str, "MediaCodecUtil");
            return null;
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.util.ArrayList<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> getDecoderInfosInternal(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r19, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r20) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        /*
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda4
            @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
            public final int getScore(Object obj) {
                return MediaCodecUtil.m463$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(format, (MediaCodecInfo) obj);
            }
        });
        return arrayList;
    }
    ...
    public static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed Dolby Vision codec string: ", str, "MediaCodecUtil");
            return null;
        }
        ...
        if (numDolbyVisionStringToProfile == null) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Unknown Dolby Vision profile string: ", strGroup, "MediaCodecUtil");
            return null;
        }
        ...
        MediaCodecUtil$$ExternalSyntheticOutline0.m("Unknown Dolby Vision level string: ", str2, "MediaCodecUtil");
        return null;
    }
    ...
    public static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr, @Nullable ColorInfo colorInfo) {
        if (strArr.length < 4) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed HEVC codec string: ", str, "MediaCodecUtil");
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!"1".equals(strGroup)) {
            if (!ExifInterface.GPS_MEASUREMENT_2D.equals(strGroup)) {
                MediaCodecUtil$$ExternalSyntheticOutline0.m("Unknown HEVC profile string: ", strGroup, "MediaCodecUtil");
                return null;
            }
        ...
        MediaCodecUtil$$ExternalSyntheticOutline0.m("Unknown HEVC level string: ", str2, "MediaCodecUtil");
        return null;
    }
    ...
    public static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed VP9 codec string: ", str, "MediaCodecUtil");
            return null;
        }
        try {
            ...
            if (iVp9ProfileNumberToConst == -1) {
                AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown VP9 profile: ", i, "MediaCodecUtil");
                return null;
            }
            ...
            AudioFocusManager$$ExternalSyntheticOutline0.m("Unknown VP9 level: ", i2, "MediaCodecUtil");
            return null;
        } catch (NumberFormatException unused) {
            MediaCodecUtil$$ExternalSyntheticOutline0.m("Ignoring malformed VP9 codec string: ", str, "MediaCodecUtil");
            return null;
