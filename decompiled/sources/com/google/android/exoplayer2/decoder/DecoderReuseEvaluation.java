...
public final class DecoderReuseEvaluation {
    ...
    public int hashCode() {
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + DrmInitData$SchemeData$$ExternalSyntheticOutline0.m(this.decoderName, (((527 + this.result) * 31) + this.discardReasons) * 31, 31)) * 31);
    }
}
