...
public final class FrameworkMediaDrm implements ExoMediaDrm {
    ...
    public static ExoMediaDrm m450$r8$lambda$3GNQEqPU_wUEQYVzGhnf5fwpY(UUID uuid) {
        try {
    ...
    public static /* synthetic */ void $r8$lambda$Qh1xFSNh7HjVy7CDxcfSw0XR7EE(FrameworkMediaDrm frameworkMediaDrm, ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener, MediaDrm mediaDrm, byte[] bArr, List list, boolean z) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$hDCQ-S_kpBWygCBN-u86A0gjFPk, reason: not valid java name */
    public static /* synthetic */ void m451$r8$lambda$hDCQS_kpBWygCBNu86A0gjFPk(FrameworkMediaDrm frameworkMediaDrm, ExoMediaDrm.OnExpirationUpdateListener onExpirationUpdateListener, MediaDrm mediaDrm, byte[] bArr, long j) {
        frameworkMediaDrm.getClass();
    ...
    */
    public static byte[] adjustRequestInitData(java.util.UUID r3, byte[] r4) {
        ...
        L10:
            ...
            r1 = 0
            byte[] r4 = com.google.android.exoplayer2.extractor.mp4.PsshAtomUtil.buildPsshAtom(r0, r1, r4)
        L19:
    ...
    public void setOnEventListener(@Nullable final ExoMediaDrm.OnEventListener onEventListener) {
        this.mediaDrm.setOnEventListener(onEventListener == null ? null : new MediaDrm.OnEventListener() { // from class: com.google.android.exoplayer2.drm.FrameworkMediaDrm$$ExternalSyntheticLambda3
            ...
            public final void onEvent(MediaDrm mediaDrm, byte[] bArr, int i, int i2, byte[] bArr2) {
                FrameworkMediaDrm.$r8$lambda$SbLtjC6llPgdjJdrLaTi7pgFrYg(this.f$0, onEventListener, mediaDrm, bArr, i, i2, bArr2);
            }
        });
    }
    ...
    public void setOnExpirationUpdateListener(@Nullable final ExoMediaDrm.OnExpirationUpdateListener onExpirationUpdateListener) {
        ...
        this.mediaDrm.setOnExpirationUpdateListener(onExpirationUpdateListener == null ? null : new MediaDrm.OnExpirationUpdateListener() { // from class: com.google.android.exoplayer2.drm.FrameworkMediaDrm$$ExternalSyntheticLambda2
            ...
            public final void onExpirationUpdate(MediaDrm mediaDrm, byte[] bArr, long j) {
                FrameworkMediaDrm.m451$r8$lambda$hDCQS_kpBWygCBNu86A0gjFPk(this.f$0, onExpirationUpdateListener, mediaDrm, bArr, j);
            }
        }, (Handler) null);
    }
    ...
    public void setOnKeyStatusChangeListener(@Nullable final ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener) {
        ...
        this.mediaDrm.setOnKeyStatusChangeListener(onKeyStatusChangeListener == null ? null : new MediaDrm.OnKeyStatusChangeListener() { // from class: com.google.android.exoplayer2.drm.FrameworkMediaDrm$$ExternalSyntheticLambda0
            ...
            public final void onKeyStatusChange(MediaDrm mediaDrm, byte[] bArr, List list, boolean z) {
                FrameworkMediaDrm.$r8$lambda$Qh1xFSNh7HjVy7CDxcfSw0XR7EE(this.f$0, onKeyStatusChangeListener, mediaDrm, bArr, list, z);
            }
        }, (Handler) null);
    }
