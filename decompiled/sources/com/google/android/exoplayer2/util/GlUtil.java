...
public final class GlUtil {
    ...
    public static boolean isYuvTargetExtensionSupported() {
        ...
        if (Util.areEqual(EGL14.eglGetCurrentContext(), EGL14.EGL_NO_CONTEXT)) {
            try {
                EGLDisplay eGLDisplayCreateEglDisplay = Api17.createEglDisplay();
                EGLContext eGLContextCreateEglContext = createEglContext(eGLDisplayCreateEglDisplay, EGL_CONFIG_ATTRIBUTES_RGBA_8888);
                focusPlaceholderEglSurface(eGLContextCreateEglContext, eGLDisplayCreateEglDisplay);
                strGlGetString = GLES20.glGetString(7939);
                Api17.destroyEglContext(eGLDisplayCreateEglDisplay, eGLContextCreateEglContext);
    ...
    public static int createTexture(int i, int i2, int i3, int i4) throws GlException {
