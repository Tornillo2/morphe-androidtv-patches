...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    /* JADX INFO: renamed from: $r8$lambda$6s_XPbROcPnmfVIQ2J_N-LQ08TQ, reason: not valid java name */
    public static /* synthetic */ void m497$r8$lambda$6s_XPbROcPnmfVIQ2J_NLQ08TQ(SphericalGLSurfaceView sphericalGLSurfaceView) {
    ...
    public static /* synthetic */ void $r8$lambda$enVmfmqUpTHSQjsZD1ltWqpVSP8(SphericalGLSurfaceView sphericalGLSurfaceView, SurfaceTexture surfaceTexture) {
    ...
    public void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            ...
            public final void run() {
                SphericalGLSurfaceView.m497$r8$lambda$6s_XPbROcPnmfVIQ2J_NLQ08TQ(this.f$0);
            }
        });
    }
    ...
    public final void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SphericalGLSurfaceView.$r8$lambda$enVmfmqUpTHSQjsZD1ltWqpVSP8(this.f$0, surfaceTexture);
            }
        });
    }
