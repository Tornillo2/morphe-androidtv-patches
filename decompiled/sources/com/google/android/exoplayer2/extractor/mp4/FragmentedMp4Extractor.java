...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static /* synthetic */ Extractor[] m456$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM() {
    ...
    public static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i14 < i13) {
            ...
            jArr2[i15] = jScaleLargeTimestamp;
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr2[i15] = jScaleLargeTimestamp + trackBundle.moovSampleTable.durationUs;
            }
            iArr[i15] = i7;
    ...
    public final void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            if (fullAtomVersion != 1) {
                AudioFocusManager$$ExternalSyntheticOutline0.m("Skipping unsupported emsg version: ", fullAtomVersion, "FragmentedMp4Extractor");
                return;
            }
    ...
    public final void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        ArrayList arrayList = (ArrayList) AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda1
    ...
    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster) {
        this(i, timestampAdjuster, null, Collections.EMPTY_LIST, null);
    }

    public FragmentedMp4Extractor(int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track) {
        this(i, timestampAdjuster, track, Collections.EMPTY_LIST, null);
    }
