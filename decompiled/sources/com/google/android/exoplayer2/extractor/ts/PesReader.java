...
public final class PesReader implements TsPayloadReader {
            ...
            if (i3 != 0) {
                if (i3 != 1) {
                    if (i3 == 2) {
                        ...
                        if (i5 > 0) {
                            iBytesLeft -= i5;
                            parsableByteArray.setLimit(parsableByteArray.position + iBytesLeft);
                        }
    ...
    public final boolean continueRead(ParsableByteArray parsableByteArray, @Nullable byte[] bArr, int i) {
    ...
    public final boolean parseHeader() {
        ...
        if (bits != 1) {
            AudioFocusManager$$ExternalSyntheticOutline0.m("Unexpected start code prefix: ", bits, "PesReader");
            this.payloadSize = -1;
            return false;
        }
