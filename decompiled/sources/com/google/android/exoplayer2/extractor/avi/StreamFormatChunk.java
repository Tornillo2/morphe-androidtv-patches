...
public final class StreamFormatChunk implements AviChunk {
    ...
    public static AviChunk parseBitmapInfoHeader(ParsableByteArray parsableByteArray) {
        ...
        if (mimeTypeFromCompression == null) {
            AudioFocusManager$$ExternalSyntheticOutline0.m("Ignoring track with unsupported compression ", littleEndianInt3, "StreamFormatChunk");
            return null;
        }
        Format.Builder builder = new Format.Builder();
        builder.width = littleEndianInt;
        builder.height = littleEndianInt2;
        builder.sampleMimeType = mimeTypeFromCompression;
    ...
    public static AviChunk parseWaveFormatEx(ParsableByteArray parsableByteArray) {
        ...
        if (mimeTypeFromTag == null) {
            AudioFocusManager$$ExternalSyntheticOutline0.m("Ignoring track with unsupported format tag ", littleEndianUnsignedShort, "StreamFormatChunk");
            return null;
        }
        ...
        Format.Builder builder = new Format.Builder();
        builder.sampleMimeType = mimeTypeFromTag;
