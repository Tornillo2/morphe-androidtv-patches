...
public final class DefaultExtractorInput implements ExtractorInput {
    ...
    public final void commitBytesRead(int i) {
        if (i != -1) {
    ...
    public final int readFromPeekBuffer(byte[] bArr, int i, int i2) {
        int i3 = this.peekBufferLength;
        if (i3 == 0) {
            return 0;
        }
    ...
    public final int readFromUpstream(byte[] bArr, int i, int i2, int i3, boolean z) throws IOException {
    ...
    public final int skipFromPeekBuffer(int i) {
