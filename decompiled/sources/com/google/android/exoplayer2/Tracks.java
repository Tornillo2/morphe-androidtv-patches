...
public final class Tracks implements Bundleable {
    ...
    public static final class Group implements Bundleable {
        ...
        public static Group m420$r8$lambda$5U4Vd2ct8VgoPhf6SgLr2Yc2Y(Bundle bundle) {
            Bundleable.Creator<TrackGroup> creator = TrackGroup.CREATOR;
            Bundle bundle2 = bundle.getBundle(FIELD_TRACK_GROUP);
            bundle2.getClass();
            TrackGroup trackGroup = (TrackGroup) creator.fromBundle(bundle2);
    ...
    public static Tracks $r8$lambda$vYA5RM9DVNv_S8EIm2h75eWpGro(Bundle bundle) {
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(FIELD_TRACK_GROUPS);
        return new Tracks(parcelableArrayList == null ? RegularImmutableList.EMPTY : BundleableUtil.fromBundleList(Group.CREATOR, parcelableArrayList));
    }
