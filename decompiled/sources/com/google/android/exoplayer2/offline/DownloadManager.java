...
public final class DownloadManager {
    ...
    /* JADX INFO: renamed from: $r8$lambda$fuj8eSXOdf-Kow5OUl2qXLFR6UQ, reason: not valid java name */
    public static /* synthetic */ boolean m466$r8$lambda$fuj8eSXOdfKow5OUl2qXLFR6UQ(DownloadManager downloadManager, Message message) {
        downloadManager.handleMainMessage(message);
        return true;
    }
    ...
    public Requirements getRequirements() {
        return this.requirementsWatcher.requirements;
    }
    ...
    public final void onDownloadUpdate(DownloadUpdate downloadUpdate) {
        this.downloads = DesugarCollections.unmodifiableList(downloadUpdate.downloads);
    ...
    public final void onInitialized(List<Download> list) {
        ...
        this.downloads = DesugarCollections.unmodifiableList(list);
        boolean zUpdateWaitingForRequirements = updateWaitingForRequirements();
        Iterator<Listener> it = this.listeners.iterator();
        while (it.hasNext()) {
    ...
    public void setRequirements(Requirements requirements) {
        if (requirements.equals(this.requirementsWatcher.requirements)) {
            return;
        }
        this.requirementsWatcher.stop();
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory, Executor executor) {
        ...
        this(context, defaultDownloadIndex, new DefaultDownloaderFactory(factory2, executor));
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.google.android.exoplayer2.offline.DownloadManager$$ExternalSyntheticLambda0
            ...
            public final boolean handleMessage(Message message) {
                DownloadManager.m466$r8$lambda$fuj8eSXOdfKow5OUl2qXLFR6UQ(this.f$0, message);
                return true;
            }
        });
    ...
    public static final class InternalHandler extends Handler {
        ...
        public final void initialize(int i) {
            ...
            try {
                try {
                    ...
                    while (((DefaultDownloadIndex.DownloadCursorImpl) downloads).moveToNext()) {
                        this.downloads.add(DefaultDownloadIndex.getDownloadForCurrentRow(((DefaultDownloadIndex.DownloadCursorImpl) downloads).cursor));
                    }
                } catch (IOException e) {
        ...
        public final Download putDownloadWithState(Download download, int i, int i2) {
            Assertions.checkState((i == 3 || i == 4) ? false : true);
            Download downloadCopyDownloadWithState = copyDownloadWithState(download, i, i2);
        ...
        public final void removeAllDownloads() {
            ...
            try {
                ...
                while (true) {
                    try {
                        downloadCursorImpl = (DefaultDownloadIndex.DownloadCursorImpl) downloads;
                        if (!downloadCursorImpl.moveToNext()) {
                            break;
                        } else {
                            arrayList.add(DefaultDownloadIndex.getDownloadForCurrentRow(((DefaultDownloadIndex.DownloadCursorImpl) downloads).cursor));
                        }
                    } finally {
                    }
                }
                downloadCursorImpl.close();
            } catch (IOException unused) {
            ...
            if (str == null) {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.e("DownloadManager", "Failed to set manual stop reason: ".concat(str), e2);
                    }
                }
            }
            syncTasks();
    ...
    public interface Listener {
        ...
        /* JADX INFO: renamed from: com.google.android.exoplayer2.offline.DownloadManager$Listener$-CC, reason: invalid class name */
        /* JADX INFO: compiled from: r8-map-id-11d7710e1e89b9f435e4c01ffffd6a5bc78c9d6db2bbad6c6777697ebd4119c9 */
        public final /* synthetic */ class CC {
            ...
            public static void $default$onDownloadChanged(Listener listener, DownloadManager downloadManager, Download download, @Nullable Exception exc) {
            }
