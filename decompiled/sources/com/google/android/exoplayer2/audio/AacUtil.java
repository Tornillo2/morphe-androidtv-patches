...
public final class AacUtil {
    ...
    public static final String CODECS_STRING_PREFIX = "mp4a.40.";
    public static final String TAG = "AacUtil";
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i, int i2) {
        ...
        if (i == -1 || i6 == -1) {
            throw new IllegalArgumentException(Utf8$UnpairedSurrogateException$$ExternalSyntheticOutline0.m("Invalid sample rate or number of channels: ", i, ", ", i2));
        }
    ...
    public static int getAudioObjectType(ParsableBitArray parsableBitArray) {
    ...
    public static Config parseAudioSpecificConfig(byte[] bArr) throws ParserException {
        return parseAudioSpecificConfig(new ParsableBitArray(bArr, bArr.length), false);
    }
    ...
    public static Config parseAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z) throws ParserException {
        ...
        int bits = parsableBitArray.readBits(4);
        String strM = MediaBrowserCompat$MediaBrowserImplBase$$ExternalSyntheticOutline0.m("mp4a.40.", audioObjectType);
        ...
        if (i != -1) {
            return new Config(samplingFrequency, i, strM);
        }
