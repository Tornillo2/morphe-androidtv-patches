...
public final class SilenceSkippingAudioProcessor extends BaseAudioProcessor {
    ...
    public final void output(byte[] bArr, int i) {
    ...
    public final void processMaybeSilence(ByteBuffer byteBuffer) {
        int iLimit = byteBuffer.limit();
    ...
    public final void processSilence(ByteBuffer byteBuffer) {
        int iLimit = byteBuffer.limit();
        int iFindNoisePosition = findNoisePosition(byteBuffer);
    ...
    public final void updatePaddingBuffer(ByteBuffer byteBuffer, byte[] bArr, int i) {
