...
public final class Sonic {
    ...
    public final void adjustRate(float f, int i) {
        int i2;
        int i3;
    ...
    public final void changeSpeed(float f) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                ...
                if (f > 1.0d) {
                    iSkipPitchPeriod = skipPitchPeriod(this.inputBuffer, iSkipPitchPeriod, f, iFindPitchPeriod) + iFindPitchPeriod + iSkipPitchPeriod;
                } else {
                    iInsertPitchPeriod = insertPitchPeriod(this.inputBuffer, iSkipPitchPeriod, f, iFindPitchPeriod);
                }
            }
            iSkipPitchPeriod = iInsertPitchPeriod + iSkipPitchPeriod;
        } while (this.maxRequiredFrameCount + iSkipPitchPeriod <= i);
        removeProcessedInputFrames(iSkipPitchPeriod);
    }

    public final int copyInputToOutput(int i) {
    ...
    public final int findPitchPeriod(short[] sArr, int i) {
    ...
    public final int insertPitchPeriod(short[] sArr, int i, float f, int i2) {
        int i3;
        if (f < 0.5f) {
            i3 = (int) ((i2 * f) / (1.0f - f));
        } else {
    ...
    public final short interpolate(short[] sArr, int i, int i2, int i3) {
        short s = sArr[i];
    ...
    public final void moveNewSamplesToPitchBuffer(int i) {
    ...
    public final boolean previousPeriodBetter(int i, int i2) {
    ...
    public final void removePitchFrames(int i) {
        if (i == 0) {
            return;
        }
    ...
    public final void removeProcessedInputFrames(int i) {
    ...
    public final int skipPitchPeriod(short[] sArr, int i, float f, int i2) {
        int i3;
        if (f >= 2.0f) {
            i3 = (int) (i2 / (f - 1.0f));
        } else {
