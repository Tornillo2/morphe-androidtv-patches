...
public final class Ac3Util {
    ...
    public static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, MediaSessionCompat.MAX_BITMAP_SIZE_IN_DP, 384, 448, 512, 576, 640};
    public static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, 174, ReverseBinaryEncoder.TYPE_STRUCT, 243, 278, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static Format parseAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, @Nullable DrmInitData drmInitData) {
        ...
        builder.id = str;
        builder.sampleMimeType = "audio/ac3";
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            if (bits2 == 3) {
                ...
                int i12 = BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[bits3];
                i6 = bits3;
                i = SAMPLE_RATE_BY_FSCOD[bits2];
                i7 = i12;
            }
            int i13 = i7 * 256;
            int iCalculateEac3Bitrate = calculateEac3Bitrate(ac3SyncframeSize, i, i7);
            ...
            if (i11 == 2 && (i6 == 3 || parsableBitArray.readBit())) {
                i8 = 6;
                parsableBitArray.skipBits(6);
            } else {
                i8 = 6;
        ...
        return new SyncFrameInfo(str, i4, i2, i, ac3SyncframeSize, i5, i3);
    }
    ...
    */
    public static com.google.android.exoplayer2.Format parseEAc3AnnexFFormat(com.google.android.exoplayer2.util.ParsableByteArray r7, java.lang.String r8, java.lang.String r9, @androidx.annotation.Nullable com.google.android.exoplayer2.drm.DrmInitData r10) {
        /*
