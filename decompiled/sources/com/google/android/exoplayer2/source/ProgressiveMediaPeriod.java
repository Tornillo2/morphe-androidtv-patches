...
public final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public final Runnable maybeFinishPrepareRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda0
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.maybeFinishPrepare();
        }
    };
    public final Runnable onContinueLoadingRequestedRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
            ProgressiveMediaPeriod.$r8$lambda$ahkU4IiNnM317z6WGGOhU6K743E(this.f$0);
        }
    };
    ...
    public static void $r8$lambda$ahkU4IiNnM317z6WGGOhU6K743E(ProgressiveMediaPeriod progressiveMediaPeriod) {
    ...
    */
    public final long getLargestQueuedTimestampUs(boolean r6) {
        ...
        L3:
            ...
            if (r2 >= r3) goto L24
            if (r6 != 0) goto L15
            com.google.android.exoplayer2.source.ProgressiveMediaPeriod$TrackState r3 = r5.trackState
            r3.getClass()
        ...
        L24:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.source.ProgressiveMediaPeriod.getLargestQueuedTimestampUs(boolean):long");
    }
