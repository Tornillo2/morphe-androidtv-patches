...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    public static final class FakeMediaSource extends BaseMediaSource {
        ...
        public FakeMediaSource(AnonymousClass1 anonymousClass1) {
        }
    ...
    public static /* synthetic */ boolean $r8$lambda$xvlxaabNVihM68DRWdn_WPenrXk(ConcatenatingMediaSource concatenatingMediaSource, Message message) {
        concatenatingMediaSource.handleMessage(message);
        return true;
    }
    ...
    public final void addMediaSourceInternal(int i, MediaSourceHolder mediaSourceHolder) {
        if (i > 0) {
            ...
            mediaSourceHolder.reset(i, mediaSourceHolder2.mediaSource.timeline.timeline.getWindowCount() + mediaSourceHolder2.firstWindowIndexInChild);
        } else {
        ...
        try {
            ...
            this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: com.google.android.exoplayer2.source.ConcatenatingMediaSource$$ExternalSyntheticLambda0
                ...
                public final boolean handleMessage(Message message) {
                    ConcatenatingMediaSource.$r8$lambda$xvlxaabNVihM68DRWdn_WPenrXk(this.f$0, message);
                    return true;
                }
            });
    ...
    public final void removeMediaSourceInternal(int i) {
        ...
        correctOffsets(i, -1, -mediaSourceHolderRemove.mediaSource.timeline.timeline.getWindowCount());
    ...
    public ConcatenatingMediaSource(boolean z, MediaSource... mediaSourceArr) {
        this(z, false, new ShuffleOrder.DefaultShuffleOrder(0), mediaSourceArr);
    }
    ...
    public int getWindowIndexForChildWindowIndex2(MediaSourceHolder mediaSourceHolder, int i) {
        return i + mediaSourceHolder.firstWindowIndexInChild;
    }
