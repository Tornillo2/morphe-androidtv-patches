...
public final class ReaderInputStream extends InputStream {
    ...
    public static CharBuffer grow(CharBuffer buf) {
    ...
    public final int drain(byte[] b, int off, int len) {
    ...
    public final void readMoreChars() throws IOException {
    ...
    public final void startDraining(boolean overflow) {
