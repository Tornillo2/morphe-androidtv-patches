...
public final class ImmutableSortedMap<K, V> extends ImmutableMap<K, V> implements NavigableMap<K, V>, Map {
    ...
    public static class Builder<K, V> extends ImmutableMap.Builder<K, V> {
        ...
        @Deprecated
        public /* bridge */ /* synthetic */ ImmutableMap.Builder orderEntriesByValue(Comparator valueComparator) {
            orderEntriesByValue(valueComparator);
            throw null;
        }
        ...
        public ImmutableSortedMap<K, V> buildOrThrow() {
            ...
            return new ImmutableSortedMap<>(new RegularImmutableSortedSet(ImmutableList.asImmutableList(objArrCopyOf, objArrCopyOf.length), this.comparator), ImmutableList.asImmutableList(objArr, i2), null);
        }
    ...
    public static class SerializedForm<K, V> extends ImmutableMap.SerializedForm<K, V> {
        ...
        public Builder<K, V> makeBuilder(int size) {
            return new Builder<>(this.comparator, 4);
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$j5KH4cv-Ii3fNlMU1-nxOAGJM2w, reason: not valid java name */
    public static /* synthetic */ int m516$r8$lambda$j5KH4cvIi3fNlMU1nxOAGJM2w(Comparator comparator, Map.Entry entry, Map.Entry entry2) {
    ...
    static {
        ...
        NATURAL_EMPTY_MAP = new ImmutableSortedMap<>(ImmutableSortedSet.emptySet(naturalOrdering), ImmutableList.of(), null);
    }
    ...
    public static <K, V> ImmutableSortedMap<K, V> copyOfInternal(java.util.Map<? extends K, ? extends V> map, Comparator<? super K> comparator) {
    ...
    public static <K, V> ImmutableSortedMap<K, V> emptyMap(Comparator<? super K> comparator) {
        return NaturalOrdering.INSTANCE.equals(comparator) ? (ImmutableSortedMap<K, V>) NATURAL_EMPTY_MAP : new ImmutableSortedMap<>(ImmutableSortedSet.emptySet(comparator), RegularImmutableList.EMPTY, null);
    }

    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> fromEntries(Map.Entry<K, V>... entries) {
        return fromEntries(NaturalOrdering.INSTANCE, false, entries, entries.length);
    }

    public static <K extends Comparable<?>, V> Builder<K, V> naturalOrder() {
        return new Builder<>(NaturalOrdering.INSTANCE, 4);
    }
    ...
    public static <K, V> Builder<K, V> orderedBy(Comparator<K> comparator) {
        return new Builder<>(comparator, 4);
    }
    ...
    public static <K extends Comparable<?>, V> Builder<K, V> reverseOrder() {
        ...
        return new Builder<>(ReverseNaturalOrdering.INSTANCE, 4);
    }
    ...
    public final ImmutableSortedMap<K, V> getSubMap(int fromIndex, int toIndex) {
        return (fromIndex == 0 && toIndex == this.valueList.size()) ? this : fromIndex == toIndex ? emptyMap(this.keySet.comparator) : new ImmutableSortedMap<>(this.keySet.getSubSet(fromIndex, toIndex), this.valueList.subList(fromIndex, toIndex), null);
    }
    ...
    public Map.Entry<K, V> lastEntry() {
        ...
        return super.entrySet().asList().get(this.valueList.size() - 1);
    }
    ...
    public static <K, V> ImmutableSortedMap<K, V> of(Comparator<? super K> comparator, K k1, V v1) {
        ImmutableList immutableListOf = ImmutableList.of(k1);
        comparator.getClass();
        return new ImmutableSortedMap<>(new RegularImmutableSortedSet(immutableListOf, comparator), ImmutableList.of(v1), null);
    }
    ...
    public ImmutableSortedMap<K, V> descendingMap() {
        ...
        return immutableSortedMap == null ? isEmpty() ? emptyMap(Ordering.from(this.keySet.comparator).reverse()) : new ImmutableSortedMap<>((RegularImmutableSortedSet) this.keySet.descendingSet(), this.valueList.reverse(), this) : immutableSortedMap;
    }
    ...
    public ImmutableSortedMap<K, V> subMap(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
        fromKey.getClass();
        toKey.getClass();
        Preconditions.checkArgument(this.keySet.comparator.compare(fromKey, toKey) <= 0, "expected fromKey <= toKey but %s > %s", fromKey, toKey);
    ...
    public ImmutableSortedMap<K, V> tailMap(K fromKey, boolean inclusive) {
        RegularImmutableSortedSet<K> regularImmutableSortedSet = this.keySet;
        fromKey.getClass();
        return getSubMap(regularImmutableSortedSet.tailIndex(fromKey, inclusive), this.valueList.size());
    }
    ...
    public static <K, V> ImmutableSortedMap<K, V> copyOf(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries, Comparator<? super K> comparator) {
        comparator.getClass();
        return fromEntries(comparator, false, entries);
    }
    ...
    public static <K, V> ImmutableSortedMap<K, V> fromEntries(final Comparator<? super K> comparator, boolean sameComparator, Map.Entry<K, V>[] entryArray, int size) {
        ...
        if (size != 1) {
            ...
            if (sameComparator) {
                ...
                Arrays.sort(entryArray, 0, size, new Comparator() { // from class: com.google.common.collect.ImmutableSortedMap$$ExternalSyntheticLambda0
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return ImmutableSortedMap.m516$r8$lambda$j5KH4cvIi3fNlMU1nxOAGJM2w(comparator, (Map.Entry) obj, (Map.Entry) obj2);
                    }
                });
            ...
            return new ImmutableSortedMap<>(new RegularImmutableSortedSet(ImmutableList.asImmutableList(objArr, size), comparator), ImmutableList.asImmutableList(objArr2, size), null);
        }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2)}, 2);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1) {
        return of(NaturalOrdering.INSTANCE, k1, v1);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3)}, 3);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4)}, 4);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4, Comparable k5, Object v5) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5)}, 5);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4, Comparable k5, Object v5, Comparable k6, Object v6) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5), ImmutableMap.entryOf(k6, v6)}, 6);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4, Comparable k5, Object v5, Comparable k6, Object v6, Comparable k7, Object v7) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5), ImmutableMap.entryOf(k6, v6), ImmutableMap.entryOf(k7, v7)}, 7);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4, Comparable k5, Object v5, Comparable k6, Object v6, Comparable k7, Object v7, Comparable k8, Object v8) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5), ImmutableMap.entryOf(k6, v6), ImmutableMap.entryOf(k7, v7), ImmutableMap.entryOf(k8, v8)}, 8);
    }
    ...
    public static ImmutableSortedMap of(Comparable k1, Object v1, Comparable k2, Object v2, Comparable k3, Object v3, Comparable k4, Object v4, Comparable k5, Object v5, Comparable k6, Object v6, Comparable k7, Object v7, Comparable k8, Object v8, Comparable k9, Object v9) {
        return fromEntries(NaturalOrdering.INSTANCE, false, new Map.Entry[]{ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5), ImmutableMap.entryOf(k6, v6), ImmutableMap.entryOf(k7, v7), ImmutableMap.entryOf(k8, v8), ImmutableMap.entryOf(k9, v9)}, 9);
    }
