...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    public final class EntryForKey extends AbstractMapEntry<K, V> {
        ...
        public V setValue(@ParametricNullness V value) {
            ...
            int i = this.index;
            if (i == -1) {
                HashBiMap.this.put(this.key, value, false);
                return null;
            }
    ...
    public static final class EntryForValue<K, V> extends AbstractMapEntry<V, K> {
        ...
        public EntryForValue(HashBiMap<K, V> biMap, int index) {
            this.biMap = biMap;
    ...
    private void readObject(ObjectInputStream stream) throws ClassNotFoundException, IOException {
        ...
        init(16);
        Serialization.populateMap(this, stream, i);
    }
    ...
    public K removeInverse(Object value) {
        int iSmearedHash = Hashing.smearedHash(value);
        int iFindEntryByValue = findEntryByValue(value, iSmearedHash);
        if (iFindEntryByValue == -1) {
            return null;
    ...
    public final void replaceKeyInEntry(int entry, @ParametricNullness K newKey, boolean force) {
        ...
        if (iFindEntryByKey == -1) {
            ...
            if (!force) {
                throw new IllegalArgumentException(MediaPipelineBackendEngineManager$$ExternalSyntheticOutline2.m("Key already present in map: ", newKey));
            }
    ...
    public final void replaceValueInEntry(int entry, @ParametricNullness V newValue, boolean force) {
        ...
        if (iFindEntryByValue != -1) {
            if (!force) {
                throw new IllegalArgumentException(MediaPipelineBackendEngineManager$$ExternalSyntheticOutline2.m("Value already present in map: ", newValue));
            }
            removeEntryValueHashKnown(iFindEntryByValue, iSmearedHash);
            if (entry == this.size) {
