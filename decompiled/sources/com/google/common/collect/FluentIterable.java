...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public class AnonymousClass2<T> extends FluentIterable<T> {
        ...
        public AnonymousClass2(final Iterable val$inputs) {
            this.val$inputs = val$inputs;
        }

        @Override // java.lang.Iterable
        public Iterator<T> iterator() {
            return new Iterators.ConcatenatedIterator(new Iterators.AnonymousClass6(this.val$inputs.iterator(), new FluentIterable$2$$ExternalSyntheticLambda0()));
        }
    }
    ...
    public static <T> FluentIterable<T> concatNoDefensiveCopy(final Iterable<? extends T>... inputs) {
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.3
            @Override // java.lang.Iterable
            public Iterator<T> iterator() {
                return new Iterators.ConcatenatedIterator(new AbstractIndexedListIterator<Iterator<? extends T>>(inputs.length) { // from class: com.google.common.collect.FluentIterable.3.1
    ...
    public static <E> FluentIterable<E> of(@ParametricNullness E element, E... elements) {
        return from(new Lists.OnePlusArrayList(element, elements));
    }
    ...
    public <T> FluentIterable<T> transformAndConcat(Function<? super E, ? extends Iterable<? extends T>> function) {
        return new AnonymousClass2(transform(function));
    }
    ...
    public static <T> FluentIterable<T> concat(Iterable<? extends Iterable<? extends T>> inputs) {
        inputs.getClass();
        return new AnonymousClass2(inputs);
    }
