...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    public static class Builder<N, V> {
        ...
        public Builder(ValueGraphBuilder<N, V> graphBuilder) {
            ValueGraphBuilder<N, V> valueGraphBuilderCopy = graphBuilder.copy();
            valueGraphBuilderCopy.incidentEdgeOrder(ElementOrder.stable());
            this.mutableValueGraph = new StandardMutableValueGraph(valueGraphBuilderCopy);
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$3DssDe_CBaUIGZpIxMXmj-OKncQ, reason: not valid java name */
    public static /* synthetic */ Object m545$r8$lambda$3DssDe_CBaUIGZpIxMXmjOKncQ(ValueGraph valueGraph, Object obj, Object obj2) {
    ...
    public ImmutableValueGraph(ValueGraph<N, V> graph) {
        super(ValueGraphBuilder.from(graph), getNodeConnections(graph), ((AbstractBaseGraph.AnonymousClass1) graph.edges()).size());
    }

    public static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> graph, final N node) {
        Function function = new Function() { // from class: com.google.common.graph.ImmutableValueGraph$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return ImmutableValueGraph.m545$r8$lambda$3DssDe_CBaUIGZpIxMXmjOKncQ(graph, node, obj);
            }
        };
        return graph.isDirected() ? DirectedGraphConnections.ofImmutable(node, graph.incidentEdges(node), function) : UndirectedGraphConnections.ofImmutable(new Maps.AsMapView(graph.adjacentNodes(node), function));
    }
    ...
    public static <N, V> ImmutableMap<N, GraphConnections<N, V>> getNodeConnections(ValueGraph<N, V> graph) {
