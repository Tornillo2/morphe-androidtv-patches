...
public abstract class WrappingExecutorService implements ExecutorService {
    ...
    public static /* synthetic */ void $r8$lambda$JaV9JSzE8iMqrlX555hXKJFt8us(Callable callable) {
        try {
            callable.call();
        } catch (Exception e) {
    ...
    public Runnable wrapTask(Runnable command) {
        ...
        return new Runnable() { // from class: com.google.common.util.concurrent.WrappingExecutorService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WrappingExecutorService.$r8$lambda$JaV9JSzE8iMqrlX555hXKJFt8us(callableWrapTask);
            }
        };
    }
    ...
    public final <T> ImmutableList<Callable<T>> wrapTasks(Collection<? extends Callable<T>> tasks) {
