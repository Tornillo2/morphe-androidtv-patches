...
public final class Chars {
    ...
    public static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
        ...
        public CharArrayAsList(char[] array, int start, int end) {
            this.array = array;
            this.start = start;
            this.end = end;
        }
    ...
    public static List<Character> asList(char... backingArray) {
        return backingArray.length == 0 ? Collections.EMPTY_LIST : new CharArrayAsList(backingArray, 0, backingArray.length);
    }
    ...
    public static String join(String separator, char... array) {
        ...
        StringBuilder sb = new StringBuilder(ColorUtils$$ExternalSyntheticOutline0.m(length, 1, separator.length(), length));
        sb.append(array[0]);
