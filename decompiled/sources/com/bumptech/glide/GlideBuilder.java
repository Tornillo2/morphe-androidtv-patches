...
public final class GlideBuilder {
    ...
    public Glide build(@NonNull Context context) {
        ...
        if (this.memorySizeCalculator == null) {
            this.memorySizeCalculator = new MemorySizeCalculator(new MemorySizeCalculator.Builder(context));
        }
        if (this.connectivityMonitorFactory == null) {
            this.connectivityMonitorFactory = new DefaultConnectivityMonitorFactory();
        }
        if (this.bitmapPool == null) {
            int i = this.memorySizeCalculator.bitmapPoolSize;
            if (i > 0) {
        ...
        if (this.memoryCache == null) {
            this.memoryCache = new LruResourceCache(this.memorySizeCalculator.memoryCacheSize);
        }
        ...
        if (list == null) {
            ...
            this.defaultRequestListeners = DesugarCollections.unmodifiableList(list);
        }
    ...
    public GlideBuilder setDefaultRequestOptions(@NonNull Glide.RequestOptionsFactory requestOptionsFactory) {
        Preconditions.checkNotNull(requestOptionsFactory, "Argument must not be null");
    ...
    public GlideBuilder setMemorySizeCalculator(@NonNull MemorySizeCalculator.Builder builder) {
        builder.getClass();
        this.memorySizeCalculator = new MemorySizeCalculator(builder);
        return this;
    }
    ...
    public GlideBuilder setDefaultRequestOptions(@Nullable final RequestOptions requestOptions) {
        this.defaultRequestOptionsFactory = new Glide.RequestOptionsFactory() { // from class: com.bumptech.glide.GlideBuilder.2
            @Override // com.bumptech.glide.Glide.RequestOptionsFactory
            @NonNull
            public RequestOptions build() {
