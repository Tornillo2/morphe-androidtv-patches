...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
    ...
    @NonNull
    public final Context findContextForPackage(Uri uri, String str) {
    ...
    public Resource<Drawable> decode(@NonNull Uri uri, int i, int i2, @NonNull Options options) {
        ...
        return NonOwnedDrawableResource.newInstance(DrawableDecoderCompat.getDrawable(this.context, contextFindContextForPackage, findResourceIdFromUri(contextFindContextForPackage, uri), null));
    }
