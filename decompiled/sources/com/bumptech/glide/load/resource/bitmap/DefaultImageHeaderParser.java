...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    public final int moveToExifSegmentAndGetLength(Reader reader) throws IOException {
        ...
        if (Log.isLoggable(TAG, 3)) {
            StringBuilder sbM = MutableFloatList$$ExternalSyntheticOutline0.m("Unable to skip enough data, type: ", uInt8, ", wanted to skip: ", uInt16, ", but actually skipped: ");
            sbM.append(jSkip);
            ...
            if (int163 == 274) {
                ...
                if (int164 >= 1 && int164 <= 12) {
                    ...
                    if (int322 < 0) {
                        ...
                        if (Log.isLoggable(TAG, 3)) {
                            StringBuilder sbM = MutableFloatList$$ExternalSyntheticOutline0.m("Got tagIndex=", i, " tagType=", int163, " formatCode=");
                            sbM.append((int) int164);
                            sbM.append(" componentCount=");
                            sbM.append(int322);
                            Log.d(TAG, sbM.toString());
                        }
                        ...
                        if (i2 > 4) {
                            ...
                            if (i3 >= 0 && i3 <= randomAccessReader.data.remaining()) {
                                if (i2 >= 0 && i2 + i3 <= randomAccessReader.data.remaining()) {
