...
public final class MemorySizeCalculator {
    ...
    public MemorySizeCalculator(Builder builder) {
        ...
        int i = builder.activityManager.isLowRamDevice() ? builder.arrayPoolSizeBytes / 2 : builder.arrayPoolSizeBytes;
        ...
        int iRound = Math.round(builder.bitmapPoolScreens * heightPixels);
        int iRound2 = Math.round(heightPixels * builder.memoryCacheScreens);
        int i2 = maxSize - i;
        ...
        if (Log.isLoggable(TAG, 3)) {
            ...
            sb.append(builder.activityManager.isLowRamDevice());
