...
public class MultiModelLoaderFactory {
    ...
    public final <Model, Data> void add(@NonNull Class<Model> cls, @NonNull Class<Data> cls2, @NonNull ModelLoaderFactory<? extends Model, ? extends Data> modelLoaderFactory, boolean z) {
    ...
    @NonNull
    public final <Model, Data> ModelLoaderFactory<Model, Data> getFactory(@NonNull Entry<?, ?> entry) {
    ...
    @NonNull
    public final <Model, Data> ModelLoader<Model, Data> build(@NonNull Entry<?, ?> entry) {
        ModelLoader<Model, Data> modelLoader = (ModelLoader<Model, Data>) entry.factory.build(this);
        Preconditions.checkNotNull(modelLoader, "Argument must not be null");
        return modelLoader;
    }
}
