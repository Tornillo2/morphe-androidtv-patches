...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    public static final Set<String> SCHEMES = DesugarCollections.unmodifiableSet(new HashSet(Arrays.asList(StringLookupFactory.KEY_FILE, "android.resource", "content")));
