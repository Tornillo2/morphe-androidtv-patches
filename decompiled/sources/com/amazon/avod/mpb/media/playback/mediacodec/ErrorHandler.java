...
public interface ErrorHandler {
    void onError(@NotNull String str, @NotNull MediaPipelineBackendResultCode mediaPipelineBackendResultCode, @NotNull String str2, @NotNull ErrorCallback.ErrorSeverity errorSeverity);
}
