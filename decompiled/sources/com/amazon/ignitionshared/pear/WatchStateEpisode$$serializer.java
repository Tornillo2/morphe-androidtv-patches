...
public /* synthetic */ class WatchStateEpisode$$serializer implements GeneratedSerializer<WatchStateEpisode> {

    @NotNull
    public static final WatchStateEpisode$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        WatchStateEpisode$$serializer watchStateEpisode$$serializer = new WatchStateEpisode$$serializer();
        INSTANCE = watchStateEpisode$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.ignitionshared.pear.WatchStateEpisode", watchStateEpisode$$serializer, 5);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{Id$$serializer.INSTANCE, nullable, nullable2, BuiltinSerializersKt.getNullable(intSerializer), intSerializer};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final WatchStateEpisode deserialize(@NotNull Decoder decoder) {
        ...
        return new WatchStateEpisode(i, id, str, str2, num, iDecodeIntElement, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull WatchStateEpisode value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(serialDescriptor);
        WatchStateEpisode.write$Self$ignitionshared_release(value, compositeEncoderBeginStructure, serialDescriptor);
