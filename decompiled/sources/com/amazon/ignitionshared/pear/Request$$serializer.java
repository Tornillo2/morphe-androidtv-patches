...
public /* synthetic */ class Request$$serializer implements GeneratedSerializer<Request> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.ignitionshared.pear.Request", request$$serializer, 1);
    ...
    @NotNull
    public final Request deserialize(@NotNull Decoder decoder) {
        ...
        return new Request(i, httpRequestV1, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Request value) {
