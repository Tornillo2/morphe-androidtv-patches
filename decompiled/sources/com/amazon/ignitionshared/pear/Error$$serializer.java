...
public /* synthetic */ class Error$$serializer implements GeneratedSerializer<Error> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.ignitionshared.pear.Error", error$$serializer, 1);
    ...
    public final Error deserialize(@NotNull Decoder decoder) {
        ...
        return new Error(i, httpRequestV1, null);
    }
