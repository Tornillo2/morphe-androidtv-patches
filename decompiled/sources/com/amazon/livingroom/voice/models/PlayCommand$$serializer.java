...
public /* synthetic */ class PlayCommand$$serializer implements GeneratedSerializer<PlayCommand> {

    @NotNull
    public static final PlayCommand$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        PlayCommand$$serializer playCommand$$serializer = new PlayCommand$$serializer();
        INSTANCE = playCommand$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.livingroom.voice.models.PlayCommand", playCommand$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr = PlayCommand.$childSerializers;
        return new KSerializer[]{lazyArr[0].getValue(), StringSerializer.INSTANCE, lazyArr[2].getValue()};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final PlayCommand deserialize(@NotNull Decoder decoder) {
        ...
        return new PlayCommand(i, voiceCommandNamespace, strDecodeStringElement, voiceCommandName, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull PlayCommand value) {
