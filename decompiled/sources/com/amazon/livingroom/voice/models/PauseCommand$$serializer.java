...
public /* synthetic */ class PauseCommand$$serializer implements GeneratedSerializer<PauseCommand> {

    @NotNull
    public static final PauseCommand$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        PauseCommand$$serializer pauseCommand$$serializer = new PauseCommand$$serializer();
        INSTANCE = pauseCommand$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.livingroom.voice.models.PauseCommand", pauseCommand$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr = PauseCommand.$childSerializers;
        return new KSerializer[]{lazyArr[0].getValue(), StringSerializer.INSTANCE, lazyArr[2].getValue()};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final PauseCommand deserialize(@NotNull Decoder decoder) {
        ...
        return new PauseCommand(i, voiceCommandNamespace, strDecodeStringElement, voiceCommandName, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull PauseCommand value) {
