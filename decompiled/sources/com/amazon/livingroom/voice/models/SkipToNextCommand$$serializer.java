...
public /* synthetic */ class SkipToNextCommand$$serializer implements GeneratedSerializer<SkipToNextCommand> {

    @NotNull
    public static final SkipToNextCommand$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        SkipToNextCommand$$serializer skipToNextCommand$$serializer = new SkipToNextCommand$$serializer();
        INSTANCE = skipToNextCommand$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.livingroom.voice.models.SkipToNextCommand", skipToNextCommand$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr = SkipToNextCommand.$childSerializers;
        return new KSerializer[]{lazyArr[0].getValue(), StringSerializer.INSTANCE, lazyArr[2].getValue()};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final SkipToNextCommand deserialize(@NotNull Decoder decoder) {
        ...
        return new SkipToNextCommand(i, voiceCommandNamespace, strDecodeStringElement, voiceCommandName, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SkipToNextCommand value) {
