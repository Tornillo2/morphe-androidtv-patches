...
public /* synthetic */ class EnableCaptionsCommand$$serializer implements GeneratedSerializer<EnableCaptionsCommand> {

    @NotNull
    public static final EnableCaptionsCommand$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        EnableCaptionsCommand$$serializer enableCaptionsCommand$$serializer = new EnableCaptionsCommand$$serializer();
        INSTANCE = enableCaptionsCommand$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amazon.livingroom.voice.models.EnableCaptionsCommand", enableCaptionsCommand$$serializer, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr = EnableCaptionsCommand.$childSerializers;
        return new KSerializer[]{lazyArr[0].getValue(), StringSerializer.INSTANCE, lazyArr[2].getValue()};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final EnableCaptionsCommand deserialize(@NotNull Decoder decoder) {
        ...
        return new EnableCaptionsCommand(i, voiceCommandNamespace, strDecodeStringElement, voiceCommandName, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull EnableCaptionsCommand value) {
