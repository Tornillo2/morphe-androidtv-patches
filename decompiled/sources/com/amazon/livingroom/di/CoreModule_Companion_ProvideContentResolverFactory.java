...
public final class CoreModule_Companion_ProvideContentResolverFactory implements Factory<ContentResolver> {
    ...
    public static ContentResolver provideContentResolver(Context context) {
        ContentResolver contentResolverProvideContentResolver = CoreModule.Companion.provideContentResolver(context);
        Preconditions.checkNotNullFromProvides(contentResolverProvideContentResolver);
