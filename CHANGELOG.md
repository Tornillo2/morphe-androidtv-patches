...
* add AppTarget for Disney and update HBO Max compatibility name for Android TV ([bacee4a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/bacee4a39555170a79cecb391bd57e9d3ae3fc18))
* Add client cert request handling and improve comments ([c60a808](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c60a808c522d1df1e1a761cd7bc0331a0ab572bd))
* Add extendWith call in SkipAdsPatch.kt ([f0abe0d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f0abe0d531c519426610de3c0e6b8bc25480c9da))
* Add fingerprints for FoxIma stream requests ([d435003](https://github.com/Tornillo2/morphe-androidtv-patches/commit/d43500327ac868bb454defa76427b2d6acbed29f))
* Add four new hooks for ad suppression and opt-out ([daafb60](https://github.com/Tornillo2/morphe-androidtv-patches/commit/daafb606f3f96bb73cd30d3c35c87cea75cdb2e4))
* Add Gradle credentials setup in release workflow via Morphe tutorial ([cdc695e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/cdc695e0b72e1e24d16d15769553b2ec023376a9))
* add Tubi ad domains block in SkipAdsPatch ([bca79ee](https://github.com/Tornillo2/morphe-androidtv-patches/commit/bca79ee15d39d7ffb64563b8d17ca9e009758247))
* Change compatibility from ATBAT_TV to MLB_TV ([6eb87fb](https://github.com/Tornillo2/morphe-androidtv-patches/commit/6eb87fb399625fc96ab9828a0ed5228e83ddea5f))
* Change compatibility from PARAMOUNT_PLUS_TV to PARAMOUNT_TV ([96dc1a8](https://github.com/Tornillo2/morphe-androidtv-patches/commit/96dc1a873621549517c28df0b2cbcc7be501553d))
* Change default namespace for extensions ([d4b6334](https://github.com/Tornillo2/morphe-androidtv-patches/commit/d4b63344b26ecaf15cb7ba1903789ac33664afd0))
* Clarify patch compatibility for Paramount versions ([6dfb89d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/6dfb89d875afbdbec3a1392d16544d7ed42cc336))
* Delete obsolete ProGuard rules for extensions ([40f15c6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/40f15c6579a2007d1967e67554a66ebe487c3939))
* Delete patches/src/main/kotlin/ajstrick81/morphe/patches/primevideo/misc/permissions directory ([65515b9](https://github.com/Tornillo2/morphe-androidtv-patches/commit/65515b92873265ae44faefc96e061c25b52fe33e))
* **dns:** match akamaized.net safe-harbor host by concatenated prefix ([b883df7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b883df7853da554f75e0a184bafdb08988ddf709))
* Enhance logging for ad group stripping methods ([b1a7381](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b1a7381761476bc7644d7527f11c6a18b0f8fde0))
* Enhance Skip Ads patch with compatibility check ([2158994](https://github.com/Tornillo2/morphe-androidtv-patches/commit/215899498531185b6799ef8e6a465f183c68edb4))
* Fix check-cast for shouldBlock return type to stop app crash ([090bbc0](https://github.com/Tornillo2/morphe-androidtv-patches/commit/090bbc0a049a2d5ff9741ade374c69594a9342ca))
* Fix formatting of method reference in ParamountPatch.kt ([9d26013](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9d2601368c34d6dea1528195c36ed61ae79ac886))
* Fix typo in SSAI parsing failure string ([38c04a6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/38c04a6962b3b275b23d9f0fe4419dc3f9fe8c09))
* force new version update Fingerprints.kt ([a4747fb](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a4747fb1e2a789ce72c6c58c15bdbfdba0e25308))
* force new version update Fingerprints.kt ([201af65](https://github.com/Tornillo2/morphe-androidtv-patches/commit/201af65cb7aa8251c5da327e503fbf7138ae23a5))
* force new version with update Fingerprints.kt ([a9028f7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a9028f7f6b6919a28929b2c7adfc2aeb5084a581))
* force version update via SkipAdsPatch.kt ([4c5bf0d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4c5bf0d82e8389e21e0d6ac4411e30d1cf6662b5))
* gradlew clean: Reorder Gradle commands in release workflow ([8d93490](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8d93490bae60ba7eb543fc41a451a3f3a3f7e391))
* Implement ad blocking in Volley network layer ([9bc512b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9bc512b9d3e2b327b59171a3343dae706ad0f3fe))
* Implement ad request interception in TubiWebClient ([a7342b1](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a7342b1e2784859010b669b2add0e69c13e651f8))
* Implement comprehensive ad suppression mechanisms ([421f039](https://github.com/Tornillo2/morphe-androidtv-patches/commit/421f0391c5b6d4179f550560d0fea757e2a158b2))
* Implement fingerprints for ad playback and metrics ([65a6878](https://github.com/Tornillo2/morphe-androidtv-patches/commit/65a6878006cbddd90b7e7b953b82c65ce1e8c865))
* Implement Nowtilus kill switch in HBOAdsPatch ([c95084b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c95084b2beea95de31216169dfe5362999b229de))
* Make gradlew executable in release workflow ([e0bc1ff](https://github.com/Tornillo2/morphe-androidtv-patches/commit/e0bc1fff7a0b5985b69436fb15ced00b07b9909e))
* **mlbtv:** re-enable SSAI/DAI/TXXX blocking patches alongside overlay ([4cfcf7c](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4cfcf7c4b3a22a1352e87f25a250ee05c8f5d0a3))
* Modify AtBatPatch for MLB At Bat compatibility ([7638422](https://github.com/Tornillo2/morphe-androidtv-patches/commit/7638422dbbcedd9de3e4aea9b6925edf8a5afd83))
* Modify BoltNonLinearAdsRequest fingerprint for JSON key ([fb28017](https://github.com/Tornillo2/morphe-androidtv-patches/commit/fb28017b792ed5b0278df849e58206578f0ee6d6))
* Morphe patch error: Refactor FoxPlayerClearVodAdsFingerprint definition ([c3edc0c](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c3edc0c9306ee724d4bab477b240bdf3ddb9213c))
* new version and Enhance AdBlockInterceptor with randomized responses ([007e8c6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/007e8c6559bc40c538e66de6bb18d7d8b146055b))
* new version and enhance GMB diagnostic logging with inline smali ([c0da5ec](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c0da5ec07a68a8966fd571d8d62b1c858a98f6a7))
* new version and Enhance skipAdsPatch with WebView interception ([9fab827](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9fab8275292d6f0c24b38530f12bd94efcc6cc85))
* new version push by adding target version to PARAMOUNT_TV compatibility ([ac43dd1](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ac43dd1dbb4c92abc96f717beb5c1fc8c944dd1f))
* new version Refactor WebViewClient interception logic ([1ae2b03](https://github.com/Tornillo2/morphe-androidtv-patches/commit/1ae2b0368f639dacb3f7e5a8a7f82a800ed2dae1))
* Peacock Layer 7 constructor coverage + HBO Max 7.5.0.73 support ([#21](https://github.com/Tornillo2/morphe-androidtv-patches/issues/21)) ([b4e862a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b4e862af3b8e974d485c7e9634f08210ec52d647))
* **peacock:** DNS-independent ad suppression — Sky SDK addon OkHttp client + New Relic agent kill ([#26](https://github.com/Tornillo2/morphe-androidtv-patches/issues/26)) ([5e592a4](https://github.com/Tornillo2/morphe-androidtv-patches/commit/5e592a4a23464c7ed6492cdd69b488f98beb06d8))
* **peacock:** fix Layer 7 VerifyError launch crash + re-add Layers 9-11 ([#32](https://github.com/Tornillo2/morphe-androidtv-patches/issues/32)) ([c5257dd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c5257dde17b6ae5b9d5fa6e9025d14788abe5337))
* **peacock:** Layer 11 media-client coverage + SAS/VAC shard matching ([#27](https://github.com/Tornillo2/morphe-androidtv-patches/issues/27)) ([a132655](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a132655743cff6cdf56e7ff65be3150952544759))
* **peacock:** remove blocking Thread.sleep() from ad-block interceptors ([f0d441d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f0d441de63adb39c33afc78ab1e28a7cbca1b5de))
* **peacock:** revert Layer 11 + SAS/VAC matcher that broke playback on v7.5.100 ([#29](https://github.com/Tornillo2/morphe-androidtv-patches/issues/29)) ([#30](https://github.com/Tornillo2/morphe-androidtv-patches/issues/30)) ([09f5c64](https://github.com/Tornillo2/morphe-androidtv-patches/commit/09f5c64a0b33569779e32d9a1fe55903980ca757)), closes [#27](https://github.com/Tornillo2/morphe-androidtv-patches/issues/27)
* **peacock:** rewrite wrapClient() to use named class, not anonymous ([188b354](https://github.com/Tornillo2/morphe-androidtv-patches/commit/188b354c6551e5a3b958f526b84735ed5926001f))
* **peacock:** roll back to known-good Layers 1-8; remove launch-breaking Layers 9-10 ([#31](https://github.com/Tornillo2/morphe-androidtv-patches/issues/31)) ([3641c54](https://github.com/Tornillo2/morphe-androidtv-patches/commit/3641c54c2387b143168e7a199ec1c81cb7a86d58))
* **peacock:** roll back to stable Layers 1-8 + fixed Layer 7 baseline for main ([c54992e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c54992e342e8e2bf51f5cd95454cd7219e0aaa2c))
* pin Paramount+ to v16.8.0 ([250eae2](https://github.com/Tornillo2/morphe-androidtv-patches/commit/250eae26bf5da15fa8b19d69306e5fe4b417c953))
* **primevideo:** block additional Volley ad hosts ([b47e706](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b47e706d8597ba36ad66a2385a2e1ec07a123472))
* **primevideo:** replace non-existent allowAutoUpdates attribute with versionCode bump ([e758753](https://github.com/Tornillo2/morphe-androidtv-patches/commit/e75875319b5831a3da95b6d30758b47934020a29))
* push new version and Update instruction index in SkipAdsPatch.kt ([056ade6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/056ade686ff71319bcfbabf51c76b05128683c43))
* push new version by Adding Volley dependency for Prime Video integration ([bc789ef](https://github.com/Tornillo2/morphe-androidtv-patches/commit/bc789ef5cae6bb72a4ce9b8390829abbeb72dc6b))
* push new version Refactor PeacockWebViewHelper for clarity and safety ([060680f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/060680fac74817f05a2d331b622b1ff544fc7402))
* push new version through update of SkipAdsPatch.kt ([f58ac6b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f58ac6be345a9589f05f43d127d427eca512edb9))
* push new version update Fingerprints.kt ([15fabeb](https://github.com/Tornillo2/morphe-androidtv-patches/commit/15fabebf35794d7fa356e93286aaba9ee2ad7cdd))
* push new version update Fingerprints.kt ([79c0575](https://github.com/Tornillo2/morphe-androidtv-patches/commit/79c057584f444f6a682241685bd90230f4d22f0f))
* push new version Update SkipAdsPatch.java ([cba3509](https://github.com/Tornillo2/morphe-androidtv-patches/commit/cba350941e1788d31ffb4c7d54c7fce2d0f12945))
* push new version via Refine skipAdsPatch description and add comments ([f92dcc3](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f92dcc3278094e1ffc86431b4cafffc7bc0f10ce))
* push new version via Update ParamountPatch for v16.12.0 compatibility ([8ae32cc](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8ae32ccd5070f2ce69841e3de2947819f49b55fc))
* push new version while Updating proguard rules to include enforceAdBlock ([54e320a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/54e320ac7d5f325770a1a7b02fd72a74d3b8da02))
* push new version with changes to Update Fingerprints.kt ([3775332](https://github.com/Tornillo2/morphe-androidtv-patches/commit/37753320a316f5e351a0cf5e628fc1ca29d06f39))
* push new version with refactor comments and logic in PeacockWebViewHelper ([2fa200f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/2fa200ff70dbf1d62f22659c1e3bfbdbc6db5ce4))
* push new version with refactor SkipAdsPatch for clarity and efficiency ([a3ab178](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a3ab178ffde8d9ba8af3bc511b9ce3d27102cef5))
* push new version with Update ad patch fingerprints for MLB At Bat ([1aac811](https://github.com/Tornillo2/morphe-androidtv-patches/commit/1aac8110d104ea6ef5dfbf56179efe2189b568be))
* push new version with Update ad suppression patch for Yospace SSAI ([38d9168](https://github.com/Tornillo2/morphe-androidtv-patches/commit/38d916832cea3945eced94a7f5b6de83879ae63d))
* push new version with Update Disney+ compatibility targets ([ef74d13](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ef74d136763c00195ca18390dad3fbff64eaa147))
* push new version with update Fingerprints.kt ([5ec69a7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/5ec69a72b9f5df4014124047d5684cfae1b23f53))
* push new version with Update Gradle job ID in release workflow ([2c014ff](https://github.com/Tornillo2/morphe-androidtv-patches/commit/2c014ff9876db633525baa7c9ba6b994b96a1df7))
* push new version: Enhance documentation for ad delivery and SSAI handling ([8fe99d7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8fe99d78ad8a2405f9a81ef98829b5cbfba53a12))
* push update for addition of MLB.tv to repo ([af7d735](https://github.com/Tornillo2/morphe-androidtv-patches/commit/af7d735729e017aeb2328c4eda836f1230b60847))
* push Update SkipAdsPatch.kt to test Peacock ([903c74d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/903c74d68a5462ecd14cd98c4dc10958fd27dfc4))
* push updated and enhance comments for SkipAdsPatch functionality ([9dbad4a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9dbad4a8d3cb4552037e02784d4f5b0daad16243))
* push version update through Fingerprints.kt ([54336ae](https://github.com/Tornillo2/morphe-androidtv-patches/commit/54336aed6019be759d1664c5eea888a05c0af523))
* push version update through Fingerprints.kt ([b20232e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b20232e4f539ad026dc91e661b5567674443fb82))
* push version with update Fingerprints.kt for ad playback state handling ([055ad5f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/055ad5fc7ce6ee8399f937943267f8bec3c8dc95))
* pushing new version by updating Fingerprints.kt ([ab4ba28](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ab4ba28d2266e2851aaa8f5cc41ca92cef79099e))
* Refactor ad break logic and update comments ([f8e340e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f8e340e2e48b415e83c392e4a608b9c3862c725a))
* Refactor ad delivery architecture comments in AtBatFingerprints.kt ([84da6e7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/84da6e776d86f759931d49c292a3727b80535699))
* Refactor ad injection method to avoid VerifyErrors ([7598779](https://github.com/Tornillo2/morphe-androidtv-patches/commit/75987792f27a8049af5e1cea353faee062a601fb))
* Refactor ad playback state handling in SkipAdsPatch ([cb0b454](https://github.com/Tornillo2/morphe-androidtv-patches/commit/cb0b454f85b9cef1e8b8625f425320d8fc160686))
* Refactor ad playback strategy for improved performance ([aafdbcd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/aafdbcdd5bdbfa00bfadf071015d8b96bbef11d5))
* Refactor ad-break fetch coroutine handling ([7f1bb26](https://github.com/Tornillo2/morphe-androidtv-patches/commit/7f1bb26b6b2ddc3e39fb56c671383c4146295ad6))
* Refactor AdBlockInterceptor injection method ([e5f4c43](https://github.com/Tornillo2/morphe-androidtv-patches/commit/e5f4c4382b6b70b00f78fc8bd5b4249918b6e73d))
* Refactor AtBatPatch for clarity and structure ([fbcd024](https://github.com/Tornillo2/morphe-androidtv-patches/commit/fbcd024b288acb7343fdf5b4ee499f9d6b42db22))
* Refactor code for 'HBO Max - Disable Ads' ([f55ebc2](https://github.com/Tornillo2/morphe-androidtv-patches/commit/f55ebc29dd0f128d647b1a84c463a88aa5d42c3a))
* Refactor comments and patch descriptions in AtBatPatch ([aafcfe5](https://github.com/Tornillo2/morphe-androidtv-patches/commit/aafcfe5b8514d0408bf2dc7b01e85cf697db2a78))
* Refactor comments for clarity in SkipAdsPatch.kt ([2114aa6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/2114aa6b1307cbc99ccc1c5945b4d763ce4e6543))
* Refactor comments in SkipAdsPatch.kt to avoid app crash ([0b1bd23](https://github.com/Tornillo2/morphe-androidtv-patches/commit/0b1bd2393740d099e0c4b2d793933dfca79f5706))
* Refactor DisneyPatch for clarity and updates ([b626bd1](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b626bd175b1029a6dd1c0b433987c464b19167c1))
* Refactor Fingerprints for ad request and timeline builders ([506a49c](https://github.com/Tornillo2/morphe-androidtv-patches/commit/506a49cde31a23c1a284445edfe2888d17dd5ea6))
* Refactor Fingerprints.kt for ad event suppression ([eec1fd6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/eec1fd6082f207602ce496818d70bd24aceb4809))
* Refactor Fingerprints.kt for Fox One integration ([23bdb4e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/23bdb4eab64959710996db57ac23758424634d5f))
* Refactor Fingerprints.kt package and imports ([e39c4d6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/e39c4d626b6261c529a89cf6dfb78d1e7205279d))
* Refactor Fingerprints.kt with updated patch strategies ([4c45180](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4c4518027d6d711475e22d932e8c777ef3bece45))
* Refactor HBOAdsPatch for clarity and efficiency ([2a47b14](https://github.com/Tornillo2/morphe-androidtv-patches/commit/2a47b14538e338e83f7e06edd8bada1afc44975f))
* Refactor Helio ad fingerprints and coroutine handling ([04c817e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/04c817ea310e65b8cebb922a9b6a2962cc3ce1d9))
* Refactor imports in Fingerprints.kt ([07ae48c](https://github.com/Tornillo2/morphe-androidtv-patches/commit/07ae48c9b0a4e5d0dbc70d591ed99fcd71097e42))
* Refactor metadata handling and patch DAI events ([ec8c6cc](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ec8c6cc9d17d6617f80c4359616d56cb0afac6ed))
* Refactor MLB At Bat ad patches for clarity and functionality ([42f0d5a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/42f0d5a67c56ab8b7f9cf3f51a75bfd9257d6c93))
* Refactor MLB At Bat ad suppression patches ([0532f64](https://github.com/Tornillo2/morphe-androidtv-patches/commit/0532f6487570ef419f180f5043f8cc82c412497b))
* Refactor ParamountPatch for ad suppression mechanism ([7f8f06f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/7f8f06fa5befef65dfde245e56e67ab1f1de06fb))
* Refactor patches and update fingerprint comments ([8bee5e3](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8bee5e3d66f4d33d79f31fc9e51e428a126e1257))
* Refactor PauseAdOverlayFingerprint custom logic ([70c4804](https://github.com/Tornillo2/morphe-androidtv-patches/commit/70c4804acd3c9785271dbb878df5e9a3899558b2))
* Refactor SkipAdsPatch by removing unused hooks ([e1c3302](https://github.com/Tornillo2/morphe-androidtv-patches/commit/e1c3302bf7751b18a96df444ea3c7a5740fc04e7))
* Refactor SkipAdsPatch documentation and remove seek method ([20cf0bd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/20cf0bd5f59af60f09d85311fd50d49eb015a9b5))
* Refactor SkipAdsPatch to simplify ad handling ([7eaede7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/7eaede7510ae55a56a1c58d77d16e41c32bd0dec))
* Refactor supplementaryAdsPatch to remove interstitial ad hook ([89a5c12](https://github.com/Tornillo2/morphe-androidtv-patches/commit/89a5c125186db152ae7d30b5ab75d3475bdcc01a))
* Refactor TXXX metadata dispatch handling ([520358e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/520358ef3c8b6bfa0e82fa29da39109ee4218cba))
* Refactor URL blocking logic in PeacockWebViewHelper ([beac284](https://github.com/Tornillo2/morphe-androidtv-patches/commit/beac284f95904045745a59d94dfd26b8b1a4d524))
* Refactor VOD SSAI and pause ads fingerprint strategies ([cbb0117](https://github.com/Tornillo2/morphe-androidtv-patches/commit/cbb0117efda945e60b3fa78dcc11277f3f26ae69))
* Refine Paramount patch for ad handling ([cbe5e59](https://github.com/Tornillo2/morphe-androidtv-patches/commit/cbe5e5904f2dfcb1ebeb4f53bf065c35da7ebb2c))
* Remove unnecessary closing parentheses in Fingerprints.kt ([8f211f3](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8f211f3c237f40f48280af5a332b4c63127bd558))
* Rename package in Fingerprints.kt ([4f6bd18](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4f6bd18da4714f42140a956d4c9a4458eb99409a))
* Rename patch from 'MLB At Bat' to 'MLB.tv' ([07af607](https://github.com/Tornillo2/morphe-androidtv-patches/commit/07af607dea512607de8210118b1af78d319c06c8))
* Rename patch from Fox One to Fox Sports ([ae60e8b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ae60e8bf98ed90cb54e322a0abdfa0f14fd28807))
* resolve Gradle credentials for publish step ([0a3e95b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/0a3e95b0b595453727c6496c7a08a16e440e3494))
* return null from ImaSdkFactory.zzb to prevent AdsLoader creation ([71d02aa](https://github.com/Tornillo2/morphe-androidtv-patches/commit/71d02aab549dd01bc00176b3af0e9f32f8f43c50))
* Revise ad suppression fingerprints for Fox One ([dad7e6f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/dad7e6fcd07829e5abeee1239fc8264bdc26549a))
* rollback update Fingerprints.kt ([556efdd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/556efdd3bb60043e2b434db97006fe22fe12c356))
* Simplify SkipAdsPatch description and clean up code ([ab3e2bf](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ab3e2bfa268071f85c4a1636a687a0b036f5a0b6))
* stale cache - force Update SkipAdsPatch.java ([55d678b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/55d678b79b9216cc4536566a60a69c72bd58ba24))
* trigger initial patch release ([b9ec362](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b9ec3621e4ff462492d2d6f081a9370239f712c5))
* trigger release for Peacock ad-leak fixes and HBO Max 7.5.0.73 support ([dd1ba7b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/dd1ba7bb04fe87836ca69c6565b9ac2020ecd3be))
* trigger release with Gradle credentials fix ([26459d4](https://github.com/Tornillo2/morphe-androidtv-patches/commit/26459d44339e1dc5e541c1afb1981decea348639))
* update and Improve comments in Fingerprints.kt for XTVWebView ([bc4d815](https://github.com/Tornillo2/morphe-androidtv-patches/commit/bc4d81536923685d624639ead1772d96d6231ea5))
* Update app.morphe.patches plugin version to 1.3.2 ([a625d8f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a625d8f6aacd5b541ee958c5f304039f68982ba5))
* Update AppCompatibilities.kt to include HBOmax ([99bee43](https://github.com/Tornillo2/morphe-androidtv-patches/commit/99bee43fc262767c630cd293e5d286d4fe317b0d))
* Update comments and add new ad server checks ([a39195d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a39195d92bd3ea1810c8672a8642771f92aac4b5))
* Update comments and method name for ad pause patch ([1a06d95](https://github.com/Tornillo2/morphe-androidtv-patches/commit/1a06d95ee5b293e1e52b49d66f1abfc6565a0817))
* Update dependencies in build.gradle.kts ([be68275](https://github.com/Tornillo2/morphe-androidtv-patches/commit/be6827510874c3a39f05f86bd2c6c9d133b6e88b))
* Update Fingerprints: Remove and add SDK fingerprints ([36f3bd5](https://github.com/Tornillo2/morphe-androidtv-patches/commit/36f3bd5e023e55a49473ad5f92451f4f4a076597))
* Update Fingerprints.kt for Disney+ Android TV v26.8.0rc6 ([5140813](https://github.com/Tornillo2/morphe-androidtv-patches/commit/5140813ad11756cbd3134f92b243a5d3d08fbb7e))
* Update FreewheelModuleSkipFingerprint definition ([5e0306e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/5e0306e0a6f86d27da137d59bee17de66a585cbe))
* update Gradle wrapper to 9.4.1 ([a0c8799](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a0c8799e4dbbb0bbd69fb8221a2f572d63fa1205))
* Update Gradle wrapper to version 9.5.0 ([7fbf2d7](https://github.com/Tornillo2/morphe-androidtv-patches/commit/7fbf2d7471ef75333df59ecf5483e6ac66bc2823))
* Update HBO Max package name in AppCompatibilities ([b374810](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b374810cb92206b34b8bb5725afe54e51711ce5a))
* Update HBO Max package name to com.wbd.stream ([6b0c55d](https://github.com/Tornillo2/morphe-androidtv-patches/commit/6b0c55d26300ab774e3d65fd7598382011624e84))
* Update method invocation in SkipAdsPatch.kt to avoid app crash on startup ([8bd5c84](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8bd5c84e2dc44a3cfdf36b2a828ec4bbda9cb04a))
* Update package name for HBO Max Android TV compatibility ([9e033ad](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9e033adb2bf4312e00948dd2e704e08ab0687cd7))
* update package-lock.json and bump Node to 22 ([899748f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/899748f0a2924f27714201ce18f4a6412a2c831a))
* Update ParamountPatch to suppress VOD and pause ads ([2bd6988](https://github.com/Tornillo2/morphe-androidtv-patches/commit/2bd698808bbfde794ca2adb347849b85543d86ff))
* Update patch notes and adjust return types for suspend functions ([c8eb1f5](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c8eb1f5cfc5ce86c0669671b3e7aeb78c6b1e17b))
* Update Prime Video extension patch for merging DEX ([8a93773](https://github.com/Tornillo2/morphe-androidtv-patches/commit/8a93773fbff409f08929ff9e45022d66596e63be))
* Update release workflow permissions and build steps ([bdc2476](https://github.com/Tornillo2/morphe-androidtv-patches/commit/bdc24760520ed7cf6b1d0db742f8910dda9372a2))
* Update returnType in ImaSdkFactoryFingerprint ([ed7ed27](https://github.com/Tornillo2/morphe-androidtv-patches/commit/ed7ed2744626527d2755ca426d0555fdc37a8b41))
* Update SkipAdsPatch to use invoke-static/range ([a3ca8bf](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a3ca8bfd260ce363617cdce103bc037542c2bba8))
* Update SkipAdsPatch.kt ([b1abecd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b1abecdca6419abd6c32bc84baa4efed79fe7157))
* **vix:** retarget Innovid hook to mount method, drop broken FreeWheel hook ([33cefba](https://github.com/Tornillo2/morphe-androidtv-patches/commit/33cefba404703be7f7da0cf02c25e8f3aab63206))


### Features

* add GMB send-direction diagnostic patch (debug-only) ([b0552cb](https://github.com/Tornillo2/morphe-androidtv-patches/commit/b0552cb7f84a74b455bef5473b781328164c5fae))
* initial Paramount+ and Disney+ ad blocking patches ([dca286e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/dca286eea91711f896674136521435cf74bb208d))
* initial Paramount+ and Disney+ ad blocking release ([9ae71e6](https://github.com/Tornillo2/morphe-androidtv-patches/commit/9ae71e63c3060b2b495e49591d3d7c81efe01d18))
* **peacock:** DAI-swap ad suppression + Clone and Disable auto-updates ([2969316](https://github.com/Tornillo2/morphe-androidtv-patches/commit/296931651c3d50c49e88190286d087a23e2a5f32))
* **pluto:** add certificate-pinning override for HTTPS inspection ([723ceeb](https://github.com/Tornillo2/morphe-androidtv-patches/commit/723ceebb3ee0987efb0991478b902b467bcd2076))
* **pluto:** add Clone and Disable auto-updates patches ([4358314](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4358314cab49bd34a84fa17517f3394a49ea79d3))
* **pluto:** strip ad-break timeline to remove VOD ads ([16cc76b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/16cc76b67468d692ef0c4c1f7b5789d8cc79883b))
* **pluto:** verify ad hooks against dex, add clickable-ads suppression ([575612f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/575612f34caf006a040df1e200b02f03f31184c3))
* **primevideo dns:** v4.2 — add hercule trigger after live-session validation ([82c94cd](https://github.com/Tornillo2/morphe-androidtv-patches/commit/82c94cd445750966a73aad2e8d3e2efe1a8898c1))
* **primevideo dns:** v4.3 — optional general-tracker section (triaged) ([4182df0](https://github.com/Tornillo2/morphe-androidtv-patches/commit/4182df0c6594e966a596f49516b99a17c6b037e1))
* **primevideo:** add Clone Prime Video side-by-side install patch ([0ebea56](https://github.com/Tornillo2/morphe-androidtv-patches/commit/0ebea56de302d986a3e559a224c7e5e5affdab3b))
* **primevideo:** add evidence-graded DNS ad-suppression list (dual-layer) ([c55bb0e](https://github.com/Tornillo2/morphe-androidtv-patches/commit/c55bb0e1e10ee82529a5b5102987c24b02f0582d))
* **primevideo:** block getVideoAds path on dual-use playback host ([940b91a](https://github.com/Tornillo2/morphe-androidtv-patches/commit/940b91aff4a56a347e44eaf498d7351dfb8f3cdd))
* **primevideo:** expand Volley ad-host block list from v3.6 session diff ([6f05cb5](https://github.com/Tornillo2/morphe-androidtv-patches/commit/6f05cb5a9922a24f9f50759083287ee571895f9e))
* **primevideo:** remove GMB send diagnostic patch, add DNS rules from live testing ([48b744b](https://github.com/Tornillo2/morphe-androidtv-patches/commit/48b744bb136a49ecdaa8c7d3a5ed11e618e73d60))
* replace MLB At Bat SSAI/DAI blocking with ad-break overlay ([adc3d3f](https://github.com/Tornillo2/morphe-androidtv-patches/commit/adc3d3fa802a43c494e487e28472a0c40a26899b))
* restructure Paramount+ patch with separate Fingerprints file ([badd2c2](https://github.com/Tornillo2/morphe-androidtv-patches/commit/badd2c281981becff17d529d58961ec2caa10d59))
* update app names for Paramount and Disney Plus ([a6450cf](https://github.com/Tornillo2/morphe-androidtv-patches/commit/a6450cfdfc489ef645afd69922ef770210150669))
* **vix:** add "Override certificate pinning" companion patch ([1fcdccf](https://github.com/Tornillo2/morphe-androidtv-patches/commit/1fcdccf651d01cc1ee9e3ba2ddf45154b796fc1a))
* **vix:** block LuraPlayer linear (client-side VAST) ad-break scheduler ([1360354](https://github.com/Tornillo2/morphe-androidtv-patches/commit/1360354a9275a2fbcd1d363114876c5e9bef6c04))
