...
//
// Our hook (pure smali — no extension required):
//   1. Get the host from WebResourceRequest.getUrl().getHost()
//   2. Check against blocked ad domains using String.contains()
//   3. If match → construct and return empty WebResourceResponse inline
//   4. If no match → fall through to original yo/b (LocalAssetsLoader) body
//
